# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq IseOptions DepthOfMarket Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_iseoptions_depthofmarket_itch_v2_1_servertcp
  title: Nasdaq IseOptions DepthOfMarket Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq ISE Depth Of Market Itch v2.1'
