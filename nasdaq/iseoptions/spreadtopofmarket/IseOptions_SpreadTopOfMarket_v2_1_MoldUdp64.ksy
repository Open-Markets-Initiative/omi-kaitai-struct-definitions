# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq IseOptions SpreadTopOfMarket Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_iseoptions_spreadtopofmarket_itch_v2_1_moldudp64
  title: Nasdaq IseOptions SpreadTopOfMarket Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq ISE Phlx Options Spread Top Of Market Itch v2.1'
