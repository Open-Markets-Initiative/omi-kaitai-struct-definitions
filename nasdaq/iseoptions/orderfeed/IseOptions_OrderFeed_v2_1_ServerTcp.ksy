# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq IseOptions OrderFeed Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_iseoptions_orderfeed_itch_v2_1_servertcp
  title: Nasdaq IseOptions OrderFeed Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq ISE Ise Order Feed Market Data Itch v2.1'
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            'sequenced_message_type::auction_message': auction_message
