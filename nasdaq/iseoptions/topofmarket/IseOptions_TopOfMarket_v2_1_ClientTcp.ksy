# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq IseOptions TopOfMarket Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_iseoptions_topofmarket_itch_v2_1_clienttcp
  title: Nasdaq IseOptions TopOfMarket Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq ISE Top Of Market Itch v2.1'
