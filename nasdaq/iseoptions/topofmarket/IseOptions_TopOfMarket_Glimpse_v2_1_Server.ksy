# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq IseOptions TopOfMarket Glimpse v2.1
#
# Protocol:
...
meta:
  id: nasdaq_iseoptions_topofmarket_glimpse_v2_1_server
  title: Nasdaq IseOptions TopOfMarket Glimpse v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq ISE Top Of Market Glimpse v2.1'
