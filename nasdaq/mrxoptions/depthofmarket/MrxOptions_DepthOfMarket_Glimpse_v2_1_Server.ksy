# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq MrxOptions DepthOfMarket Glimpse v2.1
#
# Protocol:
...
meta:
  id: nasdaq_mrxoptions_depthofmarket_glimpse_v2_1_server
  title: Nasdaq MrxOptions DepthOfMarket Glimpse v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq MRX Depth Of Market Glimpse v2.1'
