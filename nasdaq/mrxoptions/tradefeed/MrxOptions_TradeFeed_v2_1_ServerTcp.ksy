# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq MrxOptions TradeFeed Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_mrxoptions_tradefeed_itch_v2_1_servertcp
  title: Nasdaq MrxOptions TradeFeed Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq MRX Trade Feed Itch v2.1'
