# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq MrxOptions SpreadDepthOfMarket Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_mrxoptions_spreaddepthofmarket_itch_v2_1
  title: Nasdaq MrxOptions SpreadDepthOfMarket Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq MRX Phlx Options Spread Depth Itch v2.1'
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            'sequenced_message_type::single_side_replace_short_form_message': single_side_replace_short_form_message
            'sequenced_message_type::single_side_replace_long_form_message': single_side_replace_long_form_message
            'sequenced_message_type::single_side_delete_message': single_side_delete_message
            'sequenced_message_type::single_side_update_message': single_side_update_message
            'sequenced_message_type::complex_strategy_trade_message': complex_strategy_trade_message
  ...
  single_side_delete_message:
    seq:
      ...
      - id: strategy_id_order_reference
        type: u4
        doc: 'Integer ID of the Strategy, as defined in the Complex Strategy Message'
      - id: order_reference_number
        type: u8
        doc: 'The unique reference number assigned to the new order'
  single_side_update_message:
    seq:
      ...
      - id: order_type
        ...
        enum: order_type
        doc: 'Order Type'
  complex_strategy_trade_message:
    seq:
      - id: tracking_number
        type: u2
        doc: 'Internal system tracking number'
      ...
      - id: udp_payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::complex_strategy_trade_message': complex_strategy_trade_message
