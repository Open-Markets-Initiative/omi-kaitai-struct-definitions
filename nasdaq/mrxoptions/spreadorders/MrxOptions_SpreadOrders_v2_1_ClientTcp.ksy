# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq MrxOptions SpreadOrders Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_mrxoptions_spreadorders_itch_v2_1_clienttcp
  title: Nasdaq MrxOptions SpreadOrders Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq MRX Phlx Options Spread Orders Itch v2.1'
