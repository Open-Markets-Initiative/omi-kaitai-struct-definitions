# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq PsxEquities Bbo Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_psxequities_bbo_itch_v2_1
  title: Nasdaq PsxEquities Bbo Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq PSX Best Bid And Offer Itch v2.1'
  ...
  stock_directory_message:
    seq:
      ...
      - id: etp_leverage_factor
        type: u4
        doc: 'Leverage Factor is rounded to the nearest integer below, e.g. leverage factor 1 would represent leverage factors of 1 to 1.99. This field is used for LULD Tier I price band calculation purposes. ETP Leverage Factor currently not supported for Non-Nasdaq listed ETP’s'
  ...
  quotation_message:
    seq:
      ...
      - id: stock
        ...
        pad-right: 0x20
        doc: 'Denotes the security symbol for the issue in the NASDAQ execution system'
      - id: bbo_security_class
        type: u1
        enum: bbo_security_class
        doc: 'Indicates the primary listing market for the stock'
      - id: best_bid_price
        type: decimal_u4_4
