# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq PhlxOptions DepthOfMarket Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_phlxoptions_depthofmarket_itch_v2_1_servertcp
  title: Nasdaq PhlxOptions DepthOfMarket Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq PHLX Depth Of Market Itch v2.1'
