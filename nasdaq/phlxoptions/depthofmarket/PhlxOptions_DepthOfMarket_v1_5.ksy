# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq PhlxOptions DepthOfMarket Itch v1.5
#
# Protocol:
...
doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq PHLX Depth Of Market Itch v1.5'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::order_replace_message_short_form': order_replace_message_short_form
            ...
            'message_type::broken_trade_order_execution_message': broken_trade_order_execution_message
  ...
  add_quote_message_long_form:
    seq:
      ...
      - id: ask
        type: u4
        doc: 'NOTE: When converted to a decimal format, this price is in fixed point format with 6 whole number places followed by 4 decimal digits. The display ask price of the new quote'
      - id: ask_size
        type: u4
        doc: 'The ask contracts of the new quote'
  ...
  single_side_replace_message_long_form:
    seq:
      ...
      - id: volume
        type: u4
        doc: 'The total number of contracts of the new order being added to the book'
  order_replace_message_short_form:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Nanoseconds portion of the timestamp. Nanoseconds since Second epoch'
  ...
  options_cross_trade_message:
    seq:
      ...
      - id: volume
        type: u4
        doc: 'The total number of contracts of the new order being added to the book'
  broken_trade_order_execution_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Nanoseconds portion of the timestamp. Nanoseconds since Second epoch'
...
enums:
  message_type:
    ...
    0x55:
      ...
      doc: 'This message is sent whenever one side of a quote on the book is replaced. The replacement has a new reference number and replaces the prior reference number.'
    0x76:
      id: 'order_replace_message_short_form'
    ...
    0x42:
      id: 'broken_trade_order_execution_message'
