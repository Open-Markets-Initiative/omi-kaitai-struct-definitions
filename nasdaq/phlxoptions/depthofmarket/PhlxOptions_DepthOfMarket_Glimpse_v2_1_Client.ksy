# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq PhlxOptions DepthOfMarket Glimpse v2.1
#
# Protocol:
...
meta:
  id: nasdaq_phlxoptions_depthofmarket_glimpse_v2_1_client
  title: Nasdaq PhlxOptions DepthOfMarket Glimpse v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq PHLX Depth Of Market Glimpse v2.1'
