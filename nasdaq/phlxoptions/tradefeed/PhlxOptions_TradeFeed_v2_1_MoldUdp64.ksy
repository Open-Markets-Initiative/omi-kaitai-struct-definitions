# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq PhlxOptions TradeFeed Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_phlxoptions_tradefeed_itch_v2_1_moldudp64
  title: Nasdaq PhlxOptions TradeFeed Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq PHLX Trade Feed Itch v2.1'
