# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq PhlxOptions SpreadOrders Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_phlxoptions_spreadorders_itch_v2_1_clienttcp
  title: Nasdaq PhlxOptions SpreadOrders Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq PHLX Spread Orders Itch v2.1'
