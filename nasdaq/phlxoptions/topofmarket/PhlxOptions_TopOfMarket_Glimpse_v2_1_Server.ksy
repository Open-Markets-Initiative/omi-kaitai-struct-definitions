# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq PhlxOptions TopOfMarket Glimpse v2.1
#
# Protocol:
...
meta:
  id: nasdaq_phlxoptions_topofmarket_glimpse_v2_1_server
  title: Nasdaq PhlxOptions TopOfMarket Glimpse v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq PHLX Top Of Market Glimpse v2.1'
