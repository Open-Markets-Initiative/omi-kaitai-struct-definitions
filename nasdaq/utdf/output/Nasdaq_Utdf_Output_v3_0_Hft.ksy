# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq Utdf Output Utp v3.0.Hft
#
# Protocol:
...
meta:
  id: nasdaq_utdf_output_utp_v3_0_hft
  title: Nasdaq Utdf Output Utp v3.0.Hft
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq UTP Trade Data Feed Output Utp v3.0.Hft'
...
types:
  ...
  message:
    seq:
      ...
      - id: udp_payload
        size: message_header.message_length - 29
  message_header:
    seq:
      - id: message_length
        type: u2
      ...
      - id: message_category
        ...
        size: 1
        encoding: ASCII
        doc: 'Single-byte ascii message category (high byte of the cat+type 16-bit dispatch key)'
      - id: message_type
        type: str
        size: 1
        encoding: ASCII
        doc: 'Single-byte ascii message type discriminator within a category (low byte of the cat+type 16-bit dispatch key)'
