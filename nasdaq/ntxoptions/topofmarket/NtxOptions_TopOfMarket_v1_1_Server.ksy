# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NtxOptions TopOfMarket Glimpse v1.1
#
# Protocol:
...
meta:
  id: nasdaq_ntxoptions_topofmarket_glimpse_v1_1_server
  title: Nasdaq NtxOptions TopOfMarket Glimpse v1.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Texas Options Top Of Market Glimpse v1.1'
...
enums:
  ...
  sequenced_message_type:
    ...
    0x62:
      ...
      doc: 'Best Bid OR Ask Update message with 2 byte Price and Size fields.'
    0x42:
      id: 'best_bid_or_ask_update_long_form_message'
      doc: 'Best Bid OR Ask Update message with 4 byte Price and Size fields.'
    0x4d:
      id: 'snapshot_message'
