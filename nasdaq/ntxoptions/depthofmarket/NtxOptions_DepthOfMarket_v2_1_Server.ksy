# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NtxOptions DepthOfMarket Glimpse v2.1
#
# Protocol:
...
meta:
  id: nasdaq_ntxoptions_depthofmarket_glimpse_v2_1_server
  title: Nasdaq NtxOptions DepthOfMarket Glimpse v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Texas Options Depth Of Market Glimpse v2.1'
