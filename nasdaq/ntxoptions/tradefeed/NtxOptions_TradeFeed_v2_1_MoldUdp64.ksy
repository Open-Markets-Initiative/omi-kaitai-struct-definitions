# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NtxOptions TradeFeed Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_ntxoptions_tradefeed_itch_v2_1_moldudp64
  title: Nasdaq NtxOptions TradeFeed Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Texas Options Trade Feed Itch v2.1'
