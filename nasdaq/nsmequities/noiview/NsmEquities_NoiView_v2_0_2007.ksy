# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NsmEquities NoiView Itch v2.0.2007
#
# Protocol:
...
meta:
  id: nasdaq_nsmequities_noiview_itch_v2_0_2007
  title: Nasdaq NsmEquities NoiView Itch v2.0.2007
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Stock Market Net Order Imbalance View Itch v2.0.2007'
...
enums:
  message_type:
    ...
    0x52:
      ...
      doc: 'At the start of each trading day, NASDAQ disseminates stock directory messages for all active and cross eligible symbols.'
    0x48:
  ...
  market_category:
    ...
    0x54:
      id: 'cqs'
      doc: 'Nyse Amex Or Regional Exchange'
  ...
  current_trading_state:
    0x48:
      ...
      doc: 'Halt In Effect'
    0x51:
      id: 'quotationonly_period_in_effect'
      doc: 'Quotationonly Period In Effect'
    0x54:
  ...
  cross_type:
    ...
    0x43:
      ...
      doc: 'Close Cross'
    0x48:
      id: 'intraday_opening_cross_for_ipo_and_halted_securities'
      doc: 'Intraday Opening Cross For Ipo And Halted Securities'
