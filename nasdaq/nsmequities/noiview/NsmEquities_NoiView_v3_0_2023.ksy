# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NsmEquities NoiView Itch v3.0.2023
#
# Protocol:
...
meta:
  id: nasdaq_nsmequities_noiview_itch_v3_0_2023
  title: Nasdaq NsmEquities NoiView Itch v3.0.2023
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Stock Market Net Order Imbalance View Itch v3.0.2023'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::direct_listing_with_capital_raise_message': direct_listing_with_capital_raise_message
  message_header:
    seq:
      - id: message_length
        type: u2
  ...
  stock_directory_message:
    seq:
      ...
      - id: etp_leverage_factor
        type: u4
        doc: 'Tracks the integral relationship of the ETP to the underlying index. Leverage Factor is rounded to the nearest integer. ETP Leverage Factor currently not supported for Non-Nasdaq listed ETPs'
  ...
  direct_listing_with_capital_raise_message:
    seq:
      - id: tracking_number
        type: u2
        doc: 'NASDAQ internal tracking number'
...
enums:
  message_type:
    ...
    0x4f:
      id: 'direct_listing_with_capital_raise_message'
      doc: 'Disseminated only for Direct Listing with Capital Raise (DLCR) securities, once per second once the DLCR volatility test has successfully passed.'
  event_code:
    0x4f:
