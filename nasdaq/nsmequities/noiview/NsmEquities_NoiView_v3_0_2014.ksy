# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NsmEquities NoiView Itch v3.0.2014
#
# Protocol:
...
meta:
  id: nasdaq_nsmequities_noiview_itch_v3_0_2014
  title: Nasdaq NsmEquities NoiView Itch v3.0.2014
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Stock Market Net Order Imbalance View Itch v3.0.2014'
