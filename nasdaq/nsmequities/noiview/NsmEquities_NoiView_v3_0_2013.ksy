# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NsmEquities NoiView Itch v3.0.2013
#
# Protocol:
...
meta:
  id: nasdaq_nsmequities_noiview_itch_v3_0_2013
  title: Nasdaq NsmEquities NoiView Itch v3.0.2013
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Stock Market Net Order Imbalance View Itch v3.0.2013'
  ...
  stock_directory_message:
    seq:
      ...
      - id: etp_leverage_factor
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Tracks the integeral relationship of the ETP to the underlying index'
  ...
  stock_trading_action_message:
    seq:
      ...
      - id: tracking_id
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Tracking identifier for the trading action'
  ...
  ipo_quoting_period_update_message:
    seq:
      ...
      - id: ipo_quotation_release_time
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Denotes the IPO release time for quotation to the nearest second'
      - id: ipo_quotation_release_qualifier
        type: u1
        enum: ipo_quotation_release_qualifier
        doc: 'Denotes the qualifier for the IPO quotation release'
      - id: ipo_price
        type: str
        size: 10
        encoding: ASCII
...
enums:
  message_type:
    ...
    0x52:
      ...
      doc: 'At the start of each trading day, NASDAQ disseminates stock directory messages for all active symbols.'
    0x48:
    ...
    0x49:
      id: 'noii_message'
      doc: 'NASDAQ disseminates NOII data in the minutes leading up to the NASDAQ Opening and Closing Crosses as well as the IPO/Halt Crosses.'
    0x51:
    ...
    0x4b:
      ...
      doc: 'Denotes the IPO release time for quotation and the IPO price for the issue.'
  event_code:
    0x4f:
  ...
  round_lots_only:
    0x59:
      id: 'nasdaq_omx_system_only_accepts_round_lots_orders_for_this_security'
      doc: 'Nasdaq Omx System Only Accepts Round Lots Orders For This Security'
    0x4e:
      id: 'nasdaq_omx_system_does_not_have_any_order_size_restrictions_for_this_security'
      doc: 'Nasdaq Omx System Does Not Have Any Order Size Restrictions For This Security'
  authenticity:
    0x50:
      id: 'live_production'
      doc: 'Live Production'
  ...
  ipo_flag:
    0x59:
      id: 'nasdaq_listed_instrument_is_set_up_as_a_new_ipo_security'
      doc: 'Nasdaq Listed Instrument Is Set Up As A New Ipo Security'
    0x4e:
      id: 'nasdaq_listed_instrument_is_not_set_up_as_a_new_ipo_security'
  ...
  current_trading_state:
    ...
    0x50:
      ...
      doc: 'Nasda Qlisted Securities Only'
    0x51:
