...
meta:
  id: nasdaq_nsmequities_totalview_itch_v2_0_udp
  ...
  add_order_message:
    seq:
      ...
      - id: display
        type: u1
        enum: display
        doc: '"Y" = displayed in the quote. The "S" value is no longer supported as of the NASDAQ/INET merger'
...
enums:
  ...
  message_type:
    ...
    0x41:
      ...
      doc: 'An Add Order Message indicates that a new order has been accepted by the NASDAQ system and added onto the displayable book. It includes a day-unique Order Reference Number assigned by NASDAQ to the order.'
    0x45:
