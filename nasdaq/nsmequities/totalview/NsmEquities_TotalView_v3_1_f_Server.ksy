...
meta:
  id: nasdaq_nsmequities_totalview_itch_v3_1_f_server
      ...
      - id: sequenced_message
        type:
          ...
          cases:
            ...
            'message_type::order_display_message': order_display_message
  ...
  stock_directory_message:
    seq:
      - id: stock_alpha_6
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Denotes the security symbol for the issue in NASDAQ Single Book. Refer to Appendix B for NASDAQ Single Book stock symbol convention information'
      - id: market_category
        type: u1
  ...
  stock_trading_action_message:
    seq:
      ...
      - id: trading_state
        type: u1
        enum: trading_state
        doc: 'The current trading state for the stock. The 3.1f table gives only the allowable values for this field'
      - id: reserved
        type: str
        size: 1
        encoding: ASCII
  ...
  add_order_message:
    seq:
      ...
      - id: display
        type: u1
        enum: display
        doc: 'Indicates the Display code for the order'
...
enums:
  ...
  message_type:
    0x54:
      id: 'seconds_message'
      doc: 'This message is sent every second for which at least one TotalView-ITCH 3.1f message is being generated.'
    0x4d:
      id: 'milliseconds_message'
      doc: 'This message is sent every millisecond for which at least one TotalView-ITCH 3.1f message is being generated.'
    0x53:
    ...
    0x41:
      ...
      doc: 'An Add Order Message indicates that a new order has been accepted by the NASDAQ system and was added to the displayable book. The message includes a day-unique Order Reference Number used by NASDAQ to track the order. This message will be generated for unattributed orders in the NASDAQ Single Book system. This is the Add Order Anonymous format, which in 3.1f carries a Display field.'
    0x46:
    ...
    0x56:
      id: 'order_display_message'
      doc: 'This message is disseminated to alert the TotalView-ITCH users that a Flash order has been added to the continuous order book for display on all NASDAQ data feeds.'
    0x50:
      id: 'trade_message'
  ...
  display:
    0x59:
      id: 'displayable'
      doc: 'Displayable Order Type On All Nasdaq Data Feeds'
    0x53:
      id: 'flash_order'
      doc: 'Flash Order Displayable On Total View Itch Only'
  printable:
    0x4e:
      id: 'non_printable'
      doc: 'Nonprintable'
