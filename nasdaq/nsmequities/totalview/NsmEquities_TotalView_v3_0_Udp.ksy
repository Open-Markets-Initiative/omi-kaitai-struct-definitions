...
meta:
  id: nasdaq_nsmequities_totalview_itch_v3_0_udp
...
types:
  ...
  stock_directory_message:
    seq:
      - id: stock_alphabetic_6
        type: str
        size: 6
        encoding: ASCII
        pad-right: 0x20
        doc: 'Denotes the security symbol for the issue in NASDAQ Single Book'
      - id: market_category
        type: u1
        enum: market_category
        doc: 'Indicates listing market center or listing market tier for the issue'
