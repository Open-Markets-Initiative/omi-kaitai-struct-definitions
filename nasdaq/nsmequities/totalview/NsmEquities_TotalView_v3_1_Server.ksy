# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NsmEquities TotalView Itch v3.1
#
# Protocol:
...
meta:
  id: nasdaq_nsmequities_totalview_itch_v3_1_server
  title: Nasdaq NsmEquities TotalView Itch v3.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Stock Market TotalView Itch Itch v3.1'
...
enums:
  ...
  message_type:
    0x54:
      id: 'seconds_message'
      doc: 'This message is sent every second for which at least one TotalView-ITCH 3.1 message is being generated.'
    0x4d:
      id: 'milliseconds_message'
      doc: 'This message is sent every millisecond for which at least one TotalView-ITCH 3.1 message is being generated.'
    0x53:
