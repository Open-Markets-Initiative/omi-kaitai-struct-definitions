# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NsmEquities TotalView Itch v5.0.2017
#
# Protocol:
...
meta:
  id: nasdaq_nsmequities_totalview_itch_v5_0_2017_server
  title: Nasdaq NsmEquities TotalView Itch v5.0.2017
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Stock Market TotalView Itch Itch v5.0.2017'
...
types:
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            '"R"': stock_directory_message
            '"H"': stock_trading_action_message
            '"Y"': reg_sho_short_sale_price_test_restricted_indicator_message
            '"L"': market_participant_position_message
            '"V"': mwcb_decline_level_message
            '"W"': mwcb_status_level_message
            '"K"': ipo_quoting_period_update
            '"J"': luld_auction_collar_message
            '"A"': add_order_no_mpid_attribution_message
            '"F"': add_order_with_mpid_attribution_message
            '"E"': order_executed_message
            '"C"': order_executed_with_price_message
            '"X"': order_cancel_message
            '"D"': order_delete_message
            '"U"': order_replace_message
            '"P"': non_cross_trade_message
            '"Q"': cross_trade_message
            '"B"': broken_trade_message
            '"I"': net_order_imbalance_indicator_message
            '"N"': retail_interest_message
  ...
  cross_trade_message:
    seq:
      ...
      - id: cross_shares
        type: u8
        doc: 'The number of shares matched in the'
      - id: stock
        type: str
        size: 8
        encoding: ASCII
...
enums:
  ...
  round_lots_only:
    0x59:
      id: 'round_lots_only'
      doc: 'Nasdaq Omx System Only Accepts Round Lots Orders For This Security'
    0x4e:
      id: 'no_restrictions'
      doc: 'Nasdaq Omx System Does Not Have Any Order Size Restrictions For This Security Odd And Mixed Lot Orders Are Allowed'
  ...
  interest_flag:
    0x42:
      id: 'buy_side_rpi_orders_available'
      doc: 'Rpi Orders Available On The Buy Side'
    0x53:
      id: 'sell_side_rpi_orders_available'
      doc: 'Rpi Orders Available On The Sell Side'
    0x41:
      id: 'both_sides_rpi_orders_available'
  ...
  message_type:
    ...
    0x4c:
      ...
      doc: 'Throughout the day, NASDAQ will send out this message only if NASDAQ Operations changes the status of a market participant firm in an issue.'
    0x56:
