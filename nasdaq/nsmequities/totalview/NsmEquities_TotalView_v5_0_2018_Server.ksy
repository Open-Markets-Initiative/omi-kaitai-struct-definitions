# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq NsmEquities TotalView Itch v5.0.2018
#
# Protocol:
...
meta:
  id: nasdaq_nsmequities_totalview_itch_v5_0_2018_server
  title: Nasdaq NsmEquities TotalView Itch v5.0.2018
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Stock Market TotalView Itch Itch v5.0.2018'
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            '"N"': retail_price_improvement_indicator_message
