...
meta:
  id: nasdaq_ntxequities_orders_ouch_v4_2_server
  title: Nasdaq NtxEquities Orders Ouch v4.2
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq Texas BX Orders Ouch v4.2'
...
types:
  ...
  accepted_message:
    seq:
      ...
      - id: order_reference_number
        type: u8
        doc: 'The day-unique Order Reference Number assigned by NASDAQ OMX BX to this order'
      - id: capacity
        type: u1
        enum: capacity
  ...
  executed_message:
    seq:
      ...
      - id: match_number
        type: u8
        doc: 'Assigned by NASDAQ OMX BX to each match executed. Each match consists of one buy and one sell. The matching buy and sell executions share the same match number'
...
enums:
  ...
  unsequenced_message_type:
    0x4f:
      ...
      doc: 'The Enter Order Message lets you enter a new order into NASDAQ OMX BX.'
    0x55:
  ...
  display:
    ...
    0x5a:
      ...
      doc: 'Entered as displayed but changed to non-displayed (Priced to comply)'
    0x4d:
      id: 'mid_point'
      doc: 'Mid-Point Peg'
    0x4f:
  ...
  sequenced_message_type:
    0x53:
      ...
      doc: 'System Event Messages signal events that affect the entire NASDAQ OMX BX system'
    0x41:
      id: 'accepted_message'
  ...
  event_code:
    0x53:
      id: 'start_of_day'
      doc: 'Start of Day — This is always the first message each day. It indicates that NASDAQ OMX BX is open and ready to start accepting orders.'
    0x45:
      id: 'end_of_day'
      doc: 'End of Day — This indicates that NASDAQ OMX BX is now closed and will not accept any new orders or replaces in this session. There will be no further executions during this session; however, it is still possible to receive Broken Trade Messages and Canceled Order Messages'
  order_state:
    0x4c:
      id: 'live'
      doc: 'Order Live'
  ...
  liquidity_flag:
    ...
    0x74:
      ...
      doc: 'RMO Retail Order removes price improving non-displayed liquidity other than RPI liquidity'
    0x71:
    ...
    0x38:
      ...
      doc: 'Displayed, liquidity-adding order sets the BXBBO while joining the NBBO'
    0x70:
      id: 'removed_price_improving_nondisplayed_liquidity'
      doc: 'Removed price improving non-displayed liquidity'
    0x4e:
  ...
  rejected_reason:
    ...
    0x5a:
      ...
      doc: 'Shares exceeds configured safety threshold — The number of shares entered must be less than the safety threshold configured for this Account. The safety threshold can be added/updated through NASDAQ OMX BX Subscriber Services.'
    0x53:
      id: 'invalid_stock'
      doc: 'Invalid stock — The stock field must be a valid issue, tradable on NASDAQ OMX BX.'
    0x44:
    ...
    0x4c:
      ...
      doc: 'Requested firm not authorized for requested clearing type on this account — To authorize additional firms, use the NASDAQ OMX BX Service Bureau Agreement.'
    0x4d:
    ...
    0x71:
      id: 'midpoint_peg_orders_are_not_accepted'
