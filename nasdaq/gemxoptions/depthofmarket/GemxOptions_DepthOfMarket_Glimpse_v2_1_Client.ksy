# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq GemxOptions DepthOfMarket Glimpse v2.1
#
# Protocol:
...
meta:
  id: nasdaq_gemxoptions_depthofmarket_glimpse_v2_1_client
  title: Nasdaq GemxOptions DepthOfMarket Glimpse v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq GEMX Depth Of Market Glimpse v2.1'
