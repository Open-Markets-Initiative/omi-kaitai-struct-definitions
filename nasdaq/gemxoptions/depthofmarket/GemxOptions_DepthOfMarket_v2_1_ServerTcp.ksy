# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq GemxOptions DepthOfMarket Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_gemxoptions_depthofmarket_itch_v2_1_servertcp
  title: Nasdaq GemxOptions DepthOfMarket Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq GEMX Depth Of Market Itch v2.1'
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            'sequenced_message_type::quote_replace_short_form_message': quote_replace_short_form_message
            'sequenced_message_type::quote_replace_long_form_message': quote_replace_long_form_message
            'sequenced_message_type::quote_delete_message': quote_delete_message
            'sequenced_message_type::trade_message': trade_message
            'sequenced_message_type::net_order_imbalance_message': net_order_imbalance_message
