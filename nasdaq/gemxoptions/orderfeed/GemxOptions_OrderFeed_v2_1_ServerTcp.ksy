# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq GemxOptions OrderFeed Itch v2.1
#
# Protocol:
...
meta:
  id: nasdaq_gemxoptions_orderfeed_itch_v2_1_servertcp
  title: Nasdaq GemxOptions OrderFeed Itch v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq GEMX Order Feed Itch v2.1'
