# ---------------------------------------------------------------------
# Kaitai struct definition for: Nasdaq GemxOptions TopOfMarket Glimpse v2.1
#
# Protocol:
...
meta:
  id: nasdaq_gemxoptions_topofmarket_glimpse_v2_1_server
  title: Nasdaq GemxOptions TopOfMarket Glimpse v2.1
  license: GPL-3.0
  endian: be

doc: 'National Association of Securities Dealers Automated Quotations (Nasdaq) Nasdaq GEMX Top Of Market Glimpse v2.1'
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            'sequenced_message_type::best_bid_or_ask_update_short_form_message': best_bid_or_ask_update_short_form_message
            'sequenced_message_type::best_bid_or_ask_update_short_form_message_x61': best_bid_or_ask_update_short_form_message
            'sequenced_message_type::best_bid_or_ask_update_long_form_message': best_bid_or_ask_update_long_form_message
            'sequenced_message_type::best_bid_or_ask_update_long_form_message_x41': best_bid_or_ask_update_long_form_message
  ...
  best_bid_and_ask_update_short_form_message:
    seq:
      ...
      - id: bid_cust_size_short
        type: u2
        doc: 'Customer quantity on the bid side. Not supported on Nasdaq Texas Options (Nasdaq Texas Options is an anonymous market). Always set to "0"'
      - id: bid_procust_size_short
        type: u2
        doc: 'Customer professional quantity on the bid side. Not supported on Nasdaq Texas Options (Nasdaq Texas Options is an anonymous market). Always set to "0"'
      ...
      - id: ask_cust_size_short
        type: u2
        doc: 'Customer quantity on the ask side. Not supported on Nasdaq Texas Options (Nasdaq Texas Options is an anonymous market). Always set to "0"'
      - id: ask_procust_size_short
        type: u2
        doc: 'Customer professional quantity on the ask side. Not supported on Nasdaq Texas Options (Nasdaq Texas Options is an anonymous market). Always set to "0"'
  best_bid_and_ask_update_long_form_message:
    seq:
      ...
      - id: ask_procust_size_long
        type: u4
        doc: 'Customer professional quantity on the ask side. Not supported on Nasdaq Texas Options (Nasdaq Texas Options is an anonymous market). Always set to "0"'
  best_bid_or_ask_update_short_form_message:
    seq:
      - id: tracking_number
        type: u2
        doc: 'Internal system tracking number'
      ...
      - id: cust_size_short
        type: u2
        doc: 'Customer quantity on the bid or ask side. Not supported on Nasdaq Texas Options (Nasdaq Texas Options is an anonymous market). Always set to "0"'
      - id: procust_size_short
        type: u2
        doc: 'Customer professional quantity on the bid or ask side. Not supported on Nasdaq Texas Options (Nasdaq Texas Options is an anonymous market). Always set to "0"'
  best_bid_or_ask_update_long_form_message:
    seq:
      - id: tracking_number
        type: u2
        doc: 'Internal system tracking number'
  ...
  snapshot_message:
    seq:
      - id: snapshot_sequence_number
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Top of Market Feed sequence number when the Glimpse snapshot was taken'
...
enums:
  ...
  sequenced_message_type:
    ...
    0x71:
      ...
      doc: 'Best Bid AND Ask Update message with 2 byte Price and Size fields.'
    0x51:
      id: 'best_bid_and_ask_update_long_form_message'
      doc: 'Best Bid AND Ask Update message with 4 byte Price and Size fields.'
    0x62:
      id: 'best_bid_or_ask_update_short_form_message'
      doc: 'Best Bid OR Ask Update message with 2 byte Price and Size fields, bid side.'
    0x61:
      id: 'best_bid_or_ask_update_short_form_message_x61'
      doc: 'Best Bid OR Ask Update message with 2 byte Price and Size fields, ask side.'
    0x42:
      id: 'best_bid_or_ask_update_long_form_message'
      doc: 'Best Bid OR Ask Update message with 4 byte Price and Size fields, bid side.'
    0x41:
      id: 'best_bid_or_ask_update_long_form_message_x41'
      doc: 'Best Bid OR Ask Update message with 4 byte Price and Size fields, ask side.'
    0x4d:
      id: 'snapshot_message'
      doc: 'The Snapshot message reflects the Top of Market sequence number at the time the GLIMPSE spin was requested.'
  event_code:
    0x4f:
