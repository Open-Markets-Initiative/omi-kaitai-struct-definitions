...
meta:
  id: nasdaq_nordicequities_orderentry_ouch_v5_02_6_server
...
types:
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            'sequenced_message_type::cancelled_order_message': cancelled_order_message
            'sequenced_message_type::cancel_pending_message': cancel_pending_message
            'sequenced_message_type::replace_pending_message': replace_pending_message
            ...
            'sequenced_message_type::cancel_rejected_message': cancel_rejected_message
            'sequenced_message_type::order_restated_message': order_restated_message
            'sequenced_message_type::mmo_refresh_request_message': mmo_refresh_request_message
            'sequenced_message_type::account_query_response_message': account_query_response_message
            'sequenced_message_type::gtc_cancelled_message': gtc_cancelled_message
            'sequenced_message_type::response_to_mmi_notification_message': response_to_mmi_notification_message
            'sequenced_message_type::pending_order_message': pending_order_message
            'sequenced_message_type::stream_status_message': stream_status_message
  system_event_message:
    seq:
      - id: timestamp
        type: nanosecond_timestamp
        doc: 'Nanoseconds past midnight. Nanoseconds since Midnight epoch'
      - id: event_code
        type: u1
        enum: event_code
  ...
  cancelled_order_message:
    seq:
      ...
      - id: decrement_quantity
        type: u4
        doc: 'Quantity just decremented from the order'
      - id: cancel_reason
        type: u1
        enum: cancel_reason
        doc: 'Reason the order was reduced or cancelled'
  cancel_pending_message:
    seq:
      ...
      - id: user_ref_num
        type: u4
        doc: 'Sequence number, unique and strictly increasing for the day'
      - id: cancel_pending_reason
        type: u1
        enum: cancel_pending_reason
        doc: 'Reason the order was pended'
  replace_pending_message:
    seq:
      - id: timestamp
        type: nanosecond_timestamp
        doc: 'Nanoseconds past midnight. Nanoseconds since Midnight epoch'
  ...
  executed_order_message:
    seq:
      ...
      - id: executed_quantity
        type: u4
        doc: 'Incremental quantity executed'
      - id: execution_price
        type: decimal_u4_4
        doc: 'The price at which the shares executed. Implied decimal with scale 1e-4'
      - id: liquidity_flag
        type: str
        size: 1
        encoding: ASCII
        pad-right: 0x20
        doc: 'The type of trade'
      - id: match_number
        type: u4
        doc: 'Day unique match number'
      - id: contra_firm
        type: str
        size: 4
        encoding: ASCII
        pad-right: 0x20
        doc: 'The Mpid of the counterparty'
      - id: trading_mode
        type: u1
        enum: trading_mode
        doc: 'Market model typology level 2'
      - id: transaction_category
        type: u1
        enum: transaction_category
        doc: 'Market model typology level 3.1'
      - id: transaction_type_algo_indicator
        type: u1
        enum: transaction_type_algo_indicator
        doc: 'Market model typology level 3.9'
      - id: liquidity_attributes
        type: liquidity_attributes
        doc: 'Packed qualifier bits'
      - id: last_market
        type: u1
  ...
  cancel_rejected_message:
    seq:
      ...
      - id: cancel_rejected_reason
        type: u2
        doc: 'The reason the cancel was rejected'
  order_restated_message:
    seq:
      ...
      - id: restate_reason
        type: u1
        enum: restate_reason
        doc: 'The reason for this order being restated'
      - id: appendage_length
        type: u2
        doc: 'Remaining length of the TagValue element'
      - id: tagvalue
  ...
  mmo_refresh_request_message:
    seq:
      ...
      - id: order_book
        type: u4
        doc: 'Order book id'
      - id: mmo_refresh_reason
        type: str
        size: 1
        encoding: ASCII
        pad-right: 0x20
        doc: 'Protection that was triggered'
  ...
  gtc_cancelled_message:
    seq:
      - id: timestamp
        type: nanosecond_timestamp
        doc: 'Nanoseconds past midnight. Nanoseconds since Midnight epoch'
      - id: original_order_entry_date
        type: original_order_entry_date
        doc: 'Original Order Entry Date'
      - id: original_order_reference_number
        type: original_order_reference_number
        doc: 'Original Order Reference Number'
      - id: reason
        type: u2
        doc: 'The reason the Gtc order was cancelled'
  response_to_mmi_notification_message:
    seq:
      - id: timestamp
        type: nanosecond_timestamp
        doc: 'Nanoseconds past midnight. Nanoseconds since Midnight epoch'
      ...
      - id: user
        ...
        pad-right: 0x20
        doc: 'Name of responsible trader'
      - id: instruction_status
        type: str
        size: 1
        encoding: ASCII
        pad-right: 0x20
        doc: 'Whether the instruction was accepted or rejected'
  pending_order_message:
    seq:
      ...
      - id: user_ref_num
        type: u4
        doc: 'Sequence number, unique and strictly increasing for the day'
      - id: pending_order_reason
        type: u1
        enum: pending_order_reason
        doc: 'Reason the order is pending'
  stream_status_message:
    seq:
      ...
      - id: cum_rate
        type: u2
        doc: 'Current cumulative streaming Ltr the order is achieving'
      - id: status
        type: u1
        enum: status
        doc: 'Whether the stream is on or off'
