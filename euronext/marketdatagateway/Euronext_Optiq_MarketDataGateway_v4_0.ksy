# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq MarketDataGateway Sbe v4.0
#
# Protocol:
...
meta:
  id: euronext_optiq_marketdatagateway_sbe_v4_0
  title: Euronext Optiq MarketDataGateway Sbe v4.0
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Market Data Gateway Sbe v4.0'
  ...
  bf_trade_message:
    seq:
      ...
      - id: event_time
        type: nanosecond_timestamp
        doc: 'eventTime. Nanoseconds since Unix epoch'
      - id: bid_offer_date_time_uint_64t
        type: u8
        doc: 'bidOfferDateTime'
  ...
  bfnav_message:
    seq:
      ...
      - id: symbol_index
        type: u4
        doc: 'symbolIndex'
      - id: bid_offer_date_time_uint_64t_optional
        type: u8_nullable
