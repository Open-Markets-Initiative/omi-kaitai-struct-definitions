# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq MarketDataGateway Sbe v3.0
#
# Protocol:
...
meta:
  id: euronext_optiq_marketdatagateway_sbe_v3_0
  title: Euronext Optiq MarketDataGateway Sbe v3.0
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Market Data Gateway Sbe v3.0'
