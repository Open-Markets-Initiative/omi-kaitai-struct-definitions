# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq MarketDataGateway Sbe v4.3
#
# Protocol:
...
meta:
  id: euronext_optiq_marketdatagateway_sbe_v4_3
  title: Euronext Optiq MarketDataGateway Sbe v4.3
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Market Data Gateway Sbe v4.3'
