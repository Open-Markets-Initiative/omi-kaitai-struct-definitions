# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq MarketDataGateway Sbe v3.1
#
# Protocol:
...
meta:
  id: euronext_optiq_marketdatagateway_sbe_v3_1
  title: Euronext Optiq MarketDataGateway Sbe v3.1
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Market Data Gateway Sbe v3.1'
