# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq OrderEntryGateway Sbe v4.11
#
# Protocol:
...
meta:
  id: euronext_optiq_orderentrygateway_sbe_v4_11
  title: Euronext Optiq OrderEntryGateway Sbe v4.11
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Order Entry Gateway Sbe v4.11'
...
types:
  ...
  execution_instruction:
    ...
    seq:
      ...
      - id: unused_execution_instructionset_7
        type: b1
