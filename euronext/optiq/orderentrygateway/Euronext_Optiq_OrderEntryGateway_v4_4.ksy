# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq OrderEntryGateway Sbe v4.4
#
# Protocol:
...
meta:
  id: euronext_optiq_orderentrygateway_sbe_v4_4
  title: Euronext Optiq OrderEntryGateway Sbe v4.4
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Order Entry Gateway Sbe v4.4'
