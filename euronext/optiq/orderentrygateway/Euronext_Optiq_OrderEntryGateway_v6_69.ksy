# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq OrderEntryGateway Sbe v6.69
#
# Protocol:
...
meta:
  id: euronext_optiq_orderentrygateway_sbe_v6_69
  title: Euronext Optiq OrderEntryGateway Sbe v6.69
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Order Entry Gateway Sbe v6.69'
...
types:
  ...
  new_order_message:
    seq:
      ...
      - id: optional_ids_groups
        type: optional_ids_groups
        doc: 'OptionalIDs Block'
  ...
  optional_ids_groups:
    seq:
      - id: group_size_encoding
        type: group_size_encoding
        doc: 'groupSizeEncoding'
      - id: optional_ids_group
        type: optional_ids_group
        repeat: expr
        repeat-expr: group_size_encoding.num_in_group
        doc: 'OptionalIDs'
  optional_ids_group:
    seq:
      - id: lpid
        type: u4_nullable
        doc: 'lPID. Nullable, No Value = 4294967295'
  ack_message:
    seq:
      - id: msg_seq_num
        type: u4
  ...
  quote_request_message:
    seq:
      ...
      - id: free_text_groups
        type: free_text_groups
        doc: 'FreeTextSection Block'
      - id: rfq_optional_field_groups
        type: rfq_optional_field_groups
        doc: 'RFQOptionalFields Block'
  rfq_optional_field_groups:
    seq:
      - id: group_size_encoding
        type: group_size_encoding
        doc: 'groupSizeEncoding'
      - id: rfq_optional_field_group
        type: rfq_optional_field_group
        repeat: expr
        repeat-expr: group_size_encoding.num_in_group
        doc: 'RFQOptionalFields'
  rfq_optional_field_group:
    seq:
  ...
  user_notification_message:
    seq:
      ...
      - id: market_condition
        ...
        doc: 'MarketCondition_set bit set. Nullable, No Value = 255'
      - id: emm_optional
        type: u1_nullable
        doc: 'eMM. Nullable, No Value = 255'
      - id: market_place
        type: str_3_nullable
        doc: 'marketPlace. Nullable, No Value = 0'
      - id: not_used_groups
        type: not_used_groups
        doc: 'NotUsedGroup1 Block'
  market_condition:
...
enums:
  ...
  kill_reason:
    ...
    46:
      ...
      doc: 'KillReason_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    47:
      id: 'order_cancelleddueto_remaining_non_allocated_quantity'
      doc: 'KillReason_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    48:
      id: 'order_cancelledby_market_operationsdueto_csd_unavailability'
      doc: 'KillReason_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
  ...
  user_status:
    ...
    41:
      ...
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    42:
      id: 'uor_activatedfora_firmby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    43:
      id: 'uor_deactivatedfora_firmby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    44:
      id: 'uor_activatedfora_logical_accessby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    45:
      id: 'uor_deactivatedfora_logical_accessby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    46:
      id: 'osl_activatedfora_firmby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    47:
      id: 'osl_deactivatedfora_firmby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    48:
      id: 'osl_activatedfora_logical_accessby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    49:
      id: 'osl_deactivatedfora_logical_accessby_risk_manager'
      doc: 'UserStatus_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
  exposure_side:
    1:
      id: 'buy'
  ...
  log_out_reason_code:
    ...
    5:
      ...
      doc: 'LogOutReasonCode_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    6:
      id: 'logout_by_market_operations'
      doc: 'LogOutReasonCode_enum Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
  operation_type:
    1:
