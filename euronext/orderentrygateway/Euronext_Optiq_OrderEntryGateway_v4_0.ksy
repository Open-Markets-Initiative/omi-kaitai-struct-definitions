# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq OrderEntryGateway Sbe v4.0
#
# Protocol:
...
meta:
  id: euronext_optiq_orderentrygateway_sbe_v4_0
  title: Euronext Optiq OrderEntryGateway Sbe v4.0
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Order Entry Gateway Sbe v4.0'
