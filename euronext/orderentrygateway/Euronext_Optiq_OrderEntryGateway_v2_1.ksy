# ---------------------------------------------------------------------
# Kaitai struct definition for: Euronext Optiq OrderEntryGateway Sbe v2.1
#
# Protocol:
...
meta:
  id: euronext_optiq_orderentrygateway_sbe_v2_1
  title: Euronext Optiq OrderEntryGateway Sbe v2.1
  license: GPL-3.0
  endian: le

doc: 'Euronext Euronext Optiq Order Entry Gateway Sbe v2.1'
