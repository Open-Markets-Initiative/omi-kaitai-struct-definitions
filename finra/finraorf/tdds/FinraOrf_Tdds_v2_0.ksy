# ---------------------------------------------------------------------
# Kaitai struct definition for: Finra FinraOrf Tdds Dfi v2.0
#
# Protocol:
...
meta:
  id: finra_finraorf_tdds_dfi_v2_0
  title: Finra FinraOrf Tdds Dfi v2.0
  license: GPL-3.0
  endian: be

doc: 'Financial Industry Regulatory Authority Finra ORF Trade Data Dissemination Service Dfi v2.0'
  ...
  trade_cancel_error_message:
    seq:
      ...
      - id: original_dissemination_date
        type: original_dissemination_date
        doc: 'Original Dissemination Date'
      - id: original_message_sequence_number
        type: str
        size: 8
        encoding: ASCII
        doc: 'The Original Message Sequence Number field indicates the message sequence number of the original outbound message for the transaction being reversed'
      - id: report_function
        type: u1
