# ---------------------------------------------------------------------
# Kaitai struct definition for: Finra Trace Atds Dfi v2.1
#
# Protocol:
#   Organization: Financial Industry Regulatory Authority
#   Protocol: Agency Debt Trade Dissemination Service
...
meta:
  id: finra_trace_atds_dfi_v2_1
  title: Finra Trace Atds Dfi v2.1
  license: GPL-3.0
  endian: be

doc: 'Financial Industry Regulatory Authority Finra TRACE Agency Debt Trade Dissemination Service Dfi v2.1'
...
types:
  ...
  label:
    seq:
      - id: symbol
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'The agency bond issue symbol as assigned by Finra for Trace trade reporting purposes'
      - id: cusip
        type: str
        size: 9
        encoding: ASCII
        pad-right: 0x20
        doc: 'The universal identifier for the specific agency bond as assigned by the Cusip Service Bureau'
      - id: bsym
        type: str
        size: 12
        encoding: ASCII
        pad-right: 0x20
        doc: 'The Bloomberg identifier for the specific agency bond'
      - id: sub_product_type
        type: str
        size: 5
        encoding: ASCII
      ...
      - id: administrative_message_payload
        type:
          ...
          cases:
            ...
            'administrative_message_type::market_sentiment_fannie_mae_message': market_sentiment_fannie_mae_message
            'administrative_message_type::market_sentiment_fhlb_message': market_sentiment_fhlb_message
            'administrative_message_type::market_sentiment_freddie_mac_message': market_sentiment_freddie_mac_message
  ...
  trading_halt_message:
    seq:
      ...
      - id: issuer
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'The name of the Agency or Government-sponsored enterprise that issued the security'
      - id: action
        type: u1
        enum: action
  ...
  market_breadth_information:
    seq:
      ...
      - id: total_securities_traded_freddie_mac
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues traded on the day'
      - id: total_securities_traded_fannie_mae
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues traded on the day'
      - id: total_securities_traded_fhlb
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues traded on the day'
      ...
      - id: advances_freddie_mac
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is higher than the prior closing price'
      - id: advances_fannie_mae
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is higher than the prior closing price'
      ...
      - id: declines_freddie_mac
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is lower than the prior closing price'
      - id: declines_fannie_mae
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is lower than the prior closing price'
      ...
      - id: unchanged_freddie_mac
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day remains the same as the prior closing price'
      - id: unchanged_fannie_mae
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day remains the same as the prior closing price'
      ...
      - id: fifty_two_week_high_freddie_mac
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is higher than a prior closing price within the past 52 business weeks'
      - id: fifty_two_week_high_fannie_mae
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is higher than a prior closing price within the past 52 business weeks'
      - id: fifty_two_week_high_fhlb
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is higher than a prior closing price within the past 52 business weeks'
      ...
      - id: fifty_two_week_low_freddie_mac
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is lower than a prior closing price within the past 52 business weeks'
      - id: fifty_two_week_low_fannie_mae
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is lower than a prior closing price within the past 52 business weeks'
      - id: fifty_two_week_low_fhlb
        type: str
        size: 6
        encoding: ASCII
        doc: 'The total number of issues where the closing price for the day is lower than a prior closing price within the past 52 business weeks'
      ...
      - id: total_volume_freddie_mac
        type: str
        size: 13
        encoding: ASCII
        doc: 'The current day''s total traded par value in millions'
      - id: total_volume_fannie_mae
        type: str
        size: 13
        encoding: ASCII
        doc: 'The current day''s total traded par value in millions'
      - id: total_volume_fhlb
        type: str
        size: 13
        encoding: ASCII
        doc: 'The current day''s total traded par value in millions'
  ...
  market_sentiment_information:
    seq:
      ...
      - id: total_volume_inter_dealer
        ...
        encoding: ASCII
        doc: 'The current day''s total traded par value in millions'
  market_sentiment_fannie_mae_message:
    seq:
      - id: message_header
        type: message_header
        doc: 'Message Header'
  ...
  market_sentiment_fhlb_message:
    seq:
      ...
      - id: market_sentiment_information
        type: market_sentiment_information
        doc: 'Market Sentiment Information'
  market_sentiment_freddie_mac_message:
    seq:
      - id: message_header
        type: message_header
        doc: 'Message Header'
...
enums:
  ...
  trade_message_type:
    0x4d:
      ...
      doc: 'Used to transmit agency debt trade transaction information to subscribers'
    0x4e:
  ...
  administrative_message_type:
    0x45:
      ...
      doc: 'Price summary message disseminated for each agency debt security that traded during the day during the normal trading hours'
    0x48:
      id: 'trading_halt_message'
      doc: 'Disseminated when a trading halt is instituted or removed for an agency debt security'
    0x41:
    ...
    0x33:
      id: 'market_sentiment_fannie_mae_message'
      doc: 'End of day market sentiment aggregate data for Fannie Mae issues'
    0x34:
      id: 'market_sentiment_fhlb_message'
      doc: 'End of day market sentiment aggregate data for Federal Home Loan Bank issues'
    0x35:
      id: 'market_sentiment_freddie_mac_message'
      doc: 'End of day market sentiment aggregate data for Freddie Mac issues'
