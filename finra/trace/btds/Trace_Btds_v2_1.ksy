# ---------------------------------------------------------------------
# Kaitai struct definition for: Finra Trace Btds Dfi v2.1
#
# Protocol:
#   Organization: Financial Industry Regulatory Authority
#   Protocol: Bond Trade Dissemination Service
...
meta:
  id: finra_trace_btds_dfi_v2_1
  title: Finra Trace Btds Dfi v2.1
  license: GPL-3.0
  endian: be

doc: 'Financial Industry Regulatory Authority Finra TRACE Bond Trade Dissemination Service Dfi v2.1'
...
enums:
  ...
  administrative_message_type:
    0x45:
      ...
      doc: 'Price summary message disseminated for each bond issue that traded during the day during the normal trading hours'
    0x48:
      id: 'trading_halt_message'
      doc: 'Disseminated when a trading halt is instituted or removed for a bond issue'
    0x41:
