# ---------------------------------------------------------------------
# Kaitai struct definition for: Aquis AquisEquities RealTime Amd v4.1
#
# Protocol:
...
meta:
  id: aquis_aquisequities_realtime_amd_v4_1
  title: Aquis AquisEquities RealTime Amd v4.1
  license: GPL-3.0
  endian: be

doc: 'Aquis Exchange Aquis Equities Real Time Market Data Feed Amd v4.1'
