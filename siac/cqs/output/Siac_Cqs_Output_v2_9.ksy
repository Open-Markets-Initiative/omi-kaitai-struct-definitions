# ---------------------------------------------------------------------
# Kaitai struct definition for: Siac Cqs Output Cta v2.9
#
# Protocol:
...
meta:
  id: siac_cqs_output_cta_v2_9
  title: Siac Cqs Output Cta v2.9
  license: GPL-3.0
  endian: be

doc: 'The Securities Industry Automation Corporation Consolidated Quotation System Output Cta v2.9'
  ...
  market_wide_circuit_breaker_status_message:
    seq:
      ...
      - id: participant_reference_number
        type: s8
        doc: 'Participant Reference Number Is A Passthru Of The Inbound Participant Reference Number Assigned To A Transaction'
      - id: mwcb_level_indicator
        type: u1
        enum: mwcb_level_indicator
  ...
  national_best_offer_long_appendage:
    seq:
      ...
      - id: best_offer_quote_condition
        type: u1
        enum: best_offer_quote_condition
        doc: 'Identifies The Quote Condition Associated With The Best Offer Price On A Consolidated Basis'
