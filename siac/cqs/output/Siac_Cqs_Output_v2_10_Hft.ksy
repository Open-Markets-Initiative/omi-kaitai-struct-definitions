# ---------------------------------------------------------------------
# Kaitai struct definition for: Siac Cqs Output Cta v2.10.Hft
#
# Protocol:
...
meta:
  id: siac_cqs_output_cta_v2_10_hft
  title: Siac Cqs Output Cta v2.10.Hft
  license: GPL-3.0
  endian: be

doc: 'The Securities Industry Automation Corporation Consolidated Quotation System Cta v2.10.Hft'
...
types:
  ...
  message_struct:
    seq:
      ...
      - id: message_payload
        type: special_long_quote_message
        doc: 'Used only by FINRA to report the FINRA Best Bid and FINRA Best Offer for their Market Makers for CTA eligible Equity, Local Issue or Bond information inclusive of changes to any existing FINRA BBO'
  message_header:
    seq:
      - id: message_length
        type: u2
  ...
  long_quote_message:
    seq:
      ...
      - id: national_best_offer_long_appendage
        ...
        if: national_bbo_indicator == national_bbo_indicator::no_best_bid_change_best_offer_long_appendage or national_bbo_indicator == national_bbo_indicator::quote_contains_best_bid_best_offer_long_appendage or national_bbo_indicator == national_bbo_indicator::no_best_bid_best_offer_long_appendage
      ...
      - id: national_best_offer_short_appendage
        ...
        if: national_bbo_indicator == national_bbo_indicator::no_best_bid_change_best_offer_short_appendage or national_bbo_indicator == national_bbo_indicator::quote_contains_best_bid_best_offer_short_appendage or national_bbo_indicator == national_bbo_indicator::no_best_bid_best_offer_short_appendage
