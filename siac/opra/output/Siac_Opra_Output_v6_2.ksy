# ---------------------------------------------------------------------
# Kaitai struct definition for: Siac Opra Output Obi v6.2
#
# Protocol:
...
meta:
  id: siac_opra_output_obi_v6_2
  title: Siac Opra Output Obi v6.2
  license: GPL-3.0
  endian: be

doc: 'The Securities Industry Automation Corporation Options Price Reporting Authority Output Obi v6.2'
    ...
    seq:
      ...
      - id: underlying_value_message_payload
        type:
          ...
          cases:
            'underlying_value_message_type::index_based_on_last_sale': underlying_value_last_sale_message
...
enums:
  ...
  underlying_value_message_type:
    0x20:
      id: 'index_based_on_last_sale'
      doc: 'Index Based On Last Sale'
    0x49:
      id: 'index_based_on_bid_and_offer'
      doc: 'Index Based On Bid And Offer'
