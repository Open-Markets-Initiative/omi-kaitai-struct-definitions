# ---------------------------------------------------------------------
# Kaitai struct definition for: Coinbase Deribit OrdersApi Sbe v1.3
#
# Protocol:
...
meta:
  id: coinbase_deribit_ordersapi_sbe_v1_3
  ...
  get_mass_quote_mmp_status_response_message:
    seq:
      ...
      - id: frozen_until_time
        type: s8_nullable
        doc: 'frozenUntilTime. Nullable, No Value = -9223372036854775808'
