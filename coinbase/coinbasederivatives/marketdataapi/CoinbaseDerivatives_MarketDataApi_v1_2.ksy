# ---------------------------------------------------------------------
# Kaitai struct definition for: Coinbase CoinbaseDerivatives MarketDataApi Sbe v1.2
#
# Protocol:
...
meta:
  id: coinbase_coinbasederivatives_marketdataapi_sbe_v1_2
...
types:
  ...
  implied_order_update_message:
    seq:
      ...
      - id: best_price
        type: s8_nullable
        doc: 'bestPrice. Nullable, No Value = -9223372036854775808'
      - id: next_price
        type: s8_nullable
        doc: 'nextPrice. Nullable, No Value = -9223372036854775808'
      - id: best_qty
        type: s4
        doc: 'bestQty'
      - id: next_qty
