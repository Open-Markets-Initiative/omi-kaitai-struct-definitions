# ---------------------------------------------------------------------
# Kaitai struct definition for: Coinbase CoinbaseDerivatives OrdersApi Sbe v1.3
#
# Protocol:
...
meta:
  id: coinbase_coinbasederivatives_ordersapi_sbe_v1_3
  title: Coinbase CoinbaseDerivatives OrdersApi Sbe v1.3
  license: GPL-3.0
  endian: le

doc: 'Coinbase Coinbase Derivatives Orders Api Sbe v1.3'
      ...
      - id: order_payload
        type:
          ...
          cases:
            ...
            'template_id::stream_order_message': stream_order_message
  ...
  event_resend_reject_message:
    seq:
      ...
      - id: resend_reject_reason
        ...
        doc: 'rejectReason'
      - id: event_resend_reject_details
        type: str
        size: 23
        encoding: ASCII
        doc: 'details'
...
enums:
  template_id:
    ...
    121:
      id: 'stream_order_message'
      doc: 'StreamOrderMessage'
    221:
