# ---------------------------------------------------------------------
# Kaitai struct definition for: Coinbase CoinbaseDerivatives OrdersApi Sbe v1.6
#
# Protocol:
...
meta:
  id: coinbase_coinbasederivatives_ordersapi_sbe_v1_6
  title: Coinbase CoinbaseDerivatives OrdersApi Sbe v1.6
  license: GPL-3.0
  endian: le

doc: 'Coinbase Coinbase Derivatives Orders Api Sbe v1.6'
