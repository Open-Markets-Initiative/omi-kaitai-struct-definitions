# ---------------------------------------------------------------------
# Kaitai struct definition for: Tmx Mx SolaMulticast Hsvf v1.13
#
# Protocol:
...
meta:
  id: tmx_mx_solamulticast_hsvf_v1_13
  title: Tmx Mx SolaMulticast Hsvf v1.13
  license: GPL-3.0
  endian: be

doc: 'TMX Group Montreal Exchange Sola Multicast Hsvf v1.13'
  ...
  option_market_depth_message:
    seq:
      ...
      - id: instrument_status_marker
        ...
        encoding: ASCII
        doc: 'Indicates instrument status'
      - id: num_option_market_depth_level
        type: str
        size: 1
        encoding: ASCII
  ...
  future_options_instrument_keys_message:
    seq:
      ...
      - id: underlying_symbol_year
        ...
        size: 2
        encoding: ASCII
        doc: 'Last 2digits of the symbol yearof the underlying futures contract'
      - id: last_trading_datetime
        type: str
        size: 14
        encoding: ASCII
