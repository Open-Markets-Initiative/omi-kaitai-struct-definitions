# ---------------------------------------------------------------------
# Kaitai struct definition for: Nse NseCom Recovery Binary v7.0
#
# Protocol:
...
meta:
  id: nse_nsecom_recovery_binary_v7_0_client
  title: Nse NseCom Recovery Binary v7.0
  license: GPL-3.0
  endian: le

doc: 'National Stock Exchange of India Ltd NSE Commodity Derivatives Mtbt Tick Data Recovery Binary v7.0'
