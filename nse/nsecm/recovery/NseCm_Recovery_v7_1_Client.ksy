# ---------------------------------------------------------------------
# Kaitai struct definition for: Nse NseCm Recovery Binary v7.1
#
# Protocol:
...
meta:
  id: nse_nsecm_recovery_binary_v7_1_client
  title: Nse NseCm Recovery Binary v7.1
  license: GPL-3.0
  endian: le

doc: 'National Stock Exchange of India Ltd NSE Capital Market Mtbt Tick Data Recovery Binary v7.1'
