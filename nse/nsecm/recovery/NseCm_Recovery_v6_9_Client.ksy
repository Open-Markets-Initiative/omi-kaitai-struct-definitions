# ---------------------------------------------------------------------
# Kaitai struct definition for: Nse NseCm Recovery Binary v6.9
#
# Protocol:
...
meta:
  id: nse_nsecm_recovery_binary_v6_9_client
  title: Nse NseCm Recovery Binary v6.9
  license: GPL-3.0
  endian: le

doc: 'National Stock Exchange of India Ltd NSE Capital Market Mtbt Tick Data Recovery Binary v6.9'
