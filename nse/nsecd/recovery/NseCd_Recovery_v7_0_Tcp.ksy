# ---------------------------------------------------------------------
# Kaitai struct definition for: Nse NseCd Recovery Binary v7.0
#
# Protocol:
...
meta:
  id: nse_nsecd_recovery_binary_v7_0_tcp
  title: Nse NseCd Recovery Binary v7.0
  license: GPL-3.0
  endian: le

doc: 'National Stock Exchange of India Ltd NSE Currency Derivatives Mtbt Tick Data Recovery Binary v7.0'
