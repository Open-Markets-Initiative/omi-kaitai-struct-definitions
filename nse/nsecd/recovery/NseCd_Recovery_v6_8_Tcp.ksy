# ---------------------------------------------------------------------
# Kaitai struct definition for: Nse NseCd Recovery Binary v6.8
#
# Protocol:
...
meta:
  id: nse_nsecd_recovery_binary_v6_8_tcp
  title: Nse NseCd Recovery Binary v6.8
  license: GPL-3.0
  endian: le

doc: 'National Stock Exchange of India Ltd NSE Currency Derivatives Mtbt Tick Data Recovery Binary v6.8'
...
enums:
  message_type:
    ...
    0x43:
      ...
      doc: 'For CM and FO segment only. This message is sent whenever a Trade gets cancelled.'
    0x5a:
