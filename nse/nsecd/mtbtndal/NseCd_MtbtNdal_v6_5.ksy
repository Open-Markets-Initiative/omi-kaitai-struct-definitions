# ---------------------------------------------------------------------
# Kaitai struct definition for: Nse NseCd MtbtNdal Binary v6.5
#
# Protocol:
...
meta:
  id: nse_nsecd_mtbtndal_binary_v6_5
  title: Nse NseCd MtbtNdal Binary v6.5
  license: GPL-3.0
  endian: le

doc: 'National Stock Exchange of India Ltd NSE Currency Derivatives Multicast Tick By Tick Data Feed Binary v6.5'
...
types:
  ...
  new_order_message:
    seq:
      ...
      - id: price
        type: decimal_s4_7
        doc: 'Price of the order (In Paise). Implied decimal with scale 1e-7'
      - id: quantity
        type: s4
  ...
  trade_message:
    seq:
      ...
      - id: trade_price
        type: decimal_s4_7
        doc: 'Trade Price (In Paise). Implied decimal with scale 1e-7'
      - id: trade_quantity
        type: s4
        doc: 'Trade Quantity'
...
enums:
  message_type:
    ...
    0x43:
      ...
      doc: 'CM segment only. Sent whenever a Trade gets cancelled. Both the Order IDs will have value as zero in this message.'
    0x5a:
      id: 'heartbeat_message'
      doc: 'Sent when there is no data available for a few seconds, on all Streams. The sequence number field in the Stream Header will have the value 0 (zero) for this message.'
  order_type:
    0x42:
      id: 'buy_order'
      doc: 'Buy Order'
