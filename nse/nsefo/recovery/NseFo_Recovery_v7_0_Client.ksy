# ---------------------------------------------------------------------
# Kaitai struct definition for: Nse NseFo Recovery Binary v7.0
#
# Protocol:
...
meta:
  id: nse_nsefo_recovery_binary_v7_0_client
  title: Nse NseFo Recovery Binary v7.0
  license: GPL-3.0
  endian: le

doc: 'National Stock Exchange of India Ltd NSE Futures & Options Mtbt Tick Data Recovery Binary v7.0'
