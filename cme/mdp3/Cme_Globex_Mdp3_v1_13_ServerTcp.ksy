...
meta:
  id: cme_globex_mdp3_sbe_v1_13_servertcp
  ...
  fx_lot_type_rules_group:
    seq:
      ...
      - id: min_lot_size_u_int_64
        type: u8
        doc: 'For FX instruments in the repeating group with Tag 1093-LotType=2, Tag 1231-MinLotSize provides a Regular Amount - a default order size on the Workstation screen. With tag 1093-LotType= 5, Tag 1231-MinLotSize value represents standard min order qty increment. With tag 1093-LotType=6 tag 1231-MinLotSize contains SizePriorityQty for instruments trading with Match Algorithm = P (Size Priority)'
