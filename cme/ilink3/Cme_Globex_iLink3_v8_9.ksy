# ---------------------------------------------------------------------
# Kaitai struct definition for: Cme Globex iLink3 Sbe v8.9
#
# Protocol:
...
types:
  ...
  party_details_group:
    seq:
      - id: party_detail_id
        ...
        size: 20
        encoding: ASCII
        doc: 'The identification of the party. Required when NoPartyDetails, tag 1671 is not 0'
      - id: party_detail_role
        type: u2
        enum: party_detail_role
        doc: 'Identifies the type of PartyDetailID. Required when NoPartyDetails is not 0'
  trd_reg_publications_groups:
    seq:
      ...
      - id: trd_reg_publications_group
        ...
        repeat: expr
        repeat-expr: group_size.num_in_group
        doc: 'Number of regulatory publication rules in repeating group. Should always be set to 1 if being used otherwise set to 0'
  ...
  fills_group:
    seq:
      ...
      - id: fill_qty
        type: u4
        doc: 'Quantity bought or sold for this fill reason'
      - id: fill_exec_id
        type: str
        size: 2
        encoding: ASCII
        doc: 'Used as an identifier for each fill reason or allocation reported in single Execution Report. Required if NoFills (1362) is greater than 0. Append FillExecID with ExecID to derive unique identifier for each fill reason or allocation'
      - id: fill_yield_type
        type: u1
  ...
  requesting_party_ids_group:
    seq:
      - id: requesting_party_id
        ...
        size: 5
        encoding: ASCII
        doc: 'Party identifier for the requesting party. Required when NoRequestingPartyIDs(1657) is greater than 0'
      - id: requesting_party_id_source
        type: str
        size: 1
        encoding: ASCII
        doc: 'Identifies the source of the RequestingPartyID(1658) value. Required when NoRequestingPartyIDs(1657) is greater than 0. Constant value'
  ...
  party_ids_group:
    seq:
      - id: party_id
        type: u8
        doc: 'Required if NoPartyIDs(453) is greater than 0. Identification of the PartyDetailsListRequestID of PartyDetailsDefinitionRequestAck'
      - id: party_id_source
        type: str
        size: 1
        encoding: ASCII
        doc: 'Required if NoPartyIDs(453) is greater than 0. Used to identify classification source. Constant value'
      - id: party_role
        type: u2
  ...
  execution_report_trade_addendum_outright:
    seq:
      ...
      - id: exec_ref_id
        ...
        size: 40
        encoding: ASCII
        doc: 'References original Tag 17 ExecID value of the modified or canceled fill'
      - id: fills_groups
        type: fills_groups
        doc: 'NoFills Block'
  ...
  mass_quote_response:
    seq:
      ...
      - id: mass_quote_response_entries_groups
        ...
        doc: 'NoQuoteEntries Block'
  mass_quote_response_entries_groups:
    seq:
      - id: group_size
        type: group_size
        doc: 'Repeating group dimensions'
      - id: mass_quote_response_entries_group
...
enums:
  template_id:
    ...
    567:
      ...
      doc: 'MassQuoteRequest'
    568:
      id: 'quote_cancel_by_set'
      doc: 'QuoteCancelBySet'
    569:
      id: 'quote_cancel_by_group'
      doc: 'QuoteCancelByGroup'
    570:
      id: 'quote_cancel_by_instrument'
      doc: 'QuoteCancelByInstrument'
    571:
      id: 'mass_quote_response'
      doc: 'MassQuoteResponse'
