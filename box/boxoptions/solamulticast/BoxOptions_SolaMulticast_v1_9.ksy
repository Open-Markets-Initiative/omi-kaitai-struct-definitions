# ---------------------------------------------------------------------
# Kaitai struct definition for: Box BoxOptions SolaMulticast Hsvf v1.9
#
# Protocol:
...
meta:
  id: box_boxoptions_solamulticast_hsvf_v1_9
  title: Box BoxOptions SolaMulticast Hsvf v1.9
  license: GPL-3.0
  endian: be

doc: 'Box Options Market BOX Options Exchange Sola Multicast Hsvf v1.9'
doc-ref: https://boxoptions.com/technology/trading-interface-specifications
  ...
  - id: message_body
    type:
      ...
      cases:
        ...
        '"GS"': strategies_group_status_message
...
types:
  ...
  option_trade_message:
    seq:
      ...
      - id: opra_trade_marker
        type: str
        size: 1
        encoding: ASCII
        doc: 'Contains the OPRA Trade Marker for both Non FLEX Single-Leg Floor (QOO) and FLEX Single-Leg Floor (FOO)'
      - id: filler_5
        size: 5
        doc: 'Filler'
      - id: timestamp
  ...
  group_status_message:
    seq:
      ...
      - id: group_status
        ...
        enum: group_status
        doc: 'Value is O'
  strategies_group_status_message:
    seq:
      - id: exchange_id
        type: str
        size: 1
