# ---------------------------------------------------------------------
# Kaitai struct definition for: Box BoxOptions SolaMulticast Hsvf v1.8
#
# Protocol:
...
meta:
  id: box_boxoptions_solamulticast_hsvf_v1_8
  title: Box BoxOptions SolaMulticast Hsvf v1.8
  license: GPL-3.0
  endian: be

doc: 'Box Options Market BOX Options Exchange Sola Multicast Hsvf v1.8'
