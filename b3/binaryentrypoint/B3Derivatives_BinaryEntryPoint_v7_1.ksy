  ...
  client_app_version:
    seq:
      ...
      - id: client_app_version_data
        ...
        encoding: ASCII
        if: len_client_app_version_data > 0
        doc: 'Client system information'
  ...
  simple_new_order_message:
    seq:
      ...
      - id: self_trade_prevention_instruction
        type: u1_nullable
        doc: 'selfTradePreventionInstruction. Nullable, No Value = 0'
      - id: security_id
        type: u8
        doc: 'securityID'
      - id: side
  ...
  execution_report_forward_message:
    seq:
      ...
      - id: fixed_rate_optional
        type: decimal_s8_4_nullable
        doc: 'fixedRate. Implied decimal with scale 1e-4. Nullable, No Value = -9223372036854775808'
      - id: order_qty
        type: u8
        doc: 'orderQty'
      - id: desk_id
  ...
  order_mass_action_request_message:
    seq:
      ...
      - id: action_target_session_id
        type: u4_nullable
        doc: 'actionTargetSessionID. Nullable, No Value = 0'
      - id: action_target_group_id
        type: u4_nullable
        doc: 'actionTargetGroupID. Nullable, No Value = 0'
