# ---------------------------------------------------------------------
# Kaitai struct definition for: B3 B3Derivatives BinaryEntryPoint Sbe v7.1
#
# Protocol:
...
meta:
  id: b3_b3derivatives_binaryentrypoint_sbe_v7_1
  title: B3 B3Derivatives BinaryEntryPoint Sbe v7.1
  license: GPL-3.0
  endian: le

doc: 'Brasil, Bolsa, Balcão B3 Derivatives Binary Entry Point Sbe v7.1'
...
types:
  ...
  simple_new_order_message:
    seq:
      ...
      - id: routing_instruction
        type: u1
        enum: routing_instruction
        doc: 'routingInstruction'
      - id: deprecated_investor_id
        type: deprecated_investor_id
        doc: 'deprecatedInvestorID data struct'
      - id: memo
        type: memo
  ...
  new_order_single_message:
    seq:
      ...
      - id: stop_px
        type: decimal_s8_4
        doc: 'stopPx. Implied decimal with scale 1e-4'
      - id: min_qty
        type: u8
        doc: 'minQty'
      - id: max_floor
  ...
  order_cancel_request_message:
    seq:
      ...
      - id: single_cancel_restatement_reason
        type: u1
        enum: single_cancel_restatement_reason
  ...
  execution_report_new_message:
    seq:
      ...
      - id: market_segment_received_time
        type: nanosecond_timestamp
        doc: 'marketSegmentReceivedTime. Nanoseconds since Unix epoch'
      - id: protection_price
        type: decimal_s8_4
        doc: 'protectionPrice. Implied decimal with scale 1e-4'
      - id: trade_date
        type: u2
        doc: 'tradeDate'
  ...
  execution_report_forward_message:
    seq:
      ...
      - id: exec_ref_id
        type: u8
        doc: 'execRefID'
      - id: fixed_rate_optional
        type: decimal_s8_4
        doc: 'fixedRate. Implied decimal with scale 1e-4'
      - id: order_qty
        type: u8
        doc: 'orderQty'
      - id: desk_id
  ...
  legs_group:
    seq:
      ...
      - id: leg_side
        type: u1
        enum: leg_side
        doc: 'The side of this individual leg (multileg security). See Side (54) field for description and values'
      - id: padding_1
        size: 1
        doc: '1 bytes padding'
  ...
  position_maintenance_request_message:
    seq:
      ...
      - id: threshold_amount
        type: decimal_s8_4
        doc: 'thresholdAmount. Implied decimal with scale 1e-4'
      - id: account
        type: u4
        doc: 'account'
      - id: sender_location
  ...
  order_mass_action_request_message:
    seq:
      ...
      - id: mass_cancel_restatement_reason
        type: u1
        enum: mass_cancel_restatement_reason
        doc: 'execRestatementReason'
      - id: ord_tag_id
        type: u1
        doc: 'ordTagID'
      ...
      - id: security_id_optional
        type: u8
        doc: 'securityID'
      - id: action_target_session_id
        type: u4
        doc: 'actionTargetSessionID'
      - id: action_target_group_id
        type: u4
        doc: 'actionTargetGroupID'
  order_mass_action_report_message:
    seq:
      ...
      - id: mass_action_reject_reason
        type: u1
        enum: mass_action_reject_reason
        doc: 'massActionRejectReason'
      - id: mass_cancel_restatement_reason
        type: u1
        enum: mass_cancel_restatement_reason
        doc: 'execRestatementReason'
  ...
  comp_ids_group:
    seq:
      - id: ref_comp_id
        type: u4
        doc: 'Used to identify the sessionID belonged to the given group (actionTargetGroupID)'
