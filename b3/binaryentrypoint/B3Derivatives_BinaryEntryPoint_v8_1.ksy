# ---------------------------------------------------------------------
# Kaitai struct definition for: B3 B3Derivatives BinaryEntryPoint Sbe v8.1
#
# Protocol:
...
meta:
  id: b3_b3derivatives_binaryentrypoint_sbe_v8_1
  title: B3 B3Derivatives BinaryEntryPoint Sbe v8.1
  license: GPL-3.0
  endian: le

doc: 'Brasil, Bolsa, Balcão B3 Derivatives Binary Entry Point Sbe v8.1'
