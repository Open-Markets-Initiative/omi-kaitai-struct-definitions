# ---------------------------------------------------------------------
# Kaitai struct definition for: B3 B3Derivatives BinaryEntryPoint Sbe v8.4
#
# Protocol:
...
meta:
  id: b3_b3derivatives_binaryentrypoint_sbe_v8_4
  title: B3 B3Derivatives BinaryEntryPoint Sbe v8.4
  license: GPL-3.0
  endian: le

doc: 'Brasil, Bolsa, Balcão B3 Derivatives Binary Entry Point Sbe v8.4'
...
types:
  ...
  new_order_cross_message:
    seq:
      - id: inbound_business_header
        type: inbound_business_header
        doc: 'InboundBusinessHeader'
      - id: ord_type_cross_ord_type_optional
        type: u1
        enum: ord_type_cross_ord_type_optional
        doc: 'ordType'
  ...
  execution_report_new_message:
    seq:
      ...
      - id: received_time
        type: nanosecond_timestamp
        doc: 'receivedTime. Nanoseconds since Unix epoch'
      ...
      - id: mm_protection_reset_boolean_optional
        type: u1
        enum: mm_protection_reset_boolean_optional
        doc: 'mmProtectionReset'
...
enums:
  ...
  ord_type_cross_ord_type_optional:
    0x31:
      id: 'market'
      doc: 'CrossOrdType Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    0x32:
      id: 'limit'
      doc: 'CrossOrdType Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
  crossed_indicator:
