# ---------------------------------------------------------------------
# Kaitai struct definition for: B3 B3Derivatives BinaryEntryPoint Sbe v7.0
#
# Protocol:
...
meta:
  id: b3_b3derivatives_binaryentrypoint_sbe_v7_0
  title: B3 B3Derivatives BinaryEntryPoint Sbe v7.0
  license: GPL-3.0
  endian: le

doc: 'Brasil, Bolsa, Balcão B3 Derivatives Binary Entry Point Sbe v7.0'
