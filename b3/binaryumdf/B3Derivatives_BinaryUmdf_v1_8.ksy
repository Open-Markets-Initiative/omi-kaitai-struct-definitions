# ---------------------------------------------------------------------
# Kaitai struct definition for: B3 B3Derivatives BinaryUmdf Sbe v1.8
#
# Protocol:
...
meta:
  id: b3_b3derivatives_binaryumdf_sbe_v1_8
  title: B3 B3Derivatives BinaryUmdf Sbe v1.8
  license: GPL-3.0
  endian: le

doc: 'Brasil, Bolsa, Balcão B3 Derivatives Binary Unified Market Data Feed Sbe v1.8'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'template_id::deprecatedsecurity_definition_message': deprecated_security_definition_message
            ...
            'template_id::price_band_20_message': price_band_20_message
  ...
  deprecated_security_definition_message:
    seq:
      ...
      - id: maturity_month_year
        ...
        doc: 'SecurityDefinition_4Message'
      ...
      - id: price_type_price_type_optional
        type: u1
        enum: price_type_price_type_optional
        doc: 'priceType'
      ...
      - id: deprecated_legs_groups
        type: deprecated_legs_groups
        doc: 'noLegs Block'
      - id: deprecated_instr_attribs_groups
        type: deprecated_instr_attribs_groups
  ...
  contract_settl_month:
    seq:
      ...
      - id: week
        type: u1
        doc: 'week'
  deprecated_underlyings_groups:
    seq:
      - id: group_size_encoding
        type: group_size_encoding
        doc: 'GroupSizeEncoding'
      - id: deprecated_underlyings_group
        type: deprecated_underlyings_group
        repeat: expr
  ...
  deprecated_legs_groups:
    seq:
      - id: group_size_encoding
        type: group_size_encoding
        doc: 'GroupSizeEncoding'
      - id: deprecated_legs_group
        type: deprecated_legs_group
        repeat: expr
        repeat-expr: group_size_encoding.num_in_group
        doc: 'noLegs'
  deprecated_legs_group:
    seq:
      - id: leg_security_id
        type: u8
      ...
      - id: leg_symbol
        ...
        encoding: ASCII
        doc: 'Leg symbol'
  deprecated_instr_attribs_groups:
    seq:
      - id: group_size_encoding
        type: group_size_encoding
        doc: 'GroupSizeEncoding'
      - id: deprecated_instr_attribs_group
        type: deprecated_instr_attribs_group
        repeat: expr
        repeat-expr: group_size_encoding.num_in_group
        doc: 'noInstrAttribs'
  deprecated_instr_attribs_group:
    seq:
...
enums:
  template_id:
    ...
    4:
      id: 'deprecatedsecurity_definition_message'
      doc: 'SecurityDefinition_4Message'
    12:
    ...
    20:
      id: 'price_band_20_message'
      doc: 'PriceBand_20Message'
    21:
