# ---------------------------------------------------------------------
# Kaitai struct definition for: B3 B3Derivatives BinaryUmdf Sbe v2.2
#
# Protocol:
...
meta:
  id: b3_b3derivatives_binaryumdf_sbe_v2_2
  title: B3 B3Derivatives BinaryUmdf Sbe v2.2
  license: GPL-3.0
  endian: le

doc: 'Brasil, Bolsa, Balcão B3 Derivatives Binary Unified Market Data Feed Sbe v2.2'
...
types:
  ...
  security_definition_message:
    seq:
      ...
      - id: opt_payout_type
        type: u1_nullable
        doc: 'optPayoutType. Nullable, No Value = 0'
  ...
  snapshot_full_refresh_header_30_message:
    seq:
      ...
      - id: last_sequence_version
        type: u2_nullable
        doc: 'lastSequenceVersion. Nullable, No Value = 0'
  order_mb_o_50_message:
    seq:
      ...
      - id: transact_time
        type: u8_nullable
        doc: 'transactTime. Nullable, No Value = 0'
      - id: md_entry_prev_size
        type: s8_nullable
        doc: 'mDEntryPrevSize. Nullable, No Value = -9223372036854775808'
...
enums:
  ...
  opt_payout_type:
    1:
      id: 'vanilla'
      doc: 'OptPayoutType Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    2:
      id: 'capped'
      doc: 'OptPayoutType Scaled.Binary.Specification.Load.Sbe.V1.Xml.Xml.typesEnumValidValue'
    3:
