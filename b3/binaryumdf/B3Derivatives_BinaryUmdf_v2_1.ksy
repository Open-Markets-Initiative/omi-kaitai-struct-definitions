# ---------------------------------------------------------------------
# Kaitai struct definition for: B3 B3Derivatives BinaryUmdf Sbe v2.1
#
# Protocol:
...
meta:
  id: b3_b3derivatives_binaryumdf_sbe_v2_1
  title: B3 B3Derivatives BinaryUmdf Sbe v2.1
  license: GPL-3.0
  endian: le

doc: 'Brasil, Bolsa, Balcão B3 Derivatives Binary Unified Market Data Feed Sbe v2.1'
