# ---------------------------------------------------------------------
# Kaitai struct definition for: Iex IexOptions MarketData Sbe v1.04
#
# Protocol:
...
meta:
  id: iex_iexoptions_marketdata_sbe_v1_04
  title: Iex IexOptions MarketData Sbe v1.04
  license: GPL-3.0
  endian: le

doc: 'Investors Exchange IEX Options Market Data Sbe v1.04'
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'template_id::sequence_number_reset_message': sequence_number_reset_message
...
enums:
  template_id:
    ...
    303:
      ...
      doc: 'SequenceNumberResetMessage'
    400:
