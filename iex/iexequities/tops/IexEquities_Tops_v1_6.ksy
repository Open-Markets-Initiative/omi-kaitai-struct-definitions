# ---------------------------------------------------------------------
# Kaitai struct definition for: Iex IexEquities Tops Snap v1.6
#
# Protocol:
...
meta:
  id: iex_iexequities_tops_snap_v1_6
  title: Iex IexEquities Tops Snap v1.6
  license: GPL-3.0
  endian: le

doc: 'Investors Exchange IEX Equities Tops Snap v1.6'
...
types:
  ...
  snapshot_request_message:
    seq:
      ...
      - id: channel_id
        type: u4
        doc: 'Channel identifier from the Tops feed IexTp header'
      - id: session_id
        type: u4
        doc: 'Session identifier from the Tops feed IexTp header'
  ...
  snapshot_data_message:
    seq:
      - id: iex_tp_header
        ...
        size: 1
        encoding: ASCII
        doc: 'IexTp header for the wrapped Tops feed message, see the Iex Transport specification'
      ...
      - id: iex_tp_message_length
        type: u2
        doc: 'Length of the wrapped Tops message in bytes not including this field'
      - id: iex_tp_message_type
        type: u1
        enum: iex_tp_message_type
        doc: 'Code identifying the wrapped Tops message type'
      - id: iex_tp_message_data
        type:
          ...
          cases:
            ...
            'iex_tp_message_type::quote_update_message': quote_update_message
...
enums:
  message_type:
    0x72:
      ...
      doc: 'The Snapshot Request message is sent from the client to the Tops Snap server to authenticate and request a Snapshot Response'
    0x65:
      id: 'error_response_message'
      doc: 'Sent by the Tops Snap server to the client when a Snapshot Request is rejected'
    0x73:
      id: 'snapshot_start_message'
      doc: 'First message of a Snapshot Response sent from the Tops Snap server when a Snapshot Request is successful'
    0x64:
      id: 'snapshot_data_message'
      doc: 'Carries one complete Tops feed message wrapped with an IexTp header providing Tops feed sequencing and timing information'
    0x78:
