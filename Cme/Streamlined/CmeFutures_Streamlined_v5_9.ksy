# ---------------------------------------------------------------------
# Omi Kaitai Struct Definition: Cme CmeFutures Streamlined v5.9
#
# Please see end of file for rules and regulations
# ---------------------------------------------------------------------

meta:
  id: cmefutures_streamlined_v5_9
  title: Cme CmeFutures Streamlined Sbe v5.9
  license: GPL-3.0
  endian: le

doc: 'CME Group Chicago Mercantile Exchange Futures Streamlined Market Data Sbe v5.9'
