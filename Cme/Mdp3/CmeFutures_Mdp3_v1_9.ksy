# ---------------------------------------------------------------------
# Omi Kaitai Struct Definition: Cme CmeFutures Mdp3 v1.9
#
# Please see end of file for rules and regulations
# ---------------------------------------------------------------------

meta:
  id: cmefutures_mdp3_v1_9
  title: Cme CmeFutures Mdp3 Sbe v1.9
  license: GPL-3.0
  endian: le

doc: 'CME Group Chicago Mercantile Exchange Futures Market Data Platform 3 Sbe v1.9'
