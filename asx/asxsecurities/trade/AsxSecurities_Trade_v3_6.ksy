# ---------------------------------------------------------------------
# Kaitai struct definition for: Asx AsxSecurities Trade Ouch v3.6
#
# Protocol:
...
meta:
  id: asx_asxsecurities_trade_ouch_v3_6
  title: Asx AsxSecurities Trade Ouch v3.6
  license: GPL-3.0
  endian: be

doc: 'Australian Securities Exchange Asx Securities Asx Trade Ouch v3.6'
doc-ref: https://asxonline.com/public/documents/asx-trade-technical-library.html
...
types:
  ...
  order_executed_message:
    seq:
      ...
      - id: trade_price
        type: decimal_s4_2
        doc: 'Price that the order traded at. Implied decimal with scale 1e-2'
      - id: match_id
        size: 12
      ...
      - id: deal_source
        type: u2
        enum: deal_source
        doc: 'The deal source is a numeric code that gives information about how the execution took place. The code matches the deal_source_c variable disseminated in the ASX Trade Open Interface'
      - id: match_attributes
      ...
      - id: unsequenced_message
        ...
        type:
          ...
          cases:
            ...
            'unsequenced_message_type::cancel_by_order_id_message': cancel_by_order_id_message
  enter_order_message:
    seq:
      - id: order_token
        type: str
...
enums:
  ...
  deal_source:
    1:
      id: 'continuous_automatch'
      doc: 'Single Series To Single Series Automatched During Continuous Trading'
    20:
      id: 'auction_automatch'
      doc: 'Single Series To Single Series Automatched During An Auction'
    36:
      id: 'tailor_made_combination_match'
      doc: 'Tailor Made Combination Match'
    10:
      id: 'deleted_by_asx'
      doc: 'Order Deleted By Asx On Behalf Of The Customer'
    44:
      id: 'booked_ucp_transaction'
      doc: 'Booked Transaction Resulting From Unintentional Crossing Prevention'
    45:
      id: 'booked_ucp_auction_transaction'
      doc: 'Booked Transaction Resulting From Unintentional Crossing Prevention During An Auction'
    46:
      id: 'centre_point_preference_matched_trade'
      doc: 'Centre Point Preference Matched Trade'
    47:
      id: 'centre_point_trade'
      doc: 'Centre Point Trade'
    48:
      id: 'centre_point_booked_ucp'
      doc: 'Centre Point Booked Transaction Resulting From Unintentional Crossing Prevention'
    49:
      id: 'reserved'
    ...
    50:
      ...
      doc: 'Block Trade'
    51:
      id: 'preference_block_trade'
      doc: 'Preference Block Trade'
    52:
      id: 'reserved_52'
      doc: 'Reserved For Future Use'
  crossing_dealing_capacity:
    0:
      id: 'not_crossed'
      doc: 'Order Was Not Crossed Or Crossed With An Order That Was Not Defined As Principal Agency Or Mixed'
    1:
      id: 'principal_order'
