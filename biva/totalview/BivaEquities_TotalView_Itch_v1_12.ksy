# ---------------------------------------------------------------------
# Kaitai struct definition for: Biva BivaEquities TotalView Itch v1.12
#
# Protocol:
...
meta:
  id: biva_bivaequities_totalview_itch_v1_12
  title: Biva BivaEquities TotalView Itch v1.12
  license: GPL-3.0
  endian: be

doc: 'Bolsa Institucional de Valores Biva Equities Total View Itch v1.12'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::participant_directory_message': participant_directory_message
            ...
            'message_type::indicative_price_quantity_message': indicative_price_quantity_message
  message_header:
    seq:
      - id: message_length
        type: u2
  ...
  order_executed_message:
    seq:
      ...
      - id: match_number
        type: u8
        doc: 'The unique match identifier'
      - id: trade_indicator
        type: u1
        enum: trade_indicator
        doc: 'Regular trade or unintentional self-cross'
      - id: stat_update
        type: u1
        enum: stat_update
        doc: 'Indicates which stats are updated by this trade'
      - id: aggressor_participant_id
        type: u4
        doc: 'Unique participant firm identifier for the aggressor order'
  order_executed_with_price_message:
    seq:
      ...
      - id: printable
        type: u1
        enum: printable
        doc: 'Indicates if the execution should be reflected in volume calculations'
      - id: execution_price
        type: u4
  ...
  trade_message:
    seq:
      ...
      - id: stat_update
        ...
        enum: stat_update
        doc: 'Indicates which stats are updated by this trade'
      - id: buy_participant_id
        type: u4
        doc: 'Unique participant firm identifier for the buyer'
      - id: sell_participant_id
        type: u4
        doc: 'Unique participant firm identifier for the seller'
  ...
  order_replace_message:
    seq:
      ...
      - id: new_order_number
        type: u8
        doc: 'The new reference number for the order at the time of replacement'
      - id: quantity
        type: u8
        doc: 'Total quantity of the order being added to the book'
      - id: price
...
enums:
  message_type:
    ...
    0x43:
      ...
      doc: 'Order executed with price'
    0x50:
      id: 'trade_message'
      doc: 'Trade message'
    0x42:
      id: 'broken_trade_message'
      doc: 'Busted trade message'
    0x44:
  ...
  trade_indicator:
    0x43:
      id: 'intentional_cross_trade'
      doc: 'Intentional Cross Trade'
    0x45:
      id: 'exceptional_cross_trade_at_vwap'
      doc: 'Exceptional Cross Trade At Vwap'
    0x49:
      id: 'ipo_cross'
      doc: 'Ipo Cross'
    0x52:
      ...
      doc: 'Regular Trade'
    0x55:
      id: 'unintentional_selfcross'
      doc: 'Unintentional Selfcross'
  stat_update:
    0x41:
      id: 'all_stats'
      doc: 'All Stats'
    0x56:
      id: 'last_traded_price_and_volume'
      doc: 'Last Traded Price And Volume'
    0x4c:
      id: 'last_traded_price_only'
      doc: 'Last Traded Price Only'
    0x43:
      id: 'volume_only'
      doc: 'Volume Only'
    0x4e:
