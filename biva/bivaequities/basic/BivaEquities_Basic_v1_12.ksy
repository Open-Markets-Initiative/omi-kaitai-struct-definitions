# ---------------------------------------------------------------------
# Kaitai struct definition for: Biva BivaEquities Basic Itch v1.12
#
# Protocol:
...
meta:
  id: biva_bivaequities_basic_itch_v1_12
  title: Biva BivaEquities Basic Itch v1.12
  license: GPL-3.0
  endian: be

doc: 'Bolsa Institucional de Valores Biva Equities Basic Itch v1.12'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::best_bid_offer_message': best_bid_offer_message
  ...
  best_bid_offer_message:
    seq:
      ...
      - id: best_bid
        type: u4
        doc: 'The best buy price'
      - id: best_bid_size
        type: u8
        doc: 'Total quantity at the best buy price'
      - id: best_offer
        type: u4
        doc: 'The best sell price'
      - id: best_offer_size
        type: u8
        doc: 'Total quantity at the best sell price'
...
enums:
  message_type:
    ...
    0x51:
      ...
      doc: 'Best bid offer quotation message'
    0x58:
