...
meta:
  id: bse_bseindia_eti_fbe_v1_6_14_server
...
seq:
  - id: server_message
    ...
    repeat: eos
    doc: 'Bse Eti Message sent by Bse to the participant'
...
types:
      ...
      - id: server_payload
        ...
        type:
          ...
          cases:
            ...
            'template_id::debt_inquiry_response': debt_inquiry_response
            ...
            'template_id::gw_order_acknowledgement': gw_order_acknowledgement
            ...
            'template_id::multi_leg_exec_report_broadcast': multi_leg_exec_report_broadcast
            'template_id::multi_leg_exec_response': multi_leg_exec_response
            'template_id::multi_leg_order_reject': multi_leg_order_reject
            ...
            'template_id::quote_exec_report_broadcast': quote_exec_report_broadcast
            ...
            'template_id::risk_collateral_alert_admin_broadcast': risk_collateral_alert_admin_broadcast
            'template_id::risk_collateral_alert_broadcast': risk_collateral_alert_broadcast
            ...
            'template_id::session_password_change_response': session_password_change_response
            'template_id::session_registration_response': session_registration_response
            ...
            'template_id::trade_enhancement_broadcast': trade_enhancement_broadcast
            ...
            'template_id::user_password_change_response': user_password_change_response
  message_header:
    seq:
      - id: body_len
        type: u4
  ...
  logon_response:
    seq:
      ...
      - id: no_of_partition
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
      - id: days_left_for_passwd_expiry
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
      - id: grace_logins_left
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
  ...
  modify_order_response:
    seq:
      ...
      - id: rollover_flag
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
  multi_leg_exec_report_broadcast:
    seq:
      - id: filler4
        size: 2
      - id: rbc_header_me_comp
      ...
      - id: account_type
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
      - id: num_multi_leg_grp_comp
        type: u1
        doc: 'Nullable, No Value = 0xFF'
      - id: num_multi_leg_fill_grp_comp
        type: u1
        doc: 'Nullable, No Value = 0xFF'
      - id: algo_id
        type: str
      ...
      - id: pad3
        size: 3
      - id: multi_leg_grp_comp
        type: multi_leg_grp_comp
        repeat: expr
        repeat-expr: num_multi_leg_grp_comp
      - id: multi_leg_fill_grp_comp
        type: multi_leg_fill_grp_comp
        repeat: expr
        repeat-expr: num_multi_leg_fill_grp_comp
  ...
  multi_leg_exec_response:
    seq:
      ...
      - id: num_instrmnt_leg_exec_grp_comp
        type: u2
        doc: 'Nullable, No Value = 0xFFFF'
      - id: num_multi_leg_exec_grp_comp
        type: u1
        doc: 'Nullable, No Value = 0xFF'
      - id: num_multi_leg_fill_grp_comp
        type: u1
      ...
      - id: pad4
        size: 4
      - id: multi_leg_exec_grp_comp
        type: multi_leg_exec_grp_comp
        repeat: expr
        repeat-expr: num_multi_leg_exec_grp_comp
      - id: multi_leg_fill_grp_comp
        type: multi_leg_fill_grp_comp
        repeat: expr
        repeat-expr: num_multi_leg_fill_grp_comp
  ...
  retransmit_response:
    seq:
      ...
      - id: pad6
        size: 6
  risk_collateral_alert_admin_broadcast:
    seq:
      - id: filler4
        size: 2
      - id: rbc_header_comp
      ...
      - id: total_collateral
        type: s8_nullable
        doc: 'Nullable, No Value = 0x8000000000000000'
      - id: utilized_collateral
        type: s8_nullable
        doc: 'Nullable, No Value = 0x8000000000000000'
      - id: unutilized_collateral
        type: s8_nullable
        doc: 'Nullable, No Value = 0x8000000000000000'
      - id: orig_time
        type: nanosecond_timestamp_nullable
        doc: 'Nanoseconds since Unix epoch. Nullable, No Value = 0xFFFFFFFFFFFFFFFF'
      - id: percentage_utilized
        type: s4_nullable
        doc: 'Nullable, No Value = 0x80000000'
      - id: market_segment_id
        type: s4_nullable
      ...
      - id: alignment_padding
        ...
        if: _parent.message_header.body_len != _io.pos
        doc: 'Alignment'
  risk_collateral_alert_broadcast:
    seq:
      - id: filler4
        size: 2
      - id: rbc_header_comp
  ...
  nrbc_header_comp:
    seq:
      ...
      - id: pad2
        size: 2
  session_password_change_response:
    seq:
      - id: filler4
        size: 2
      - id: response_header_comp
        type: response_header_comp
  session_registration_response:
    seq:
      - id: filler4
        size: 2
      - id: response_header_comp
  ...
  trade_enhancement_broadcast:
    seq:
      ...
      - id: side
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
      - id: auto_accept_indicator
        type: u1
        enum: auto_accept_indicator
      - id: cp_code
        type: str
        size: 12
        encoding: ASCII
