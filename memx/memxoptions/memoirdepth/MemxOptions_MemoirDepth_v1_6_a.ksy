# ---------------------------------------------------------------------
# Kaitai struct definition for: Memx MemxOptions MemoirDepth Sbe v1.6.a
#
# Protocol:
...
meta:
  id: memx_memxoptions_memoirdepth_sbe_v1_6_a
  title: Memx MemxOptions MemoirDepth Sbe v1.6.a
  license: GPL-3.0
  endian: be

doc: 'The Members Exchange Memx Options Member Order Information Record Depth Sbe v1.6.a'
      ...
      - id: payload
        type:
          ...
          cases:
            ...
            'template_id::options_instrument_status_message': options_instrument_status_message
            'template_id::underlier_instrument_status_message': underlier_instrument_status_message
            ...
            'template_id::order_added_short_message': order_added_short_message
            'template_id::order_added_long_message': order_added_long_message
            'template_id::order_added_extended_message': order_added_extended_message
  ...
  instrument_directory_message:
    seq:
      ...
      - id: is_test_symbol
        ...
        enum: is_test_symbol
        doc: 'IsTestSymbol'
  options_instrument_status_message:
    seq:
      - id: timestamp
        type: nanosecond_timestamp
        doc: 'Timestamp. Nanoseconds since Unix epoch'
      ...
      - id: trading_session
        ...
        doc: 'TradingSession'
  underlier_instrument_status_message:
    seq:
      - id: timestamp
        type: nanosecond_timestamp
        doc: 'Timestamp. Nanoseconds since Unix epoch'
...
enums:
  ...
  template_id:
    ...
    2:
      id: 'options_instrument_status_message'
      doc: 'OptionsInstrumentStatusMessage'
    3:
      id: 'underlier_instrument_status_message'
      doc: 'UnderlierInstrumentStatusMessage'
    5:
    ...
    10:
      id: 'order_added_short_message'
      doc: 'OrderAddedShortMessage'
    11:
      id: 'order_added_long_message'
      doc: 'OrderAddedLongMessage'
    12:
      id: 'order_added_extended_message'
      doc: 'OrderAddedExtendedMessage'
    13:
