# ---------------------------------------------------------------------
# Kaitai struct definition for: Memx MemxEquities MemoirDepthFeed Sbe v1.1
#
# Protocol:
...
meta:
  id: memx_memxequities_memoirdepthfeed_sbe_v1_1
  title: Memx MemxEquities MemoirDepthFeed Sbe v1.1
  license: GPL-3.0
  endian: be

doc: 'The Members Exchange Memx Equities Memoir Depth Feed Sbe v1.1'
