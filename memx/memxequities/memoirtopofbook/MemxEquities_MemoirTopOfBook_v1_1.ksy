# ---------------------------------------------------------------------
# Kaitai struct definition for: Memx MemxEquities MemoirTopOfBook Sbe v1.1
#
# Protocol:
...
meta:
  id: memx_memxequities_memoirtopofbook_sbe_v1_1
  title: Memx MemxEquities MemoirTopOfBook Sbe v1.1
  license: GPL-3.0
  endian: be

doc: 'The Members Exchange Memx Equities Memoir Top Of Book Sbe v1.1'
