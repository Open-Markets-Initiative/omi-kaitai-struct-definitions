# ---------------------------------------------------------------------
# Kaitai struct definition for: BruceAts LastSale Itch v1.0
#
# Protocol:
...
meta:
  id: bruceats_bruceequities_lastsale_itch_v1_0
  title: BruceAts LastSale Itch v1.0
  license: GPL-3.0
  endian: be

doc: 'Bruce ATS Bruce ATS Equities Last Sale Itch v1.0'
...
enums:
  message_type:
    ...
    0x54:
      ...
      doc: 'Bruce Last Sale will broadcast a real-time update every time that the system produces a trade during the trading day.'
    0x58:
      id: 'trade_cancel_message'
      doc: 'Bruce Last Sale will broadcast a real-time update every time that the system cancels a trade during the trading day.'
  event_code:
    0x4f:
