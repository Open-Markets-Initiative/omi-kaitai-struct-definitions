# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets MoonAts DepthOfBook Link v1.3
#
# Protocol:
...
meta:
  id: otcmarkets_moonats_depthofbook_link_v1_3
  title: OtcMarkets MoonAts DepthOfBook Link v1.3
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group MOON ATS OTC Depth of Book Link v1.3'
