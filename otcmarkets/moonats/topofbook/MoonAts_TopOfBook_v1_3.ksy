# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets MoonAts TopOfBook Link v1.3
#
# Protocol:
...
meta:
  id: otcmarkets_moonats_topofbook_link_v1_3
  title: OtcMarkets MoonAts TopOfBook Link v1.3
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group MOON ATS OTC Top of Book Link v1.3'
...
enums:
  message_type:
    ...
    20:
      ...
      doc: 'This message appears on all channels and is sent out at the start of each MOON trading session: Order Acceptance at 7:30 PM, Market Open at 8:00 PM, Market Close at 4 AM. The message can also be sent mid-day if a technical outage caused a temporary closure of the market.'
    9:
      id: 'security_message'
  ...
  trading_session:
    1:
      id: 'order_acceptance'
      doc: 'Order Acceptance 730 Pm'
    5:
      id: 'market_close'
      doc: 'Market Close 4 Am'
    6:
      id: 'overnight'
      doc: 'Overnight 8 Pm'
  security_action:
