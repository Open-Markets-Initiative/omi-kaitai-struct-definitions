# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets MoonAts Retransmission Link v1.3
#
# Protocol:
...
meta:
  id: otcmarkets_moonats_retransmission_link_v1_3
  title: OtcMarkets MoonAts Retransmission Link v1.3
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group MOON ATS OTC Retransmission Link v1.3'
...
enums:
  message_type:
    ...
    20:
      ...
      doc: 'Appears in the TCP spin response payload (and on all UDP channels). Sent at the start of each MOON trading session: Order Acceptance at 7:30 PM, Market Open at 8:00 PM, Market Close at 4 AM.'
    9:
      id: 'security_message'
