# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets LinkNqb TopOfBook Link v1.18
#
# Protocol:
...
meta:
  id: otcmarkets_linknqb_topofbook_link_v1_18
  title: OtcMarkets LinkNqb TopOfBook Link v1.18
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group OTC Link NQB OTC Top of Book Link v1.18'
