# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets Overnight DepthOfBook Link v1.0
#
# Protocol:
...
meta:
  id: otcmarkets_overnight_depthofbook_link_v1_0
  title: OtcMarkets Overnight DepthOfBook Link v1.0
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group OTC Link Overnight OTC OTC Depth of Book Link v1.0'
