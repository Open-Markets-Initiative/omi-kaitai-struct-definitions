# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets Overnight Retransmission Link v1.0
#
# Protocol:
...
meta:
  id: otcmarkets_overnight_retransmission_link_v1_0
  title: OtcMarkets Overnight Retransmission Link v1.0
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group OTC Link Overnight OTC OTC Retransmission Link v1.0'
...
enums:
  message_type:
    ...
    20:
      ...
      doc: 'Appears in the TCP spin response payload (and on all UDP channels). Sent at the start of each Overnight OTC IDQS trading session: Order Acceptance at 7:00 PM, Market Open at 8:00 PM, Market Close at 7:45 AM.'
    9:
      id: 'security_message'
    ...
    28:
      ...
      doc: 'Appears in the TCP spin response payload. Not available in the Overnight TradingSession.'
    74:
