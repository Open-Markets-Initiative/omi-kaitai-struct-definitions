# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets Overnight TopOfBook Link v1.0
#
# Protocol:
...
meta:
  id: otcmarkets_overnight_topofbook_link_v1_0
  title: OtcMarkets Overnight TopOfBook Link v1.0
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group OTC Link Overnight OTC OTC Top of Book Link v1.0'
...
types:
  ...
  top_of_book_message:
    seq:
      ...
      - id: ask_price
        type: decimal_u8_6
        doc: 'Best Ask Price. The long value represents the price scaled by 1,000,000 (6 decimal places). Implied decimal with scale 1e-6'
      - id: ask_volume
        type: u4
        doc: 'Aggregate size at Ask Price'
      - id: bid_price
        type: decimal_u8_6
        doc: 'Best Bid Price. The long value represents the price scaled by 1,000,000 (6 decimal places). Implied decimal with scale 1e-6'
      - id: bid_volume
        type: u4
...
enums:
  message_type:
    ...
    20:
      ...
      doc: 'This message appears on all channels and is sent out at the start of each Overnight OTC IDQS trading session: Order Acceptance at 7:00 PM, Market Open at 8:00 PM, Market Close at 7:45 AM. The message can also be sent mid-day if a technical outage caused a temporary closure of the market.'
    9:
      id: 'security_message'
    ...
    27:
      ...
      doc: 'This message appears on the TOB channel. Provides best bid and offer aggregated top-of-book.'
    28:
      id: 'imbalance_message'
      doc: 'This message appears on all channels. This message is not available in the Overnight TradingSession.'
    74:
  ...
  trading_session:
    1:
      id: 'order_acceptance'
      doc: 'Order Acceptance 700 Pm'
    5:
      id: 'market_close'
      doc: 'Market Close 745 Am'
    6:
      id: 'overnight'
      doc: 'Overnight 800 Pm'
  security_action:
    1:
      id: 'update'
      doc: 'Update'
