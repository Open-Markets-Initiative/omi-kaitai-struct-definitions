# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets LinkAts QuoteReferencePrice Link v4.10.4
#
# Protocol:
...
meta:
  id: otcmarkets_linkats_quotereferenceprice_link_v4_10_4
  title: OtcMarkets LinkAts QuoteReferencePrice Link v4.10.4
  license: GPL-3.0
  endian: be
...
types:
  ...
  reference_price_message:
    seq:
      ...
      - id: quote_flags
        type: quote_flags
        doc: 'Reference Price Quote Information'
      - id: security_id
        type: u4
        doc: 'Unique security ID issued by OTC Markets'
      - id: ask_price
