# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets LinkAts ReferenceDataNoCusip Link v4.10.4
#
# Protocol:
...
meta:
  id: otcmarkets_linkats_referencedatanocusip_link_v4_10_4
  title: OtcMarkets LinkAts ReferenceDataNoCusip Link v4.10.4
  license: GPL-3.0
  endian: be
...
enums:
  message_type:
    ...
    16:
      ...
      doc: 'Extended security attribute information for OTC Markets securities. Sent on the Reference Data channel without CUSIP.'
  spin_type:
    1:
      id: 'reference'
      doc: 'Reference Spin'
