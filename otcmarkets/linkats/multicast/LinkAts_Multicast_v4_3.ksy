# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets LinkAts Multicast Link v4.3
#
# Protocol:
...
meta:
  id: otcmarkets_linkats_multicast_link_v4_3
  title: OtcMarkets LinkAts Multicast Link v4.3
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group OTC Link ATS OTC Markets Multicast Link v4.3'
...
types:
  ...
  market_open_message:
    seq:
      ...
      - id: market_open
        type: millisecond_timestamp
        doc: 'Market open time in milliseconds since UTC epoch. Milliseconds since Unix epoch'
      - id: market_close
        type: u8
  ...
  market_close_message:
    seq:
      ...
      - id: market_msg_ct
        type: u4
        doc: 'Total message count for the trading day'
  security_message:
    seq:
      - id: channel_seq_num
        type: u4
      ...
      - id: symbol
        ...
        size: 10
        encoding: ASCII
        doc: 'Ticker symbol. Fixed income symbols may not have a symbol. For these securities, the security ID or CUSIP (Reference Data Security Message) must be used as an identifier'
  ...
  security_flags:
    seq:
      - id: piggyback
        type: b1
        doc: 'Rule 15c2-11 “Piggyback” exempt security status flag'
      ...
      - id: qualified_institutional_buyers_only
        type: b1
        doc: 'Indicates if the security may only be quoted unsolicited for Qualified Institutional Buyers'
      - id: unsolicited_only
        type: b1
        doc: 'Indicates if the security may only be quoted unsolicited'
      - id: bb_quoted
        type: b1
        doc: 'Indicates if the security is quoted on the OTC Bulletin Board interdealer quotation system'
      - id: otc_link_ecn_eligible
        type: b1
        doc: 'Indicates if the security is eligible for OTC Link ECN'
      - id: otc_link_messaging_disabled
        type: b1
        doc: 'Indicates whether OTC Link messaging is disabled for the security'
  ...
  quote_message:
    seq:
      ...
      - id: ask_qap
        type: s1
        doc: 'Specifies the access fee or rebate for the ask. Positive values (1 to 30) indicate a rebate, negative values (-1 to -30) indicate an access fee, and 0 indicates no rebate or access fee'
      - id: ask_time_milli
        type: u8
        doc: 'Ask timestamp in milliseconds from UTC epoch'
      - id: bid_price
        type: u8
      ...
      - id: bid_time_milli
        type: u8
        doc: 'Bid timestamp in milliseconds from UTC epoch'
      - id: quote_reference_id
        type: u2
        doc: 'Numeric value (0–64,999) assigned by the quote owner (FIX Tag 9670), used for correlation purposes'
  ...
  extended_quote_flags:
    seq:
      - id: quote_saturated
        type: b1
        doc: 'Quote should be considered for inside price'
      - id: bid_auto_ex
        type: b1
        doc: 'Bid Auto Execution enabled'
      - id: offer_auto_ex
        type: b1
        doc: 'Offer Auto Execution enabled'
      - id: nms_conditional_quote
        type: b1
        doc: 'Displayed quote size is a round lot at least two times greater than the minimum round lot size and cannot be partially filled'
      - id: reserved_4
        type: b4
        doc: 'Reserved Extended Quote Flag Bits'
  quote_update_message:
    seq:
      ...
      - id: quote_time_milli
        type: u8
        doc: 'Quote timestamp in milliseconds from UTC epoch'
      - id: quote_reference_id
        type: u2
        doc: 'Numeric value (0–64,999) assigned by the quote owner (FIX Tag 9670), used for correlation purposes'
      - id: extended_quote_flags
  ...
  inside_message:
    seq:
      ...
      - id: inside_id
        type: u4
        doc: 'Unique Inside ID'
      - id: inside_action
        type: u1
        enum: inside_action
        doc: 'Inside action indicator'
      - id: quote_flags
        type: quote_flags
        doc: 'Quote Information'
      - id: security_id
      ...
      - id: ask_num_priced_mp
        type: u1
        doc: 'Number of market participants at the inside ask price level'
      - id: bid_num_priced_mp
        type: u1
        doc: 'Number of market participants at the inside bid price level'
  inside_update_message:
    seq:
      ...
      - id: inside_time_milli
        type: u8
        doc: 'Inside timestamp in milliseconds from UTC epoch'
      - id: num_priced_mp
        type: u1
  ...
  reference_price_message:
    seq:
      ...
      - id: reference_price_id
        type: u4
        doc: 'Unique Reference Price ID'
      - id: reference_price_action
        type: u1
        enum: reference_price_action
        doc: 'Reference price action indicator'
      - id: quote_flags
        type: quote_flags
        doc: 'Quote Information'
      - id: security_id
  ...
  reference_price_update_message:
    seq:
      ...
      - id: time_milli
        type: u8
        doc: 'Timestamp in milliseconds from UTC epoch'
  extended_security_message:
    seq:
      ...
      - id: primary_market
        ...
        size: 3
        encoding: ASCII
        doc: 'Primary trading market or exchange'
      - id: security_id
        type: u4
        doc: 'Unique security ID issued by OTC Markets'
      ...
      - id: par_value
        type: u8
        doc: 'Par value with 6 decimal places assumed. 0 indicates not available'
      - id: coupon
        type: u8
        doc: 'Coupon with 6 decimal places assumed. Applies to fixed income securities only'
      - id: maturity_date_milli
        type: u8
        doc: 'Maturity date in milliseconds from UTC epoch. Applies to fixed income securities only'
      - id: callable_date_milli
        type: u8
        doc: 'Callable date in milliseconds from UTC epoch. Applies to fixed income securities only'
      - id: adr_ratio
        type: u8
        doc: 'ADR ratio with 6 decimal places assumed. Applies to ADR/GDR/NYRS securities only'
      - id: adr_level
        type: str
        size: 15
        encoding: ASCII
        doc: 'ADR level. Applies to ADR/GDR/NYRS securities only'
      - id: security_detail
  ...
  extended_security_flags:
    seq:
      ...
      - id: investment_grade
        type: b1
        doc: 'Security is investment grade'
      - id: trading_flat
        type: b1
        doc: 'Security is trading flat'
      - id: callable
        type: b1
        doc: 'Security is callable'
      - id: reserved_5
        type: b5
  ...
  trade_message:
    seq:
      ...
      - id: deprecated
        ...
        size: 8
        encoding: ASCII
        doc: 'Deprecated field. Spaces will be sent in the message'
      - id: trade_price
        type: u8
        doc: 'Trade price with 6 decimal places assumed'
      - id: trade_size
        type: u4
        doc: 'Number of shares traded'
      - id: trade_time_milli
        type: u8
        doc: 'Trade timestamp in milliseconds from UTC epoch'
  trade_status:
    seq:
      - id: irregular
        type: b1
        doc: 'Indicates an irregular trade'
      - id: reserved_7
        type: b7
...
enums:
  message_type:
    ...
    9:
      id: 'security_message'
      doc: 'The Security Message is included in all the quote channels and provides basic security attribute information.'
    1:
      id: 'quote_message'
    ...
    7:
      ...
      doc: 'This message is sent on the Reference Prices Channel. Size will always be set to 1.'
    8:
    ...
    15:
      ...
      doc: 'Extended Security message providing additional security and issuer attributes.'
    16:
      id: 'extended_security_no_cusip_message'
      doc: 'Extended Security message without CUSIP information. This message may be sent at system startup or intraday following a technical outage.'
    17:
      id: 'trade_message'
  ...
  spin_type:
    1:
      id: 'reference'
      doc: 'Reference Spin Cycle'
    2:
      id: 'market_data'
      doc: 'Market Data Spin Cycle'
    3:
      id: 'opening'
      doc: 'Opening Spin Cycle'
  security_action:
    1:
      id: 'update'
  ...
  asset_class:
    ...
    2:
      id: 'fixed_income'
      doc: 'Fixed Income Security'
  tier:
    0:
      id: 'no_tier'
      doc: 'No Tier Assigned'
    1:
      id: 'otcqxus_premier'
    ...
    11:
      id: 'otcbb_only'
      doc: 'Otc Bulletin Board Only'
    20:
      id: 'pink_current'
      doc: 'Pink Current Information'
    21:
      id: 'pink_limited'
      doc: 'Pink Limited Information'
    22:
