# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets LinkAts Multicast Link v4.10.4
#
# Protocol:
...
meta:
  id: otcmarkets_linkats_multicast_link_v4_10_4
  title: OtcMarkets LinkAts Multicast Link v4.10.4
  license: GPL-3.0
  endian: be

doc: 'OTC Markets Group OTC Link ATS OTC Markets Multicast Link v4.10.4'
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::extended_trade_message': extended_trade_message
  message_header:
    seq:
      - id: message_size
        type: u2
  ...
  trade_message:
    seq:
      - id: channel_seq_num
        type: u4
        doc: 'Monotonically increasing message sequence number at the channel level'
      - id: trade_id_unsigned_integer_4
        type: u4
        doc: 'Unique Trade ID'
      - id: trade_action
        type: u1
      ...
      - id: trade_size_unsigned_integer_4
        type: u4
        doc: 'Number of shares'
      - id: trade_time_milli
        type: u8
  ...
  extended_trade_message:
    seq:
      - id: channel_seq_num
        type: u4
        doc: 'Monotonically increasing message sequence number at the channel level'
      - id: trade_id_unsigned_integer_8
        type: u8
        doc: 'Unique Trade ID'
      - id: trade_action
        type: u1
      ...
      - id: trade_price
        type: u8
        doc: 'Trade price. Six decimal places assumed'
      - id: trade_size_unsigned_integer_8
        type: u8
        doc: 'Number of shares. Eight decimal places assumed for fractional shares'
      - id: trade_time_milli
        type: u8
        doc: 'Milliseconds from UTC epoch'
...
enums:
  message_type:
    ...
    18:
      ...
      doc: 'Extended Trade Channel message. Created for every trade that occurs on OTC Markets OTC Link ATS, OTC Link ECN, and OTC Link NQB platforms. Differs from Trade in that TradeID is 8 bytes, and TradeSize and TradePrice are 8 bytes with 8 decimal places assumed for fractional shares.'
  spin_type:
    1:
      id: 'reference'
      doc: 'Reference Spin'
