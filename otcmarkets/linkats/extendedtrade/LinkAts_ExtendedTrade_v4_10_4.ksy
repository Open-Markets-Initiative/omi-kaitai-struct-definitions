# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets LinkAts ExtendedTrade Link v4.10.4
#
# Protocol:
...
meta:
  id: otcmarkets_linkats_extendedtrade_link_v4_10_4
  title: OtcMarkets LinkAts ExtendedTrade Link v4.10.4
  license: GPL-3.0
  endian: be
  ...
  extended_trade_message:
    seq:
      ...
      - id: venue
        ...
        size: 3
        encoding: ASCII
        doc: 'Executing venue. Values: ATS, ECN, NQB'
      ...
      - id: trade_price
        type: u8
        doc: 'Trade price. Eight decimal places assumed'
      - id: trade_size
        type: u8
