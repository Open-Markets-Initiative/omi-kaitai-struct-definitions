# ---------------------------------------------------------------------
# Kaitai struct definition for: OtcMarkets LinkAts ReferenceData Link v4.10.4
#
# Protocol:
...
meta:
  id: otcmarkets_linkats_referencedata_link_v4_10_4
  title: OtcMarkets LinkAts ReferenceData Link v4.10.4
  license: GPL-3.0
  endian: be
...
enums:
  message_type:
    ...
    15:
      ...
      doc: 'Extended security attribute information for OTC Markets securities. Sent on the Reference Data channel with CUSIP.'
  spin_type:
    1:
      id: 'reference'
      doc: 'Reference Spin'
