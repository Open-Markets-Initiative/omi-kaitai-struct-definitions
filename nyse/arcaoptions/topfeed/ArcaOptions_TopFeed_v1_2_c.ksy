# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse ArcaOptions TopFeed Pillar v1.2.c
#
# Protocol:
...
meta:
  id: nyse_arcaoptions_topfeed_pillar_v1_2_c
  title: Nyse ArcaOptions TopFeed Pillar v1.2.c
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Arca Options Top Feed Pillar v1.2.c'
...
types:
  ...
  options_quote_message:
    seq:
      ...
      - id: ask_price
        type: s4
        doc: 'The Ask price. Use the Price scale from the Series Index message'
      - id: ask_volume
        type: u4
        doc: 'Total quantity available at the above Ask price'
      - id: bid_price
        type: s4
        doc: 'The Bid price. Use the Price scale from the Series Index message'
      - id: bid_volume
        type: u4
  ...
  options_trade_message:
    seq:
      ...
      - id: price
        type: s4
        doc: 'The price of the Trade. Use the Price scale from the series index mapping'
      - id: volume
        type: u4
  ...
  trade_condition:
    seq:
      - id: series
        type: u1
        enum: series
        doc: 'Settlement related conditions. Valid values:'
      - id: opening
        type: u1
        enum: opening
        doc: 'Reserved for future use'
  ...
  outright_series_summary_message:
    seq:
      ...
      - id: high_price
        type: s4
        doc: 'The Highest price of the series for the day. Use the Price scale from the series mapping index'
      - id: low_price
        type: s4
        doc: 'The Lowest price of the series for the day. Use the Price scale from the series mapping index'
      - id: open
        type: s4
...
enums:
  ...
  series:
    0x61:
      id: 'cube'
      doc: 'Outright Series Orderquote Trading Electronically With A Outright Series Cube Exposed Order Or Outright Series Cube Exposed Order Trading Electronically With Outright Series'
    0x63:
      id: 'occ'
      doc: 'Trading Of A Outright Series Qcc Order'
    0x65:
      id: 'floor_trade'
      doc: 'Outright Series Floor Trade'
    0x49:
      id: 'other_outright_series'
      doc: 'Other Outright Series'
    0x53:
      id: 'iso_sweep'
    ...
    0x67:
      id: 'complex_cube'
      doc: 'Complex Order Trading Electronically With A Complex Cube Exposed Order Or Complex Cube Exposed Order Trading Electronically With Complex Cube Covered Order'
    0x48:
      id: 'complex_qcc_order'
      doc: 'Trading Of A Complex Qcc Order'
    0x69:
      id: 'complex_floor_order'
      doc: 'Complex Order To Complex Order Floor Trade'
    0x6a:
      id: 'complex_order_trading_with_the_outright_series'
      doc: 'Complex Order Trading Electronically With The Outright Series Ordersquotes'
    0x6d:
      id: 'complex_order_to_outright_series_orderfloor_trade'
      doc: 'Complex Order To Outright Series Orderfloor Trade'
    0x70:
  ...
  transaction:
    0x48:
      id: 'opening_trade_in_sequence'
      doc: 'Transaction Is A Late Report Of The Opening Trade But Is In The Correct Sequence'
    0x46:
      id: 'opening_trade_out_of_sequence'
      doc: 'Transaction Is A Late Report Of The Opening Trade And Is Out Of Sequence'
    0x44:
      id: 'in_sequence'
  ...
  auction_status:
    0:
      ...
      doc: 'Usual'
    4:
      id: 'legal_width_quote_does_not_exist'
      doc: 'Legal Width Quote Does Not Exist'
    5:
      id: 'market_maker_quote_is_not_received'
      doc: 'Market Maker Quote Is Not Received'
  side:
    0x42:
      id: 'buy'
      doc: 'Buy'
