# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse ArcaOptions TopFeed Pillar v1.2.k
#
# Protocol:
...
meta:
  id: nyse_arcaoptions_topfeed_pillar_v1_2_k
  title: Nyse ArcaOptions TopFeed Pillar v1.2.k
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Arca Options Top Feed Pillar v1.2.k'
  ...
  options_imbalance_message:
    seq:
      ...
      - id: indicative_match_price
        type: s4
        doc: 'The price at which the highest number of contracts would trade, subject to auction collars. It includes the non-displayed quantity of Reserve Orders'
      - id: upper_collar
        type: s4
