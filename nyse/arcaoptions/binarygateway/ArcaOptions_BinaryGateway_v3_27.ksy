# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse ArcaOptions BinaryGateway PillarStream v3.27
#
# Protocol:
...
meta:
  id: nyse_arcaoptions_binarygateway_pillarstream_v3_27
  title: Nyse ArcaOptions BinaryGateway PillarStream v3.27
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Arca Options Binary Gateway PillarStream v3.27'
...
types:
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            'seq_msg_type::new_bulk_quote_message': new_bulk_quote_message
            'seq_msg_type::new_bulk_quote_with_order_id_message': new_bulk_quote_with_order_id_message
            ...
            'seq_msg_type::bulk_cancel_request_with_mp_sub_id_message': bulk_cancel_request_with_mp_sub_id_message
            ...
            'seq_msg_type::bulk_quote_acknowledgment_with_details_message': bulk_quote_acknowledgment_with_details_message
  ...
  new_order_message:
    seq:
      ...
      - id: bitfield_order_instructions
        ...
        doc: 'Order instructions, attributes, and modifiers for complex options'
      - id: price
        type: decimal_s8_8
  ...
  bitfield_order_instructions:
    ...
    seq:
      ...
      - id: security_type
        type: b5
        doc: 'Security type, complex options only'
      - id: customer_or_firm
        type: b5
        doc: 'Sender capacity'
      - id: open_close_bits
        type: b2
        doc: 'Open or close position'
      - id: sub_id_indicator
        type: b5
        doc: 'MPSubID usage for risk and self-trade prevention'
      - id: special_ord_type
        type: b5
        doc: 'Special order or auction type'
      - id: locate_reqd_bits
        type: b2
        doc: 'Locate requirement indicator'
      - id: retail_indicator
        type: b5
        doc: 'Retail order indicator'
      - id: attributed_quote
        type: b5
        doc: 'Attribution and BOLD behavior'
      - id: order_capacity
        type: b5
        doc: 'Order capacity'
      - id: interest_type
        type: b5
        doc: 'Market maker or special interest type'
      - id: trading_session_id
        type: b5
        doc: 'Eligible trading sessions'
      - id: time_in_force
        type: b5
        doc: 'Order duration'
      - id: proactive_if_locked
        type: b5
        doc: 'Proactive behavior when locked'
      - id: self_trade_type_bits
        type: b5
        doc: 'Self-trade prevention behavior'
      - id: cancel_instead_of_reprice
        type: b5
        doc: 'Cancel versus reprice behavior'
      - id: routing_inst
        type: b5
        doc: 'Routing instructions for complex orders'
      - id: extended_exec_inst
        type: b5
        doc: 'Extended execution instructions'
      - id: exec_inst
        type: b5
        doc: 'Execution instructions'
      - id: ord_type
        type: b5
        doc: 'Order type'
      - id: side_bits
  ...
  bitfield_quote_inst:
    ...
    seq:
      ...
      - id: unused_3
        type: b3
        doc: 'Reserved for future use'
  new_bulk_quote_with_order_id_message:
    seq:
      - id: mpid
        type: str
        size: 4
  ...
  bulk_cancel_request_with_mp_sub_id_message:
    seq:
      - id: symbol_id
        type: u4
        doc: 'Identifier of the security; both sides of a cross must match'
  ...
  risk_limit_update_request_message:
    seq:
      ...
      - id: ioc_attribution
        ...
        doc: 'Controls inclusion or exclusion of IOC and GTX orders in activity-based calculations and cancellations'
      - id: risk_range_id
        type: u1
  ...
  quote_ack_group:
    seq:
      ...
      - id: working_away_from_display
        ...
        enum: working_away_from_display
        doc: 'Indicates whether working price differs from display price'
  bulk_quote_acknowledgment_with_details_message:
    seq:
      - id: transact_time
        type: nanosecond_timestamp
        doc: 'Exchange application time. Nanoseconds since Unix epoch'
...
enums:
  ...
  seq_msg_type:
    ...
    0x0259:
      id: 'new_bulk_quote_with_order_id_message'
      doc: 'Allows a market maker to submit up to 20 single-sided quotes for the same underlying in a single message'
    0x0222:
    ...
    0x0224:
      id: 'bulk_cancel_request_with_mp_sub_id_message'
    ...
    0x0308:
      id: 'bulk_quote_acknowledgment_with_details_message'
      doc: 'Bulk Quote Acknowledgment Message'
    0x0278:
  ...
  customer_or_firm:
    ...
    5:
      id: 'options_away_market_maker'
      doc: 'Options Away Market Maker'
    6:
      id: 'prof_customer'
  ...
  sub_id_indicator:
    0:
      id: 'risk_and_stp'
      doc: 'Use Mp Sub Id For Both Pretrade Risk Controls And Selftrade Prevention'
    1:
      id: 'risk_only'
      doc: 'Use Mp Sub Id For Pretrade Risk Controls Only Selftrade Prevention At Mpid Level'
  special_ord_type:
    0:
      id: 'none'
      doc: 'No Special Order Type'
    10:
      id: 'qcc'
  ...
  retail_indicator:
    0:
      id: 'not_retail'
      doc: 'Not A Retail Order'
  attributed_quote:
    0:
      id: 'not_attributed'
      doc: 'Not Attributed Or Use Current Session Configuration'
  order_capacity:
    0:
      id: 'not_applicable'
      doc: 'Not Applicable'
  ...
  proactive_if_locked:
    0:
      id: 'none'
      doc: 'No Proactive Behavior'
    1:
      id: 'proactive_route'
      doc: 'Proactively Route Order When Locked'
  ...
  cancel_instead_of_reprice:
    ...
    4:
      id: 'reprice_once_then_cancel'
      doc: 'Allow One Reprice Then Cancel Instead Of Repricing'
  routing_inst:
    0:
      id: 'none'
    ...
    2:
      ...
      doc: 'Routable'
    9:
      id: 'complex_book_only'
      doc: 'Complex Book Only Nonlegging Complex Order'
  extended_exec_inst:
    0:
      id: 'none'
      doc: 'No Extended Execution Instruction'
    8:
      id: 'imbalance_offset'
      doc: 'Imbalance Offset'
    13:
      id: 'add_liquidity_only_non_taking'
  ...
  mm_quote_type:
    ...
    2:
      id: 'add_liquidity_only_non_taking'
      doc: 'Add Liquidity Only Nontaking Quote'
    4:
      id: 'repricing_add_liquidity_only_non_taking'
      doc: 'Repricing Add Liquidity Only Nontaking Quote'
  bulk_action:
    0:
      id: 'not_applicable'
