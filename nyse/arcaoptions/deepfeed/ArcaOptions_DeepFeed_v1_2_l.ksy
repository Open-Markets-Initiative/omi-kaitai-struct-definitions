# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse ArcaOptions DeepFeed Pillar v1.2.l
#
# Protocol:
...
meta:
  id: nyse_arcaoptions_deepfeed_pillar_v1_2_l
  title: Nyse ArcaOptions DeepFeed Pillar v1.2.l
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Arca Options Deep Feed Pillar v1.2.l'
...
types:
  ...
  options_modify_order_message:
    seq:
      ...
      - id: position_change
        type: u1
        doc: 'Defaulted to ''0''. If the price didn''t change, order keeps position. If price changed, order loses position'
      - id: side
        type: u1
        enum: side
        doc: 'The side of the order (Buy/Sell)'
  ...
  options_series_rfq_message:
    seq:
      ...
      - id: capacity
        type: u1
        enum: capacity
        doc: 'Customer or Firm capacity specified with the order. Only valid for BOLD (Type = B)'
      - id: total_quantity
        type: u4
        doc: 'Total quantity'
      - id: working_price
  ...
  options_non_displayed_trade_message:
    seq:
      ...
      - id: printable_flag
        ...
        enum: printable_flag
        doc: 'Indicates whether trade is included in total volume'
      - id: non_displayed_trade_trade_cond_1
        type: u1
        enum: non_displayed_trade_trade_cond_1
        doc: 'Settlement related conditions'
      - id: reserved_3
        size: 3
        doc: 'Reserved for future use'
  ...
  options_cross_trade_message:
    seq:
      ...
      - id: cross_type
        type: u1
        enum: cross_type
        doc: 'Reason for the crossing from the opening and re-opening auction'
...
enums:
  ...
  message_type:
    ...
    300:
      ...
      doc: 'Published when a new visible order has been received and added to the book.'
    301:
      id: 'options_modify_order_message'
      doc: 'Sent when the price or volume of an order is changed due to an event other than a cancel-replace, or full or partial execution.'
    302:
      id: 'options_delete_order_message'
      doc: 'Published when an order is taken off of the book for any reason except for full execution.'
    303:
      id: 'options_order_execution_message'
      doc: 'Sent when an order is partially or fully executed.'
    304:
      id: 'options_replace_order_message'
      doc: 'Published when a cancel/replace order is received. The resting order is replaced with a new order containing the same outright or complex series, side and attribution, a new Order ID, and the price and size specified.'
    305:
      id: 'options_imbalance_message'
      doc: 'Published every 5 seconds, during opening and re-opening auctions to update price and volume information.'
    306:
      id: 'options_add_order_refresh_message'
      doc: 'Sent as part of a refresh response for every order currently resting on the book.'
    307:
      id: 'options_series_rfq_message'
      doc: 'Published for outright series. Generated by the matching engine to solicit interest in an auction or order.'
    310:
      id: 'options_non_displayed_trade_message'
      doc: 'Published as a result of a match between two non-displayed orders.'
    311:
      id: 'options_cross_trade_message'
      doc: 'Published on completion of a crossing from the opening and re-opening auction, showing the bulk volume that traded in the auction.'
    312:
      id: 'options_trade_cancel_message'
      doc: 'Published when an earlier trade has been reported in error.'
    323:
      id: 'options_outright_series_summary_message'
      doc: 'Published every 60 seconds on a separate multicast channel. Provides high, low, open, close and total volume per series.'
  market_id:
    1:
      id: 'nyse_equities'
      doc: 'Nyse Equities'
  ...
  cust_indicator:
    ...
    0x4e:
      ...
      doc: 'Noncustomer'
    0x44:
      id: 'derived_for_future_use'
      doc: 'Derived For Future Use'
  printable_flag:
    0:
  ...
  trade_cond_1:
    0x61:
      id: 'outright_series_orderquote_trading_electronically_with_a_outright_series_cube_order_or_outright_series_cube_order_trading_electronically_with_outright_series_cube_contra_order'
      doc: 'Outright Series Orderquote Trading Electronically With A Outright Series Cube Order Or Outright Series Cube Order Trading Electronically With Outright Series Cube Contra Order'
    0x63:
      id: 'trading_of_an_outright_series_qcc_order_or_customer_to_customer_cross_order'
      doc: 'Trading Of An Outright Series Qcc Order Or Customer To Customer Cross Order'
    0x65:
      id: 'outright_series_floor_trade'
      doc: 'Outright Series Floor Trade'
    0x49:
      id: 'all_outright_series_electronic_trades_excluding_away_market_executions_that_were_not_part_of_certain_transactions'
      doc: 'All Outright Series Electronic Trades Excluding Away Market Executions That Were Not Part Of Certain Transactions'
    0x53:
      id: 'all_outright_series_trades_generated_as_part_of_an_intermarket_sweep_order'
      doc: 'All Outright Series Trades Generated As Part Of An Intermarket Sweep Order'
    0x44:
      id: 'transaction_is_being_reported_late_but_is_in_the_correct_sequence'
      doc: 'Transaction Is Being Reported Late But Is In The Correct Sequence'
    0x66:
      id: 'complex_order_trades_that_were_not_part_of_certain_transactions'
      doc: 'Complex Order Trades That Were Not Part Of Certain Transactions'
    0x67:
      id: 'complex_order_trading_electronically_with_a_complex_cube_order_or_complex_cube_order_trading_electronically_with_complex_cube_contra_order'
      doc: 'Complex Order Trading Electronically With A Complex Cube Order Or Complex Cube Order Trading Electronically With Complex Cube Contra Order'
    0x68:
      id: 'trading_of_a_complex_qcc_order_or_customer_to_customer_cross_order'
      doc: 'Trading Of A Complex Qcc Order Or Customer To Customer Cross Order'
    0x69:
      id: 'complex_order_to_complex_order_floor_trade'
      doc: 'Complex Order To Complex Order Floor Trade'
    0x6a:
      id: 'complex_order_trading_electronically_with_the_outright_series_ordersquotes'
      doc: 'Complex Order Trading Electronically With The Outright Series Ordersquotes'
    0x6d:
  ...
  imbalance_side:
    ...
    0x53:
      ...
      doc: 'Sell Side'
    0x20:
      id: 'space_or_0_x_20_indicates_no_imbalance'
      doc: 'Space Or 0 X 20 Indicates No Imbalance'
  auction_status:
    0:
  ...
  non_displayed_trade_trade_cond_1:
    0x61:
      id: 'outright_series_orderquote_trading_electronically_with_a_outright_series_cube_order_or_outright_series_cube_order_trading_electronically_with_outright_series_cube_contra_order'
      doc: 'Outright Series Orderquote Trading Electronically With A Outright Series Cube Order Or Outright Series Cube Order Trading Electronically With Outright Series Cube Contra Order'
    0x63:
    ...
    0x73:
      ...
      doc: 'Complex Order With Stock To Outright Series Order Floor Trade'
    0x48:
      id: 'late_report_of_the_opening_trade_in_the_correct_sequence'
      doc: 'Late Report Of The Opening Trade In The Correct Sequence'
    0x46:
      id: 'late_report_of_the_opening_trade_out_of_sequence'
      doc: 'Late Report Of The Opening Trade Out Of Sequence'
    0x42:
      id: 'transaction_is_being_reported_late_and_is_out_of_sequence'
      doc: 'Transaction Is Being Reported Late And Is Out Of Sequence'
  price_type:
    0:
