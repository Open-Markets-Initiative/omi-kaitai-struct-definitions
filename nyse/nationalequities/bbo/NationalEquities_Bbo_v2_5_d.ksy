# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NationalEquities Bbo Pillar v2.5.d
#
# Protocol:
...
meta:
  id: nyse_nationalequities_bbo_pillar_v2_5_d
  title: Nyse NationalEquities Bbo Pillar v2.5.d
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse National Equities Best Bid And Offer Pillar v2.5.d'
doc-ref: https://www.nyse.com/publicdocs/nyse/data/NYSE_Pillar_BBO_Client_Specification.pdf
  ...
  quote_message:
    seq:
      ...
      - id: rpi_indicator
        type: u1
        enum: rpi_indicator
        doc: 'The side(s) where Retail Price Indication orders (RPI orders) exist. Values correspond to CQS values'
