# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NationalEquities BinaryGateway PillarStream v6.0
#
# Protocol:
...
meta:
  id: nyse_nationalequities_binarygateway_pillarstream_v6_0
  title: Nyse NationalEquities BinaryGateway PillarStream v6.0
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse National Equities Binary Gateway PillarStream v6.0'
...
types:
  ...
  execution_report_message:
    seq:
      ...
      - id: bitfield_execution_details
        type: bitfield_execution_details
        doc: 'BitfieldExecutionDetails is a data structure defining the trading session in which the execution occurred'
      - id: reserved_3
        size: 3
        doc: 'Bytes reserved for future use'
      - id: locate_reqd_u_81
      ...
      - id: optional_settlement_type_add_on
        ...
        if: _parent.seq_msg_header.seq_msg_length == 66 or _parent.seq_msg_header.seq_msg_length == 103 or _parent.seq_msg_header.seq_msg_length == 85
        doc: 'OptionalSettlementTypeAddOn'
  bitfield_execution_details:
    meta:
      bit-endian: le
    seq:
      - id: executed_trading_session
        type: b3
        doc: 'ExecutedTradingSession'
      - id: unused_5
        type: b5
        doc: 'Bits reserved for future use'
...
enums:
  ...
  trading_session_id:
    0:
      id: 'overnight_trading_session'
      doc: 'Overnight Trading Session'
    1:
    ...
    7:
      id: 'overnight_early_core_and_late_trading_sessions'
      doc: 'Overnight Early Core And Late Trading Sessions'
  time_in_force:
    1:
      id: 'day'
      doc: 'Day'
