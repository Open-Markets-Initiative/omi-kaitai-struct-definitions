# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NationalEquities IntegratedFeedRetransmission Pillar v2.5.h
#
# Protocol:
...
meta:
  id: nyse_nationalequities_integratedfeedretransmission_pillar_v2_5_h
  title: Nyse NationalEquities IntegratedFeedRetransmission Pillar v2.5.h
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse National Equities Integrated Feed Retransmission Pillar v2.5.h'
