# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NationalEquities DepthFeedRetransmission Pillar v1.6
#
# Protocol:
#   Organization: New York Stock Exchange
#   Protocol: Depth Feed Retransmission
#   Encoding: Pillar
#   Version: 1.6
#   Date: 10/23/2025
...
meta:
  id: nyse_nationalequities_depthfeedretransmission_pillar_v1_6
  title: Nyse NationalEquities DepthFeedRetransmission Pillar v1.6
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse National Equities Depth Feed Retransmission Pillar v1.6'
doc-ref: https://www.nyse.com/publicdocs/nyse/data/NYSE_Pillar_Depth_Client_Specification.pdf
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::delta_message': delta_message
  ...
  message_unavailable_message:
    seq:
      - id: begin_seq_num
        type: u4
        doc: 'The beginning sequence number of the unavailable range of messages'
      - id: end_seq_num
        type: u4
        doc: 'The ending sequence number of the unavailable range of messages'
      - id: product_id
        type: u1
        doc: 'The unique ID for this NYSE feed listed in the feed''s client specification'
      - id: channel_id
  ...
  participant:
    seq:
      ...
      - id: number_of_orders
        type: u2
        doc: 'Number of orders at a price point for the specified exchange'
      - id: volume
        type: u4
        doc: 'Total interest quantity in shares at a price point for the specified exchange'
  imbalance_message:
    seq:
      - id: source_time
        type: u4
...
enums:
  ...
  message_type:
    ...
    115:
      id: 'delta_message'
      doc: 'The Delta Message is published each time there is a change to the aggregate limit-order book quantity across the ten best bid and ten best offer price points on the buy and/or sell side for NYSE Group.'
    105:
