# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NationalEquities DepthFeedRequest Pillar v1.6
#
# Protocol:
#   Organization: New York Stock Exchange
#   Protocol: Depth Feed Request
#   Encoding: Pillar
#   Version: 1.6
#   Date: 10/23/2025
...
meta:
  id: nyse_nationalequities_depthfeedrequest_pillar_v1_6
  title: Nyse NationalEquities DepthFeedRequest Pillar v1.6
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse National Equities Depth Feed Request Pillar v1.6'
