# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NationalEquities Trades Pillar v2.6.a
#
# Protocol:
...
meta:
  id: nyse_nationalequities_trades_pillar_v2_6_a
  title: Nyse NationalEquities Trades Pillar v2.6.a
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse National Equities Trades Pillar v2.6.a'
...
enums:
  ...
  message_type:
    ...
    213:
      ...
      doc: 'If a TRF participant firm fails to report a trade on the day in which it occurs, the firm may report the trade on a subsequent day by publishing a Prior Day Trade message.'
    214:
      id: 'trf_fractional_prior_day_trade_cancel_message'
      doc: 'If a TRF participant firm discovers that it has reported a trade with an inaccurate price or volume on a previous day, the firm may correct the trade on a subsequent day by publishing a Prior Day Trade Cancel message, followed by a Prior Day Trade.'
  market_id:
    1:
      id: 'nyse_equities'
      doc: 'Nyse Equities'
