# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NationalEquities IntegratedFeedRefresh Pillar v2.5.g
#
# Protocol:
#   Organization: New York Stock Exchange
#   Protocol: Integrated Feed Refresh
#   Encoding: Pillar
#   Version: 2.5.g
#   Date: 10/23/2025
...
meta:
  id: nyse_nationalequities_integratedfeedrefresh_pillar_v2_5_g
  title: Nyse NationalEquities IntegratedFeedRefresh Pillar v2.5.g
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse National Equities Integrated Feed Refresh Pillar v2.5.g'
...
types:
  ...
  sequence_number_reset_message:
    seq:
      ...
      - id: source_time_ns
        type: nanosecond_offset
        doc: 'The nanosecond offset from the Source Time. Nanoseconds since Second epoch'
      - id: product_id
        type: u1
  ...
  add_order_refresh_message:
    seq:
      ...
      - id: price
        type: s4
        doc: 'The order price. Use the Price scale from the symbol-mapping index'
      - id: volume
        type: u4
      ...
      - id: firm_id
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'The participant''s firm ID, or blanks if firm ID was not specified OR if the order is not marked as attributed'
      - id: reserved_1
        size: 1
        doc: 'Reserved for future use'
