# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse ArcaEquities ArcaBook Pillar v2.2
#
# Protocol:
...
meta:
  id: nyse_arcaequities_arcabook_pillar_v2_2
  title: Nyse ArcaEquities ArcaBook Pillar v2.2
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Arca Equities ArcaBook Pillar v2.2'
...
enums:
  ...
  trade_session:
    ...
    8:
      id: 'ok_for_overnight_hours'
      doc: 'Ok For Overnight Hours'
    15:
      id: 'ok_for_overnight_morning_core_and_late'
      doc: 'Ok For Overnight Morning Core And Late'
  auction_type:
    0x4f:
