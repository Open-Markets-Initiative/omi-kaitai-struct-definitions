# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse ArcaEquities IntegratedFeedRequest Pillar v2.5.h
#
# Protocol:
...
meta:
  id: nyse_arcaequities_integratedfeedrequest_pillar_v2_5_h
  title: Nyse ArcaEquities IntegratedFeedRequest Pillar v2.5.h
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Arca Equities Integrated Feed Request Pillar v2.5.h'
