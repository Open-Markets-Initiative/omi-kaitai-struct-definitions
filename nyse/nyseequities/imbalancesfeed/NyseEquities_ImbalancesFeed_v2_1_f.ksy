# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NyseEquities ImbalancesFeed Xdp v2.1.f
#
# Protocol:
...
doc: 'New York Stock Exchange New York Stock Exchange Equities Imbalances Feed Xdp v2.1.f'
doc-ref: https://www.nyse.com/publicdocs/nyse/data/XDP_Imbalances_Feed_Client_Specification_v2.1f.pdf
