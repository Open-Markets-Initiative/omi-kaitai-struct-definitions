# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NyseEquities Bqt Xdp v1.7.a
#
# Protocol:
...
meta:
  id: nyse_nyseequities_bqt_xdp_v1_7_a
  title: Nyse NyseEquities Bqt Xdp v1.7.a
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange New York Stock Exchange Equities Best Quote And Trade Xdp v1.7.a'
...
enums:
  ...
  retail_pricing_indicator:
    ...
    0x04:
      id: 'combination_of_retail_interest_on_bid_and_ask_side'
      doc: 'Combination Of Retail Interest On Bid And Ask Side'
