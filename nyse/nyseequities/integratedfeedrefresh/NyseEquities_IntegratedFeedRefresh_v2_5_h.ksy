# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NyseEquities IntegratedFeedRefresh Pillar v2.5.h
#
# Protocol:
...
meta:
  id: nyse_nyseequities_integratedfeedrefresh_pillar_v2_5_h
  title: Nyse NyseEquities IntegratedFeedRefresh Pillar v2.5.h
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange New York Stock Exchange Equities Integrated Feed Refresh Pillar v2.5.h'
