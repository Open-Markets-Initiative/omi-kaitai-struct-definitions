# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse NyseEquities IntegratedFeed Pillar v2.5.a
#
# Protocol:
...
doc: 'New York Stock Exchange New York Stock Exchange Equities Integrated Feed Pillar v2.5.a'
  ...
  replace_order_message:
    seq:
      ...
      - id: prev_price_parity_splits
        type: u1
        doc: 'Resulting number of splits at the previous price'
      - id: new_price_parity_splits
        type: u1
        doc: 'Resulting number of splits at the new price'
  imbalance_message:
    seq:
      - id: source_time
        type: u4
