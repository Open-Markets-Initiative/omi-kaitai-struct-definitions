# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse AmexEquities IntegratedFeedRefresh Pillar v2.5.h
#
# Protocol:
...
meta:
  id: nyse_amexequities_integratedfeedrefresh_pillar_v2_5_h
  title: Nyse AmexEquities IntegratedFeedRefresh Pillar v2.5.h
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Amex Equities Integrated Feed Refresh Pillar v2.5.h'
