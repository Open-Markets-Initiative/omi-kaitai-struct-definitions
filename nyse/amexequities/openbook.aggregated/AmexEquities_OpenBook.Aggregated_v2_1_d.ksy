# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse AmexEquities OpenBook.Aggregated Xdp v2.1.d
#
# Protocol:
...
meta:
  id: nyse_amexequities_openbookaggregated_xdp_v2_1_d
  title: Nyse AmexEquities OpenBook.Aggregated Xdp v2.1.d
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Amex Equities Open Book Aggregated Xdp v2.1.d'
doc-ref: https://www.nyse.com/publicdocs/nyse/data/OpenBook_Aggregated_Client_Specification.pdf
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::orderbook_snapshot_message': orderbook_snapshot_message
            'message_type::orderbook_delta_update_message': orderbook_delta_update_message
  message_header:
    seq:
      - id: message_size
        type: u2
  ...
  sequence_number_reset_message:
    seq:
      - id: source_time
        type: u4
        doc: 'This field specifies the time when the msg was generated in the order book. The number represents the number of seconds in UTC time (EPOCH)'
      - id: source_time_ns
        type: u4
        doc: 'This field represents the nanosecond portion within the second in UTC time (EPOCH)'
      - id: product_id
        type: u1
        doc: 'The unique ID of the feed for which the request was made (listed in the feed''s client specification)'
      - id: channel_id
        type: u1
  ...
  symbol_index_mapping_message:
    seq:
      ...
      - id: price_scale_code
        type: u1
        doc: 'Price scale for price conversion of the symbol'
      - id: security_type
        type: u1
        enum: security_type
      ...
      - id: mpv
        type: u2
        doc: 'This field contains the minimum price variation'
      - id: unit_of_trade
        type: u2
  ...
  security_status_message:
    seq:
      ...
      - id: time
        ...
        doc: 'Default value is 0. Format: HHMMSSmmm (mmm = milliseconds). If securityStatus = A and this security is listed on this exchange, then this field is the SSR Trigger Time. Nullable, Not Applicable = 0'
      - id: ssr_state
        type: u1
        enum: ssr_state
  ...
  retransmission_request_message:
    seq:
      ...
      - id: source_id
        ...
        size: 10
        encoding: ASCII
        doc: 'The ID of the client making the request. This field is up to 9 characters, null terminated'
      - id: product_id
        type: u1
        doc: 'The unique ID of the feed for which the request was made (listed in the feed''s client specification)'
      - id: channel_id
  ...
  request_response_message:
    seq:
      - id: msg_size
        type: u2
        doc: 'Size of the message: 21 Bytes'
      - id: msg_type
        type: u2
        doc: 'This field identifies the type of message. 11 - Request Response message'
      - id: request_seq_num
        type: u4
  ...
  orderbook_snapshot_message:
    seq:
      ...
      - id: symbol_index
        type: u4
        doc: 'This field identifies the numerical representation of the symbol'
      - id: ultra_last_seq_num
        type: u4
        doc: 'To ease recovery of OpenBook Ultra customers, This field contains the last sequence number of the last message sent out of the OpenBook Ultra feed'
      - id: symbol
        type: str
        size: 11
        encoding: ASCII
      ...
      - id: trading_status
        type: u1
        enum: trading_status
        doc: 'This field indicates the market condition of the security'
      - id: remaining_count
        type: u2
        doc: 'Number of updates remaining in the event'
      - id: mpv
        type: u2
        doc: 'This field contains the minimum price variation'
      - id: update_count
        type: u1
        doc: 'Number of updates. Indicates number of times the following group of fields (Price, Volume, Side, NumOrders) will be repeated in the message. Default value is 1'
      - id: snapshot_price_point
        type: snapshot_price_point
        doc: 'Snapshot Message Price Point'
  snapshot_price_point:
    seq:
      ...
      - id: volume
        type: u4
        doc: 'This field contains the total interest quantity in shares at a price point'
      - id: side
        type: u1
        enum: side
  ...
  orderbook_delta_update_message:
    seq:
      - id: msg_size
        type: u2
        doc: 'Size of the message: 21 Bytes'
...
enums:
  ...
  message_type:
    ...
    111:
      id: 'orderbook_delta_update_message'
      doc: 'A Delta Update message provides information about price updates for symbol.'
  market_id:
    1:
      id: 'nyse_equities'
      doc: 'Nyse Equities'
  ...
  status:
    ...
    0x32:
      id: 'rejected_due_to_invalid_sequence_range'
