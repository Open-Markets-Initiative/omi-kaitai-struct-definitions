# ---------------------------------------------------------------------
# Kaitai struct definition for: Nyse AmexEquities IntegratedFeedRequest Pillar v2.5.h
#
# Protocol:
...
meta:
  id: nyse_amexequities_integratedfeedrequest_pillar_v2_5_h
  title: Nyse AmexEquities IntegratedFeedRequest Pillar v2.5.h
  license: GPL-3.0
  endian: le

doc: 'New York Stock Exchange Nyse Amex Equities Integrated Feed Request Pillar v2.5.h'
