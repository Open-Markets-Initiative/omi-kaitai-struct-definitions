# ---------------------------------------------------------------------
# Kaitai struct definition for: Jnx JnxEquities Pts Itch v1.6
#
# Protocol:
...
meta:
  id: jnx_jnxequities_pts_itch_v1_6
  title: Jnx JnxEquities Pts Itch v1.6
  license: GPL-3.0
  endian: be

doc: 'Japannext Securities Japannext Equities Proprietary Trading System Itch v1.6'
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::order_added_without_attributes_message': order_added_without_attributes_message
