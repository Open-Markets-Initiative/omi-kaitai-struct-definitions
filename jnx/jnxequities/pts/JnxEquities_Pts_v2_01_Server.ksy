# ---------------------------------------------------------------------
# Kaitai struct definition for: Jnx JnxEquities Pts Ouch v2.01
#
# Protocol:
...
meta:
  id: jnx_jnxequities_pts_ouch_v2_01_server
  title: Jnx JnxEquities Pts Ouch v2.01
  license: GPL-3.0
  endian: be

doc: 'Japannext Securities Japannext Equities Ouch v2.01'
...
types:
  ...
  system_event_message:
    seq:
      - id: timestamp
        ...
        doc: 'Number of nanoseconds past midnight of the current calendar date. Nanoseconds since Midnight epoch'
      - id: system_event
        type: u1
        enum: system_event
  ...
  order_accepted_message:
    seq:
      ...
      - id: price
        type: decimal_u4_1
        doc: 'Order price. Implied decimal with scale 1e-1'
      - id: time_in_force
        type: u4
        enum: time_in_force
      ...
      - id: order_number
        type: u8
        doc: 'Order reference number unique within trading day'
      - id: minimum_quantity
        type: u4
  ...
  order_replaced_message:
    seq:
      ...
      - id: previous_order_token
        type: u4
        doc: 'Order token of replaced order'
  order_canceled_message:
    seq:
      ...
      - id: decrement_quantity
        type: u4
        doc: 'Number of shares decremented from order'
      - id: order_canceled_reason
        type: u1
        enum: order_canceled_reason
        doc: 'Reason order was reduced or canceled'
  ...
  order_executed_message:
    seq:
      ...
      - id: match_number
        type: u8
        doc: 'Reference number of the match unique within trading day'
...
enums:
  ...
  sequenced_message_type:
    ...
    0x45:
      ...
      doc: 'An Order Executed Message denotes that all or part of an order has been executed'
    0x4a:
