# ---------------------------------------------------------------------
# Kaitai struct definition for: Jnx JnxEquities Pts Glimpse v1.3
#
# Protocol:
...
meta:
  id: jnx_jnxequities_pts_glimpse_v1_3_servertcp
  title: Jnx JnxEquities Pts Glimpse v1.3
  license: GPL-3.0
  endian: be

doc: 'Japannext Securities Japannext Equities Proprietary Trading System Glimpse v1.3'
