# ---------------------------------------------------------------------
# Kaitai struct definition for: Jnx JnxEquities Pts Ouch v1.11
#
# Protocol:
...
meta:
  id: jnx_jnxequities_pts_ouch_v1_11_server
  title: Jnx JnxEquities Pts Ouch v1.11
  license: GPL-3.0
  endian: be

doc: 'Japannext Securities Japannext Equities Ouch v1.11'
