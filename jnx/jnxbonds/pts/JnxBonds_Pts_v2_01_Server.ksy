# ---------------------------------------------------------------------
# Kaitai struct definition for: Jnx JnxBonds Pts Ouch v2.01
#
# Protocol:
...
meta:
  id: jnx_jnxbonds_pts_ouch_v2_01_server
  title: Jnx JnxBonds Pts Ouch v2.01
  license: GPL-3.0
  endian: be

doc: 'Japannext Securities Japannext Bonds Ouch v2.01'
...
types:
      ...
      - id: sequenced_message
        ...
        type:
          ...
          cases:
            ...
            'sequenced_message_type::order_executed_with_counter_party_message': order_executed_with_counter_party_message
  ...
  order_accepted_message:
    seq:
      ...
      - id: price
        type: decimal_s4_3
        doc: 'Order yield. Implied decimal with scale 1e-3'
      - id: time_in_force
        type: u4
        enum: time_in_force
  ...
  order_canceled_message:
    seq:
      ...
      - id: decrement_quantity
        type: u4
        doc: 'Number of bonds decremented from order'
  ...
  order_aiq_canceled_message:
    seq:
      ...
      - id: quantity_prevented_from_trading
        type: u4
        doc: 'Number of bonds that would have executed if the trade had occurred'
      - id: execution_price
        type: decimal_s4_3
        doc: 'Yield at which the trade would have occurred. Implied decimal with scale 1e-3'
  ...
  order_executed_with_counter_party_message:
    seq:
      - id: timestamp
        type: nanosecond_timestamp
        doc: 'Number of nanoseconds past midnight of the current calendar date. Nanoseconds since Midnight epoch'
      ...
      - id: executed_quantity
        type: u4
        doc: 'Incremental number of bonds executed'
      - id: execution_price
        type: decimal_s4_3
        doc: 'Yield at which the trade would have occurred. Implied decimal with scale 1e-3'
      - id: liquidity_indicator
      ...
      - id: counter_party
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Trade counterparty identifier'
      - id: match_number
        type: u8
