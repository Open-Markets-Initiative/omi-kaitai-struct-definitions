# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Xti Fbe v8.1
#
# Protocol:
...
meta:
  id: eurex_t7_xti_fbe_v8_1_server
  title: Eurex T7 Xti Fbe v8.1
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Cash Enhanced Trading Interface Fbe v8.1'
...
enums:
  ...
  exec_restatement_reason:
    ...
    142:
      ...
      doc: 'Pending modified order executed (end of FREEZE state)'
    146:
