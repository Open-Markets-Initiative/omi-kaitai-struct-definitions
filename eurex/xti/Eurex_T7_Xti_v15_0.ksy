# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Xti Fbe v15.0
#
# Protocol:
...
meta:
  id: eurex_t7_xti_fbe_v15_0
  title: Eurex T7 Xti Fbe v15.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Cash Enhanced Trading Interface Fbe v15.0'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'template_id::inquire_overall_risk_limits_request': inquire_overall_risk_limits_request
            ...
            'template_id::overall_risk_limits_definition_request': overall_risk_limits_definition_request
            'template_id::overall_risk_limits_definition_response': overall_risk_limits_definition_response
            'template_id::overall_risk_limits_report': overall_risk_limits_report
            ...
            'template_id::rfq_reject_request': rfq_reject_request
            'template_id::rfq_reply_notification': rfq_reply_notification
            'template_id::rfq_reply_request': rfq_reply_request
            'template_id::rfq_reply_response': rfq_reply_response
            'template_id::rfq_request': rfq_request
            'template_id::rfq_response': rfq_response
            'template_id::rfq_specialist_issuer_broadcast': rfq_specialist_issuer_broadcast
  ...
  enrichment_rules_grp_comp:
    seq:
      ...
      - id: pad4
        size: 4
  inquire_overall_risk_limits_request:
    seq:
      - id: network_msg_id
        type: str
        size: 8
  ...
  order_exec_response:
    seq:
      ...
      - id: order_event_grp_comp
        ...
        repeat: expr
        repeat-expr: num_order_event_grp_comp
  overall_risk_limits_definition_request:
    seq:
      - id: network_msg_id
        type: str
        size: 8
      ...
      - id: throttle_time_interval
        type: s8_nullable
        doc: 'Nullable, No Value = 0x8000000000000000'
      - id: num_risk_limit_types_grp_comp
        type: u1
        doc: 'Nullable, No Value = 0xFF'
      - id: pad7
        size: 7
      - id: risk_limit_types_grp_comp
        type: risk_limit_types_grp_comp
        repeat: expr
        repeat-expr: num_risk_limit_types_grp_comp
  risk_limit_types_grp_comp:
    seq:
      ...
      - id: pad6
        size: 6
  overall_risk_limits_definition_response:
    seq:
      - id: pad2
        size: 2
      - id: response_header_comp
  ...
  rfq_response:
    seq:
      ...
      - id: exec_id
        type: nanosecond_timestamp_nullable
        doc: 'Nanoseconds since Unix epoch. Nullable, No Value = 0xFFFFFFFFFFFFFFFF'
  rfq_specialist_issuer_broadcast:
    seq:
      - id: pad2
        size: 2
      - id: rbc_header_me_comp
...
enums:
  template_id:
    ...
    10900:
      id: 'inquire_overall_risk_limits_request'
      doc: 'Inquire Overall Risk Limits Request TemplateId'
    10311:
    ...
    10901:
      id: 'overall_risk_limits_definition_request'
      doc: 'Overall Risk Limits Definition Request TemplateId'
    10903:
      id: 'overall_risk_limits_definition_response'
      doc: 'Overall Risk Limits Definition Response TemplateId'
    10902:
      id: 'overall_risk_limits_report'
      doc: 'Overall Risk Limits Report TemplateId'
    10042:
    ...
    10421:
      id: 'rfq_reject_request'
      doc: 'Rfq Reject Request TemplateId'
    10424:
      id: 'rfq_reply_notification'
      doc: 'Rfq Reply Notification TemplateId'
    10422:
      id: 'rfq_reply_request'
      doc: 'Rfq Reply Request TemplateId'
    10423:
      id: 'rfq_reply_response'
      doc: 'Rfq Reply Response TemplateId'
    10401:
      id: 'rfq_request'
    ...
    10419:
      id: 'rfq_specialist_issuer_broadcast'
      doc: 'Rfq Specialist Issuer Broadcast TemplateId'
    10010:
      id: 'reject'
  ...
  mass_action_reason:
    ...
    124:
      id: 'user_group_halt_trading'
      doc: 'User Group Halt Trading due to Trading Action Request'
    125:
      id: 'instrument_restrictedby_provider'
      doc: 'Instrument has been restricted by Provider'
    126:
      id: 'risk_monitoring_session_loss'
      doc: 'Risk Monitoring Session Loss'
    127:
      id: 'risk_service_unavailable'
      doc: 'Risk Service Unavailable'
    128:
      id: 'orl_level_3_breach'
      doc: 'Overall Risk Limits Level 3 Breach'
  exec_inst:
    1:
      id: 'h'
  ...
  exec_restatement_reason:
    ...
    231:
      id: 'invalid_smp_instruction_id'
      doc: 'Invalid SMP Instruction ID'
    237:
  ...
  mid_point_type:
    ...
    3:
      id: 'mid_point_mbo'
      doc: 'Midpoint order - Book Only'
    4:
      id: 'mid_point_crt'
      doc: 'Midpoint order - Counterparty Resting Time Restriction'
    5:
      id: 'mid_point_crtmbo'
      doc: 'Midpoint order - Book Only and Counterparty Resting Time Restriction'
  time_in_force:
    0:
      id: 'day'
      doc: 'Day (GFD)'
  ...
  trading_session_sub_id:
    ...
    105:
      ...
      doc: 'Special auction'
    106:
      id: 'main_trading_hours'
      doc: 'Main Trading Hours'
    107:
      id: 'avd_opening_auction'
      doc: 'Auction Volume Discovery Opening Auction'
    108:
      id: 'avd_intraday_auction'
      doc: 'Auction Volume Discovery Intraday Auction'
    109:
      id: 'avd_closing_auction'
      doc: 'Auction Volume Discovery Closing Auction'
  appl_seq_indicator:
    0:
  ...
  session_sub_mode:
    ...
    4:
      id: 'sponsored_access_tradingsession'
      doc: 'Sponsored Access Trading Session'
    5:
      id: 'sponsored_access_back_officesession'
      doc: 'Sponsored Access Back Office Session'
  ...
  event_type:
    ...
    116:
      id: 'suspend'
      doc: 'Instrument state Suspend'
    117:
      id: 'unsuspend'
      doc: 'Unsuspend Instrument'
    118:
      id: 'knockedout'
      doc: 'Knocked-out'
    119:
      id: 'knockedoutrevoked'
      doc: 'Knocked-out revoked'
    120:
      id: 'knockedoutandsuspended'
  ...
  match_type:
    ...
    15:
      ...
      doc: 'Retail'
    16:
      id: 'avd_broker_internalization'
      doc: 'Broker Internalized Auction Volume Discovery'
    17:
      id: 'avd'
      doc: 'Auction Volume Discovery'
  fill_liquidity_ind:
    1:
      id: 'added_liquidity'
      doc: 'Added Liquidity'
  ...
  quote_event_reason:
    ...
    23:
      id: 'rlp_quote_cleanup'
      doc: 'Retail Liquidity Provider Quote deletion outside Continuous'
