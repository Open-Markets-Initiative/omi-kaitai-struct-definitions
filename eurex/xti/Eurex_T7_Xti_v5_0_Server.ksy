# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Xti Fbe v5.0
#
# Protocol:
...
meta:
  id: eurex_t7_xti_fbe_v5_0_server
  title: Eurex T7 Xti Fbe v5.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Cash Enhanced Trading Interface Fbe v5.0'
...
enums:
  ...
  exec_restatement_reason:
    ...
    244:
      ...
      doc: 'Order has been marked for deletion'
    245:
  ...
  side_liquidity_ind:
    ...
    2:
      id: 'removed_liquidity'
      doc: 'Removed liquidity (aggressive)'
    4:
      id: 'none'
      doc: 'None'
  delivery_type:
