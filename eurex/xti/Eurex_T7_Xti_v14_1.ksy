# ---------------------------------------------------------------------
# Omi Kaitai Struct Definition: Eurex T7 Xti v14.1
#
# Please see end of file for rules and regulations
# ---------------------------------------------------------------------

meta:
  id: eurex_t7_xti_v14_1
  title: Eurex T7 Xti Fbe v14.1
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Cash Enhanced Trading Interface Fbe v14.1'
  ...
  otc_upload_broadcast:
    seq:
      ...
      - id: side_alloc_otc_grp_comp
        ...
        repeat: expr
        repeat-expr: no_side_otc_allocs
  ...
  pre_trade_risk_limits_definition_request:
    seq:
      ...
      - id: risk_limit_amount_grp_comp
        ...
        repeat: expr
        repeat-expr: no_risk_limit_amount
