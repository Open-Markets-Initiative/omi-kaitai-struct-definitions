# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Xti Fbe v9.0
#
# Protocol:
...
meta:
  id: eurex_t7_xti_fbe_v9_0_server
  title: Eurex T7 Xti Fbe v9.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Cash Enhanced Trading Interface Fbe v9.0'
