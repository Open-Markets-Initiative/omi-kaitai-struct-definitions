# ---------------------------------------------------------------------
# Omi Kaitai Struct Definition: Eurex T7 Eti v14.1
#
# Please see end of file for rules and regulations
# ---------------------------------------------------------------------

meta:
  id: eurex_t7_eti_v14_1
  title: Eurex T7 Eti Fbe v14.1
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Trading Interface Fbe v14.1'
  ...
  add_complex_instrument_request:
    seq:
      ...
      - id: enable_custom_commodity_strip
        type: u1
        enum: enable_custom_commodity_strip
      - id: compliance_text
        type: str
        size: 20
        encoding: ASCII
  ...
  basket_roll_broadcast:
    seq:
      ...
      - id: trd_type
        type: u2
        enum: trd_type
      - id: no_old_basket_side_alloc
        type: u2
      - id: no_new_basket_side_alloc
        type: u2
      - id: trade_report_type
        type: u1
        enum: trade_report_type
      ...
      - id: no_basket_root_party_grps_bc
        type: u1
      - id: no_old_basket_instrmt_match_sides
        type: u1
      - id: no_new_basket_instrmt_match_sides
        type: u1
      - id: basket_anonymity
        type: u1
        enum: basket_anonymity
