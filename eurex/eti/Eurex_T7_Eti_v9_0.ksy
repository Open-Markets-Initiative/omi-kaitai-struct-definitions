# ---------------------------------------------------------------------
# Omi Kaitai Struct Definition: Eurex T7 Eti v9.0
#
# Please see end of file for rules and regulations
# ---------------------------------------------------------------------

meta:
  id: eurex_t7_eti_v9_0
  title: Eurex T7 Eti Fbe v9.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Trading Interface Fbe v9.0'
  ...
  tes_trade_broadcast:
    seq:
      ...
      - id: srqs_related_trade_id_grp_comp
        ...
        repeat: expr
        repeat-expr: no_srqs_related_trade_i_ds
  srqs_related_trade_id_grp_comp:
    seq:
      - id: srqs_related_trade_id
        type: u4
      - id: pad_4
...
enums:
  ...
  cust_order_handling_inst:
    ...
    0x43:
      id: 'c'
      doc: 'C - FCM-provided screen'
    0x47:
      id: 'g'
      doc: 'G - FCM API or FIX'
    0x48:
      id: 'h'
      doc: 'H - Algo Engine'
    0x44:
  ...
  hedging_instruction:
    1:
      id: 'on_close'
      doc: 'Execute hedge transation in the closing auction of the underlying'
  md_book_type:
    1:
      id: 'top_of_book'
      doc: 'Top of book'
  ...
  compression_action:
    ...
    4:
      id: 'inquire_compression'
      doc: 'Inquire Compression'
  compression_status:
    1:
      id: 'open'
      doc: 'Open'
