# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eti Fbe v6.0
#
# Protocol:
...
meta:
  id: eurex_t7_eti_fbe_v6_0_server
  title: Eurex T7 Eti Fbe v6.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Trading Interface Fbe v6.0'
  ...
  srqs_create_deal_notification:
    seq:
      ...
      - id: side
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
      - id: num_srqs_trd_instrmnt_leg_grp_comp
        type: u1
        doc: 'Nullable, No Value = 0xFF'
      ...
      - id: free_text_1
        ...
        encoding: ASCII
        pad-right: 0x20
      - id: srqs_trd_instrmnt_leg_grp_comp
        type: srqs_trd_instrmnt_leg_grp_comp
        repeat: expr
        repeat-expr: num_srqs_trd_instrmnt_leg_grp_comp
  srqs_trd_instrmnt_leg_grp_comp:
    seq:
      - id: leg_security_id
        type: s8_nullable
        doc: 'Nullable, No Value = 0x8000000000000000'
