# ---------------------------------------------------------------------
# Omi Kaitai Struct Definition: Eurex T7 Eti v8.0
#
# Please see end of file for rules and regulations
# ---------------------------------------------------------------------

meta:
  id: eurex_t7_eti_v8_0
  title: Eurex T7 Eti Fbe v8.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Trading Interface Fbe v8.0'
...
enums:
  ...
  quote_type:
    ...
    1:
      id: 'tradeable'
      doc: 'Tradeable - For Continuous Auction with Specialist: Standard Quote'
    100:
      id: 'tradeable_boc'
      doc: 'Tradeable(BOC)'
  ...
  quote_qualifier:
    ...
    4:
      id: 'stp'
      doc: 'Auto Trade / Eurex EnLight Straight-Through-Processing (STP)'
  trade_underlying:
    1:
      id: 'no'
      doc: 'No'
