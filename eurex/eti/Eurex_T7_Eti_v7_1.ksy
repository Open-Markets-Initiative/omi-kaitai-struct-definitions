# ---------------------------------------------------------------------
# Omi Kaitai Struct Definition: Eurex T7 Eti v7.1
#
# Please see end of file for rules and regulations
# ---------------------------------------------------------------------

meta:
  id: eurex_t7_eti_v7_1
  title: Eurex T7 Eti Fbe v7.1
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Trading Interface Fbe v7.1'
