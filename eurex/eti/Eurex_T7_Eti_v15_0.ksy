# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eti Fbe v15.0
#
# Protocol:
...
meta:
  id: eurex_t7_eti_fbe_v15_0
  title: Eurex T7 Eti Fbe v15.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Trading Interface Fbe v15.0'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'template_id::add_scaled_simple_instrument_response': add_scaled_simple_instrument_response
            ...
            'template_id::basket_roll_broadcast': basket_roll_broadcast
            ...
            'template_id::mass_order_ack': mass_order_ack
            ...
            'template_id::tes_inquire_boundary_prices_request': tes_inquire_boundary_prices_request
            'template_id::tes_inquire_boundary_prices_response': tes_inquire_boundary_prices_response
            ...
            'template_id::update_reference_price_request': update_reference_price_request
            'template_id::update_reference_prices_response': update_reference_prices_response
  ...
  add_complex_instrument_request:
    seq:
      ...
      - id: multileg_model
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
      - id: enable_custom_commodity_strip
        type: u1_nullable
        doc: 'Nullable, No Value = 0xFF'
      - id: compliance_text
        type: str
  ...
  basket_roll_broadcast:
    seq:
      ...
      - id: trade_report_id
        ...
        encoding: ASCII
        pad-right: 0x20
      - id: old_basket_data_bc_grp_comp
        type: old_basket_data_bc_grp_comp
      - id: new_basket_data_bc_grp_comp
        type: new_basket_data_bc_grp_comp
      - id: basket_root_party_grp_comp
        type: basket_root_party_grp_comp
        repeat: expr
        repeat-expr: num_basket_root_party_grp_comp
  ...
  tes_execution_broadcast:
    seq:
      ...
      - id: pad2v2
        size: 2
  tes_inquire_boundary_prices_request:
    seq:
      - id: network_msg_id
        type: str
        size: 8
      ...
      - id: pad1
        size: 1
  tes_inquire_boundary_prices_response:
    seq:
      - id: pad2
        size: 2
      - id: response_header_comp
        type: response_header_comp
      - id: min_boundary_price
        type: decimal_u8_8_nullable
        doc: 'Implied decimal with scale 1e-8. Nullable, No Value = 0x8000000000000000'
      - id: max_boundary_price
        type: decimal_u8_8_nullable
        doc: 'Implied decimal with scale 1e-8. Nullable, No Value = 0x8000000000000000'
      - id: market_segment_id
        type: s4_nullable
  ...
  unsubscribe_response:
    seq:
      ...
      - id: response_header_comp
        type: response_header_comp
  update_reference_price_request:
    seq:
      - id: network_msg_id
        type: str
        size: 8
      ...
      - id: pad4
        size: 4
  update_reference_prices_response:
    seq:
      - id: pad2
        size: 2
      - id: response_header_comp
...
enums:
  template_id:
    ...
    10329:
      id: 'tes_inquire_boundary_prices_request'
      doc: 'Tes Inquire Boundary Prices Request TemplateId'
    10330:
      id: 'tes_inquire_boundary_prices_response'
      doc: 'Tes Inquire Boundary Prices Response TemplateId'
    10611:
      id: 'tes_response'
    ...
    10331:
      id: 'update_reference_price_request'
      doc: 'Update Reference Price Request TemplateId'
    10332:
      id: 'update_reference_prices_response'
      doc: 'Update Reference Prices Response TemplateId'
    10325:
  ...
  trade_alloc_status:
    ...
    11:
      id: 'auto_approved_reversal'
      doc: 'Auto Approved Reversal'
  position_effect:
    0x43:
      id: 'close'
      doc: 'Close'
  ...
  delete_reason:
    ...
    112:
      id: 'd_2_order_cancellation'
      doc: 'D-2 Order Cancellation'
  appl_id_status:
    105:
  ...
  mass_action_reason:
    ...
    122:
      ...
      doc: 'D-2 Order Cancellation'
    123:
      id: 'user_risk_group_disable'
      doc: 'User risk group has been disabled'
    124:
