# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eti Fbe v5.0
#
# Protocol:
...
meta:
  id: eurex_t7_eti_fbe_v5_0_server
  title: Eurex T7 Eti Fbe v5.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Trading Interface Fbe v5.0'
