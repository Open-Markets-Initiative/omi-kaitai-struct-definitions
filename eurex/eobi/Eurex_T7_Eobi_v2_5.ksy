# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eobi Fbe v2.5
#
# Protocol:
...
meta:
  id: eurex_t7_eobi_fbe_v2_5
  title: Eurex T7 Eobi Fbe v2.5
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Order Book Interface Fbe v2.5'
