# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eobi Fbe v8.1
#
# Protocol:
...
meta:
  id: eurex_t7_eobi_fbe_v8_1
  title: Eurex T7 Eobi Fbe v8.1
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Order Book Interface Fbe v8.1'
