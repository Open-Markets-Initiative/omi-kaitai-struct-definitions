# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eobi Fbe v6.0
#
# Protocol:
...
meta:
  id: eurex_t7_eobi_fbe_v6_0
  title: Eurex T7 Eobi Fbe v6.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Order Book Interface Fbe v6.0'
