# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eobi Fbe v8.0
#
# Protocol:
...
meta:
  id: eurex_t7_eobi_fbe_v8_0
  title: Eurex T7 Eobi Fbe v8.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Order Book Interface Fbe v8.0'
...
enums:
  ...
  trade_condition:
    1: 'implied_trade'
    86:
      id: 'special_auction_price'
      doc: 'Final Price of Session (V)'
    107:
      id: 'out_of_sequence'
      doc: 'Out of sequence'
    153:
      id: 'systematic_internalizer'
      doc: 'Systematic Internalizer (AZ)'
    155:
      id: 'midpoint_price'
      doc: 'Midpoint price (BB)'
    156:
      id: 'traded_before_issue_date'
      doc: 'Traded Before Issue Date (BC)'
  ord_type:
    1:
      id: 'market'
      doc: 'Market Order'
