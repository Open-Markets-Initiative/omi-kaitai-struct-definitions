# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Eobi Fbe v14.1
#
# Protocol:
...
meta:
  id: eurex_t7_eobi_fbe_v14_1
  title: Eurex T7 Eobi Fbe v14.1
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Enhanced Order Book Interface Fbe v14.1'
  ...
  instrmt_leg_grp_comp:
    seq:
      ...
      - id: leg_side
        type: u1
        enum: leg_side
      - id: related_price_type
        type: u1
        enum: related_price_type
      - id: trading_style
        type: u1
        enum: trading_style
      - id: related_price
...
enums:
  ...
  product_complex:
    ...
    14: 'total_return_future_strategy'
  ...
  trade_condition:
    ...
    206:
      ...
      doc: 'Auction Volume Discovery (DA)'
  ord_type:
    1:
      id: 'market'
      doc: 'Market Order'
  ...
  trading_session_sub_id:
    ...
    5: 'post_trading'
    7: 'quiescent'
    10: 'out_of_main_session_trading'
  trad_ses_status:
    1: 'halted'
    2: 'open'
    3: 'closed'
