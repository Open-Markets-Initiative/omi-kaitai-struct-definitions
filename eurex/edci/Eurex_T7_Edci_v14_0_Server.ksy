# ---------------------------------------------------------------------
# Kaitai struct definition for: Eurex T7 Edci Fbe v14.0
#
# Protocol:
...
meta:
  id: eurex_t7_edci_fbe_v14_0_server
  title: Eurex T7 Edci Fbe v14.0
  license: GPL-3.0
  endian: le

doc: 'Eurex Exchange T7 Extended Derivatives Clearing Interface Fbe v14.0'
...
seq:
  - id: server_message
    ...
    repeat: eos
    doc: 'Eurex T7 Edci Message sent by Eurex to the participant'
