...
| --- | --- | --- | --- | ---: | ---: | --- | --- | --- |
| [TxseEquities][TxseEquities.Exchange] | [Bale][Txse.TxseEquities.Bale] | [Rake][Omi.Encoding.Rake] | [1.0][Txse.TxseEquities.Bale.Rake.v1.0.Definition] | 6/12/2026 | 730 | [Active][Omi.Glossary.Deployment.Active] | [Untested][Omi.Glossary.Testing.Untested] | [url][Txse.TxseEquities.Bale.Rake.v1.0.Url] - [pdf][Txse.TxseEquities.Bale.Rake.v1.0.Pdf] |
| [TxseEquities][TxseEquities.Exchange] | [Feed][Txse.TxseEquities.Feed] | [Rake][Omi.Encoding.Rake] | [1.0][Txse.TxseEquities.Feed.Rake.v1.0.Definition] | 6/12/2026 | 862 | [Active][Omi.Glossary.Deployment.Active] | [Untested][Omi.Glossary.Testing.Untested] | [url][Txse.TxseEquities.Feed.Rake.v1.0.Url] - [pdf][Txse.TxseEquities.Feed.Rake.v1.0.Pdf] |
| [TxseEquities][TxseEquities.Exchange] | [Framing][Txse.TxseEquities.Framing] | [Tcp][Omi.Encoding.Tcp] | [1.0][Txse.TxseEquities.Framing.Tcp.v1.0.Definition] | 6/12/2026 | 185 | [Header][Omi.Glossary.Deployment.Header] | [Untested][Omi.Glossary.Testing.Untested] | [url][Txse.TxseEquities.Framing.Tcp.v1.0.Url] - [pdf][Txse.TxseEquities.Framing.Tcp.v1.0.Pdf] |
| [TxseEquities][TxseEquities.Exchange] | [Framing][Txse.TxseEquities.Framing] | [Udp][Omi.Encoding.Udp] | [1.0][Txse.TxseEquities.Framing.Udp.v1.0.Definition] | 6/12/2026 | 102 | [Header][Omi.Glossary.Deployment.Header] | [Untested][Omi.Glossary.Testing.Untested] | [url][Txse.TxseEquities.Framing.Udp.v1.0.Url] - [pdf][Txse.TxseEquities.Framing.Udp.v1.0.Pdf] |
| [TxseEquities][TxseEquities.Exchange] | [Seed][Txse.TxseEquities.Seed] | [Rake][Omi.Encoding.Rake] | [1.0][Txse.TxseEquities.Seed.Rake.v1.0.Definition] | 6/12/2026 | 3549 | [Active][Omi.Glossary.Deployment.Active] | [Untested][Omi.Glossary.Testing.Untested] | [url][Txse.TxseEquities.Seed.Rake.v1.0.Url] - [pdf][Txse.TxseEquities.Seed.Rake.v1.0.Pdf] |
...
[Txse.TxseEquities.Bale.Rake.v1.0.Definition]: https://github.com/Open-Markets-Initiative/omi-kaitai-struct-definitions/blob/main/txse/txseequities/bale/TxseEquities_Bale_v1_0.ksy "Txse TxseEquities Bale Rake v1.0 Kaitai Struct Definition"
...
[Txse.TxseEquities.Feed.Rake.v1.0.Definition]: https://github.com/Open-Markets-Initiative/omi-kaitai-struct-definitions/blob/main/txse/txseequities/feed/TxseEquities_Feed_v1_0.ksy "Txse TxseEquities Feed Rake v1.0 Kaitai Struct Definition"
...
[Txse.TxseEquities.Framing.Tcp.v1.0.Definition]: https://github.com/Open-Markets-Initiative/omi-kaitai-struct-definitions/blob/main/txse/txseequities/framing/TxseEquities_Framing_Tcp_v1_0.ksy "Txse TxseEquities Framing Tcp v1.0 Kaitai Struct Definition"
...
[Txse.TxseEquities.Framing.Udp.v1.0.Definition]: https://github.com/Open-Markets-Initiative/omi-kaitai-struct-definitions/blob/main/txse/txseequities/framing/TxseEquities_Framing_Udp_v1_0.ksy "Txse TxseEquities Framing Udp v1.0 Kaitai Struct Definition"
...
[Txse.TxseEquities.Seed.Rake.v1.0.Definition]: https://github.com/Open-Markets-Initiative/omi-kaitai-struct-definitions/blob/main/txse/txseequities/seed/TxseEquities_Seed_v1_0.ksy "Txse TxseEquities Seed Rake v1.0 Kaitai Struct Definition"
