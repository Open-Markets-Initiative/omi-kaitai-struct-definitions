# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe BzxOptions BinaryOrderEntry Boe v2.10
#
# Protocol:
...
meta:
  id: cboe_bzxoptions_binaryorderentry_boe_v2_10
  title: Cboe BzxOptions BinaryOrderEntry Boe v2.10
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Bzx Options Binary Order Entry Boe v2.10'
...
types:
  ...
  new_order_bitfield_8:
    ...
    seq:
      ...
      - id: new_order_bitfield_8_client_id_attr
        type: b1
      - id: new_order_bitfield_8_reserved_16
        type: b1
  ...
  new_order_bitfield_9:
    meta:
      bit-endian: le
    seq:
      - id: new_order_bitfield_9_reserved_1
        type: b1
      - id: new_order_bitfield_9_reserved_2
        type: b1
      - id: new_order_bitfield_9_reserved_4
        type: b1
