# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe BzxOptions ComplexTop Spin v1.1.54
#
# Protocol:
...
meta:
  id: cboe_bzxoptions_complextop_spin_v1_1_54
  title: Cboe BzxOptions ComplexTop Spin v1.1.54
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Bzx Options Complex Top Spin v1.1.54'
