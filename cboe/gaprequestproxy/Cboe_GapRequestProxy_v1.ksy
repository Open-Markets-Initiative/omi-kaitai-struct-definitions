# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe GapRequestProxy Pitch v1
#
# Protocol:
...
meta:
  id: cboe_gaprequestproxy_pitch_v1
  title: Cboe GapRequestProxy Pitch v1
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Pitch v1'
...
enums:
  message_type:
    0x01:
      id: 'login_message'
      doc: 'The Login message is the first message sent to the Gap Request Proxy by a user''s process after the connection is established. Failure to login before sending any other message type will result in the connection being dropped by the Gap Request Proxy.'
    0x02:
      id: 'login_response_message'
      doc: 'The Login Response message is sent by the Gap Request Proxy to a user''s process in response to a Login message. The status field is used to reflect an accepted login or the reason the session was not accepted. If login fails, the connection will be dropped after the Login Response message is sent.'
    0x03:
      id: 'gap_request_message'
      doc: 'The Gap Request message is used by a user''s process to request retransmission of a sequenced message (or messages) by one of Cboe''s gap servers.'
    0x04:
      id: 'gap_response_message'
      doc: 'The Gap Response message is sent by the Gap Request Proxy in response to a Gap Request message. The Unit and Sequence fields will match the values supplied in the Gap Request message. A Gap Response message, with a Status of Accepted or reason for failure, will be sent for each Gap Request message received by the Gap Request Proxy.'
