# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe ByxEquities MulticastDepthOfBook Pitch v2.41.29
#
# Protocol:
...
meta:
  id: cboe_byxequities_multicastdepthofbook_pitch_v2_41_29
  title: Cboe ByxEquities MulticastDepthOfBook Pitch v2.41.29
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Byx Equities Multicast Depth Of Book Pitch v2.41.29'
...
types:
  ...
  auction_update_message:
    seq:
      ...
      - id: buy_shares
        type: u4
        doc: 'Paired size of eligible periodic auction orders at the Reference Price'
      - id: sell_shares
        type: u4
        doc: 'Paired size of eligible periodic auction orders at the Reference Price'
      - id: indicative_price
        type: u8
        doc: 'N/A. Populated with zero'
...
enums:
  message_type:
    ...
    0x98:
      ...
      doc: 'This message is a Retail Liquidity Indicator (RLI) that includes symbol and side, but not price and size'
  side_indicator:
    0x42:
      id: 'buy_order'
      doc: 'Buy Order'
