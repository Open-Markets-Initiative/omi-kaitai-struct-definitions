# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe CxeEquities TcpDepthOfBook AsciiPitch v4.34
#
# Protocol:
...
meta:
  id: cboe_cxeequities_tcpdepthofbook_asciipitch_v4_34
  title: Cboe CxeEquities TcpDepthOfBook AsciiPitch v4.34
  license: GPL-3.0
  endian: be

doc: 'Chicago Board Options Exchange Cboe CXE Tcp Depth Of Book AsciiPitch v4.34'
