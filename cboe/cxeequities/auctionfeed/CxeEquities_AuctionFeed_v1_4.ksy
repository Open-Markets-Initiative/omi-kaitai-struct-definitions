# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe CxeEquities AuctionFeed AsciiPitch v1.4
#
# Protocol:
...
meta:
  id: cboe_cxeequities_auctionfeed_asciipitch_v1_4
  title: Cboe CxeEquities AuctionFeed AsciiPitch v1.4
  license: GPL-3.0
  endian: be

doc: 'Chicago Board Options Exchange Cboe CXE Auction Feed AsciiPitch v1.4'
