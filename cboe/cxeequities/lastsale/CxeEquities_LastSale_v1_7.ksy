# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe CxeEquities LastSale Apf v1.7
#
# Protocol:
...
meta:
  id: cboe_cxeequities_lastsale_apf_v1_7
  title: Cboe CxeEquities LastSale Apf v1.7
  license: GPL-3.0
  endian: be

doc: 'Chicago Board Options Exchange Cboe CXE Last Sale Apf v1.7'
