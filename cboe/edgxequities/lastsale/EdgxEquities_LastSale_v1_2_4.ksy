# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe EdgxEquities LastSale AsciiPitch v1.2.4
#
# Protocol:
...
meta:
  id: cboe_edgxequities_lastsale_asciipitch_v1_2_4
  title: Cboe EdgxEquities LastSale AsciiPitch v1.2.4
  license: GPL-3.0
  endian: be

doc: 'Chicago Board Options Exchange Cboe Edgx Equities Last Sale AsciiPitch v1.2.4'
