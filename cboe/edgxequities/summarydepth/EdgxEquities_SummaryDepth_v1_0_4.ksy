# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe EdgxEquities SummaryDepth Pitch v1.0.4
#
# Protocol:
...
meta:
  id: cboe_edgxequities_summarydepth_pitch_v1_0_4
  title: Cboe EdgxEquities SummaryDepth Pitch v1.0.4
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Edgx Equities Summary Depth Pitch v1.0.4'
  ...
  clear_quote_message:
    seq:
      - id: last_update_timestamp
        ...
        doc: 'Timestamp of the last matching engine message that updated the quote information for this symbol in the Cboe Summary Depth server''s cache. Nanoseconds since Midnight epoch'
      - id: symbol
        type: str
        size: 8
        encoding: ASCII
