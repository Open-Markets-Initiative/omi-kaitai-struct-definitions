# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe EdgxEquities BinaryOrderEntry Boe v2.3
#
# Protocol:
...
meta:
  id: cboe_edgxequities_binaryorderentry_boe_v2_3
  title: Cboe EdgxEquities BinaryOrderEntry Boe v2.3
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Edgx Equities Binary Order Entry Boe v2.3'
  ...
  purge_order_message:
    seq:
      ...
      - id: symbol
        ...
        size: 8
        encoding: ASCII
        if: number_of_purge_order_bitfields >= 2 and purge_order_bitfield_2.purge_order_bitfield_2_symbol > 0
      - id: symbol_sfx
        type: str
        size: 8
        encoding: ASCII
        if: number_of_purge_order_bitfields >= 2 and purge_order_bitfield_2.purge_order_bitfield_2_symbol_sfx > 0
