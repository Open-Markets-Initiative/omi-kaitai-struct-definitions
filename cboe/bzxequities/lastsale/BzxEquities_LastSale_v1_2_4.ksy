# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe BzxEquities LastSale AsciiPitch v1.2.4
#
# Protocol:
...
meta:
  id: cboe_bzxequities_lastsale_asciipitch_v1_2_4
  title: Cboe BzxEquities LastSale AsciiPitch v1.2.4
  license: GPL-3.0
  endian: be

doc: 'Chicago Board Options Exchange Cboe Bzx Equities Last Sale AsciiPitch v1.2.4'
