# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe BxeEquities LastSale Apf v1.3
#
# Protocol:
...
meta:
  id: cboe_bxeequities_lastsale_apf_v1_3
  title: Cboe BxeEquities LastSale Apf v1.3
  license: GPL-3.0
  endian: be

doc: 'Chicago Board Options Exchange Cboe BXE Last Sale Apf v1.3'
