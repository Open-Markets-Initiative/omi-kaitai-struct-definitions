# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe CfeFutures MulticastTop Pitch v1.2.20
#
# Protocol:
#   Organization: Chicago Board Options Exchange
#   Protocol: Futures Multicast Top
#   Encoding: Pitch
#   Version: 1.2.20
#   Date: 1/5/2026
...
meta:
  id: cboe_cfefutures_multicasttop_pitch_v1_2_20
  title: Cboe CfeFutures MulticastTop Pitch v1.2.20
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Futures Exchange Futures Multicast Top Pitch v1.2.20'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::market_snapshot_short_message': market_snapshot_short_message
            'message_type::market_snapshot_long_message': market_snapshot_long_message
            'message_type::single_side_update_short_message': single_side_update_short_message
            'message_type::single_side_update_long_message': single_side_update_long_message
            'message_type::two_side_update_short_message': two_side_update_short_message
            'message_type::two_side_update_long_message': two_side_update_long_message
  ...
  market_snapshot_short_message:
    seq:
      ...
      - id: bid_quantity_short
        type: u2
        doc: 'Number of contracts on the bid side of the inside book (a zero value denotes the Bid Price is invalid)'
      - id: ask_price_short
        type: decimal_u2_2
        doc: 'Ask price (may be a zero or negative price for some instruments). Implied decimal with scale 1e-2'
      - id: ask_quantity_short
        type: u2
        doc: 'Number of contracts on the ask side of the inside book (a zero value denotes the Ask Price is invalid)'
      - id: last_trade_price_short
        type: decimal_u2_2
        doc: 'Price of last execution (this can be zero or negative for some instruments). Implied decimal with scale 1e-2'
      - id: last_trade_size_short
        type: u2
        doc: 'Number of contracts traded on the last trade (if this value is 0 the Last Trade Price is invalid)'
      - id: last_trade_condition
        type: u1
        enum: last_trade_condition
        doc: 'Last Trade Condition Values'
      - id: total_volume
        type: u4
        doc: 'Total number of contracts traded on the current business day'
      - id: trading_status
        type: u1
        enum: trading_status
      ...
      - id: reserved_3
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Reserved for use in other markets'
  market_snapshot_long_message:
    seq:
      - id: time_offset
        type: nanosecond_offset
        doc: 'Nanosecond offset from last unit timestamp. Nanoseconds since Second epoch'
      ...
      - id: last_trade_price_long
        type: decimal_u8_4
        doc: 'Price of last execution (this can be zero or negative for some instruments). Implied decimal with scale 1e-4'
      - id: last_trade_size_long
        type: u4
        doc: 'Number of contracts traded on the last trade (if this value is 0 the Last Trade Price is invalid)'
      - id: last_trade_condition
        type: u1
      ...
      - id: reserved_3
        ...
        pad-right: 0x20
        doc: 'Reserved for use in other markets'
  single_side_update_short_message:
    seq:
      - id: time_offset
        type: nanosecond_offset
        doc: 'Nanosecond offset from last unit timestamp. Nanoseconds since Second epoch'
      ...
      - id: quantity_short
        type: u2
        doc: 'Number of contracts on the inside book (a zero value denotes the Price is invalid)'
  single_side_update_long_message:
    seq:
      - id: time_offset
        type: nanosecond_offset
        doc: 'Nanosecond offset from last unit timestamp. Nanoseconds since Second epoch'
  ...
  top_trade_message:
    seq:
      ...
      - id: execution_id
        type: u8
        doc: 'CFE generated day-unique execution identifier of this trade. Execution Id is also referenced in the Trade Break message'
      - id: total_volume
        type: u4
        doc: 'Total number of contracts traded on the current business day'
      - id: trade_condition
...
enums:
  message_type:
    ...
    0x20:
      id: 'time_message'
      doc: 'A Time message is immediately generated and sent when there is a TOP event for a given clock second.'
    0x97:
      id: 'unit_clear_message'
      doc: 'The Unit Clear message instructs feed recipients to clear all market snapshots for the CFE book in the unit specified in the Sequenced Unit Header message header.'
    0xbb:
      id: 'futures_instrument_definition_message'
      doc: 'The Futures Instrument Definition message can be sent as a sequenced message or an un-sequenced message. It is sent as a sequenced message when the system starts up at the beginning of a trading session or if an instrument is created or modified during a trading day.'
    0xfa:
    ...
    0xbe:
      ...
      doc: 'The Price Limits message can be sent as a sequenced or un-sequenced message. It is sent out at the start of the session for products subject to price limits per the contract specifications.'
    0xb2:
      id: 'market_snapshot_short_message'
      doc: 'A Market Snapshot message provides a snapshot of the price and size for the bid and ask, last trade price, total number of contracts traded, and the current trading status of a single symbol.'
    0xb3:
      id: 'market_snapshot_long_message'
      doc: 'A Market Snapshot message provides a snapshot of the price and size for the bid and ask, last trade price, total number of contracts traded, and the current trading status of a single symbol.'
    0xb4:
      id: 'single_side_update_short_message'
      doc: 'Single Side Update messages provide an updated price and size for a single side of a Symbol.'
    0xb5:
      id: 'single_side_update_long_message'
      doc: 'Single Side Update messages provide an updated price and size for a single side of a Symbol.'
    0xb6:
      id: 'two_side_update_short_message'
      doc: 'Two Side Update messages provide an updated price and size for both sides of a Symbol.'
    0xb7:
      id: 'two_side_update_long_message'
      doc: 'Two Side Update messages provide an updated price and size for both sides of a Symbol.'
    0xb8:
      id: 'top_trade_message'
      doc: 'The TOP Trade message provides information about executions of orders on the CFE book. TOP Trade messages are necessary to calculate CFE execution-based data.'
    0xb9:
