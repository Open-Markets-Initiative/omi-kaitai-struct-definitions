# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe CfeFutures BinaryOrderEntry Boe3 v1.1.20
#
# Protocol:
...
meta:
  id: cboe_cfefutures_binaryorderentry_boe3_v1_1_20_exchange
  title: Cboe CfeFutures BinaryOrderEntry Boe3 v1.1.20
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Futures Exchange Futures Binary Order Entry Boe3 v1.1.20'
  ...
  - id: exchange_message
    type:
      ...
      cases:
        ...
        'exchange_message_type::order_acknowledgement': order_acknowledgement
        'exchange_message_type::order_acknowledgement_option': order_acknowledgement_option
        'exchange_message_type::order_rejected': order_rejected
        'exchange_message_type::order_modified': order_modified
        'exchange_message_type::modify_rejected': modify_rejected
        'exchange_message_type::order_execution': order_execution
        'exchange_message_type::order_execution_option': order_execution_option
        'exchange_message_type::order_cancelled': order_cancelled
        'exchange_message_type::cancel_rejected': cancel_rejected
        'exchange_message_type::mass_cancel_acknowledgement': mass_cancel_acknowledgement
        'exchange_message_type::mass_cancel_rejected': mass_cancel_rejected
        'exchange_message_type::purge_acknowledgement': purge_acknowledgement
        'exchange_message_type::purge_rejected': purge_rejected
        'exchange_message_type::trade_cancel_correct': trade_cancel_correct
        'exchange_message_type::trade_cancel_correct_option': trade_cancel_correct_option
        'exchange_message_type::tas_restatement': tas_restatement
        'exchange_message_type::quote_update_acknowledgement': quote_update_acknowledgement
        'exchange_message_type::quote_update_rejected': quote_update_rejected
        'exchange_message_type::quote_restated': quote_restated
        'exchange_message_type::quote_execution': quote_execution
        'exchange_message_type::quote_cancelled': quote_cancelled
        'exchange_message_type::tas_quote_restatement': tas_quote_restatement
        'exchange_message_type::reset_risk_acknowledgement': reset_risk_acknowledgement
        'exchange_message_type::new_complex_instrument_accepted_option': new_complex_instrument_accepted_option
        'exchange_message_type::new_complex_instrument_rejected_option': new_complex_instrument_rejected_option
  ...
  reset_risk_acknowledgement:
    seq:
      ...
      - id: request_received_time
        type: nanosecond_timestamp
        doc: 'The Earliest Timestamp Populated With Nanosecond Precision Recorded By Cfe Of The Corresponding Inbound Message Being Acknowledged. Nanoseconds since Unix epoch'
  new_complex_instrument_accepted_option:
    seq:
      - id: transaction_time
        type: nanosecond_timestamp
        doc: 'The Time The Event Occurred In The Cfe Matching Engine Not The Time The Message Was Sent. Nanoseconds since Unix epoch'
      ...
      - id: symbol
        ...
        encoding: ASCII
        doc: 'Simple Instruments Can Be Specified By Providing The Mapped Symbol Format In The Symbol Field Or By Providing The Product Name E'
      - id: no_of_complex_instruments
        type: u4
        doc: 'Number Of Complex Instruments'
      - id: num_option_leg
        type: u1
        doc: 'For Complex Orders The Number Of Legs Of The Complex Instrument Specified In The Symbol Field'
      - id: option_leg
  ...
  option_leg:
    seq:
      ...
      - id: leg_side
        ...
        enum: leg_side
        doc: 'Side'
  new_complex_instrument_rejected_option:
    seq:
      - id: transaction_time
        type: nanosecond_timestamp
        doc: 'The Time The Event Occurred In The Cfe Matching Engine Not The Time The Message Was Sent. Nanoseconds since Unix epoch'
      ...
      - id: clearing_firm
        ...
        encoding: ASCII
        doc: 'Efid That Will Clear The Trade'
      - id: complex_instrument_reject_reason
        type: str
        size: 1
        encoding: ASCII
        doc: 'Complex Instrument Reject Reason'
      - id: text
        type: str
        size: 60
        encoding: ASCII
