# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe NeoEquities MulticastMarketByPrice Pitch v1.0.13
#
# Protocol:
#   Organization: Chicago Board Options Exchange
#   Protocol: Multicast Market By Price
#   Encoding: Pitch
#   Version: 1.0.13
#   Date: 10/27/2025
...
meta:
  id: cboe_neoequities_multicastmarketbyprice_pitch_v1_0_13
  title: Cboe NeoEquities MulticastMarketByPrice Pitch v1.0.13
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe Canada NEO Multicast Market By Price Pitch v1.0.13'
...
enums:
  message_type:
    ...
    0x6a:
      ...
      doc: 'Provides an updated displayed price and size for a single side of a Symbol. Used on NEO-N (market by price book).'
    0x2d:
