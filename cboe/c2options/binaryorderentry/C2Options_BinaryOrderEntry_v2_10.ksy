  ...
  new_order_message:
    seq:
      ...
      - id: compression
        type: u1
        enum: compression
        if: number_of_new_order_bitfields >= 8 and new_order_bitfield_8.new_order_bitfield_8_compression > 0
      - id: floor_destination
        type: str
        size: 4
        encoding: ASCII
        if: number_of_new_order_bitfields >= 8 and new_order_bitfield_8.new_order_bitfield_8_floor_destination > 0
      - id: floor_routing_inst
        type: u1
        enum: floor_routing_inst
        if: number_of_new_order_bitfields >= 8 and new_order_bitfield_8.new_order_bitfield_8_floor_routing_inst > 0
      - id: order_origin
        type: str
        size: 3
        encoding: ASCII
  ...
  new_order_complex_message:
    seq:
      ...
      - id: combo_order
        type: u1
        enum: combo_order
        if: number_of_new_complex_order_bitfields >= 4 and new_complex_order_bitfield_4.new_complex_order_bitfield_4_combo_order > 0
      - id: compression
        type: u1
        enum: compression
        if: number_of_new_complex_order_bitfields >= 4 and new_complex_order_bitfield_4.new_complex_order_bitfield_4_compression > 0
      ...
      - id: floor_destination
        ...
        size: 4
        encoding: ASCII
        if: number_of_new_complex_order_bitfields >= 5 and new_complex_order_bitfield_5.new_complex_order_bitfield_5_floor_destination > 0
      - id: floor_routing_inst
        type: u1
        enum: floor_routing_inst
        if: number_of_new_complex_order_bitfields >= 5 and new_complex_order_bitfield_5.new_complex_order_bitfield_5_floor_routing_inst > 0
      - id: multi_class_sprd
        type: u1
  ...
  new_order_cross_multileg_message:
    seq:
      ...
      - id: compression
        type: u1
        enum: compression
        if: number_of_new_order_cross_multileg_bitfields >= 4 and new_order_cross_multileg_bitfield_4.new_order_cross_multileg_bitfield_4_compression > 0
      - id: ors
        type: u1
        enum: ors
  ...
  order_acknowledgment_message:
    seq:
      ...
      - id: combo_order
        type: u1
        enum: combo_order
        if: number_of_return_bitfields >= 16 and return_bitfield_16.return_bitfield_16_combo_order > 0
      - id: compression
        type: u1
        enum: compression
        if: number_of_return_bitfields >= 16 and return_bitfield_16.return_bitfield_16_compression > 0
      - id: floor_destination
        type: str
        size: 4
        encoding: ASCII
        if: number_of_return_bitfields >= 16 and return_bitfield_16.return_bitfield_16_floor_destination > 0
      - id: floor_routing_inst
        type: u1
        enum: floor_routing_inst
        if: number_of_return_bitfields >= 16 and return_bitfield_16.return_bitfield_16_floor_routing_inst > 0
      - id: multi_class_sprd
        type: u1
        enum: multi_class_sprd
