# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C2Options Complex Spin v2.1.61
#
# Protocol:
...
meta:
  id: cboe_c2options_complex_spin_v2_1_61
  title: Cboe C2Options Complex Spin v2.1.61
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe C2 Options Complex Spin v2.1.61'
