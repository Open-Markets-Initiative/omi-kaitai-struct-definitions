# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C1Options Complex Pitch v2.1.37
#
# Protocol:
...
meta:
  id: cboe_c1options_complex_pitch_v2_1_37
  title: Cboe C1Options Complex Pitch v2.1.37
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe C1 Options Complex Pitch v2.1.37'
...
types:
  ...
  time_message:
    seq:
      ...
      - id: epoch_time
        type: u4
        doc: 'Number of whole seconds since the Epoch Time'
  unit_clear_message:
    seq:
      - id: time_offset
        type: nanosecond_offset
  ...
  complex_instrument_definition_expanded_message:
    seq:
      ...
      - id: complex_instrument_type
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: '4 character field; each field describes a characteristic'
      - id: num_complex_instrument_leg
        type: u1
        doc: 'The number of legs in the complex instrument. The maximum number of legs is 12'
      - id: complex_instrument_leg
        type: complex_instrument_leg
        repeat: expr
        repeat-expr: num_complex_instrument_leg
        doc: 'Leg for multi-leg strategies'
  complex_instrument_leg:
    seq:
      - id: leg_symbol
        type: str
        size: 8
      ...
      - id: leg_security_type
        ...
        doc: 'Option or Equity instrument'
  ...
  trading_status_message:
    seq:
      ...
      - id: gth_trading_status
        ...
        doc: 'GTH Trading Status (C1 Only)'
      - id: padding
        size: 1
        doc: 'Reserved'
...
enums:
  message_type:
    ...
    0x9a:
      ...
      doc: 'A Complex Instrument Definition Expanded message represents a complex instrument that is available to place orders.'
    0x2e:
    ...
    0xd1:
      ...
      doc: 'Options Auction Update messages are used to disseminate price and size information during the Opening and Re-Opening (halt) process for complex instruments.'
    0x96:
  ...
  trade_condition:
    ...
    0x68:
      ...
      doc: 'Complex'
    0x6a:
      id: 'complex_electronic_trade_against_single'
      doc: 'Complex Electronic Trade Against Single'
    0x6b:
      id: 'complex_with_stock_options_auction_trade'
      doc: 'Complex With Stock Options Auction Trade'
    0x6d:
      id: 'complex_floor_trade_against_single_leg'
      doc: 'Complex Floor Trade Against Single Leg'
    0x6e:
    ...
    0x74:
      id: 'complex_combo_order_floor_trade'
      doc: 'Complex Floor Trade Of Proprietary Products Marked As Combo Order'
    0x76:
      id: 'extended_hours_trade'
      doc: 'Transaction Represents A Trade Executed During The Curb Session'
    0x49:
      id: 'electronic_trade_x49'
      doc: 'Electronic Trade'
    0x4f:
      id: 'opening_trade'
      doc: 'Opening Trade'
  auction_type:
    0x43:
      ...
      doc: 'Complex Auction'
    0x53:
      id: 'complex_solicitation_auction'
      doc: 'Complex Solicitation Auction'
    0x42:
      id: 'complex_aim'
      doc: 'Complex Aim'
    0x4f:
