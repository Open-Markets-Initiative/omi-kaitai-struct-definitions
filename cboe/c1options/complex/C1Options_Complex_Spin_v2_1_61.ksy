# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C1Options Complex Spin v2.1.61
#
# Protocol:
...
meta:
  id: cboe_c1options_complex_spin_v2_1_61
  title: Cboe C1Options Complex Spin v2.1.61
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe C1 Options Complex Spin v2.1.61'
