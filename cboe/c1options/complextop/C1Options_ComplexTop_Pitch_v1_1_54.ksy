# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C1Options ComplexTop Pitch v1.1.54
#
# Protocol:
...
meta:
  id: cboe_c1options_complextop_pitch_v1_1_54
  title: Cboe C1Options ComplexTop Pitch v1.1.54
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe C1 Options Complex Top Pitch v1.1.54'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::exchange_designated_complex_instrument_definition_message': exchange_designated_complex_instrument_definition_message
  ...
  exchange_designated_complex_instrument_definition_message:
    seq:
      - id: time_offset
        type: nanosecond_offset
        doc: 'Nanosecond offset from last unit timestamp. Nanoseconds since Second epoch'
      ...
      - id: edci_type
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Exchange Designated Complex Instrument type right padded with spaces'
      - id: edci_subtype
        type: str
        size: 20
        encoding: ASCII
        pad-right: 0x20
        doc: 'Exchange Designated Complex Instrument subtype right padded with spaces'
      - id: reserved_2
        size: 2
        doc: 'Reserved'
      - id: num_edcid_leg
      ...
      - id: edcid_leg
        type: edcid_leg
        repeat: expr
        repeat-expr: num_edcid_leg
        doc: 'Repeating leg definition group inside the Exchange Designated Complex Instrument Definition message. Repeats Leg Count times'
  edcid_leg:
    seq:
      - id: leg_symbol_short
        type: str
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Option symbol of leg, right padded with spaces'
      - id: leg_ratio
        type: s4
        doc: 'Leg ratio (positive for buy-side, negative for sell-side). For options this is the number of contracts, for equities this is the number of shares'
...
enums:
  message_type:
    ...
    0x31:
      ...
      doc: 'The Trading Status message is used to indicate the current trading status of a complex instrument. A Trading Status message will be sent whenever a complex instrument trading status changes. The Trading Status field will be used to represent the status of the RTH (9:30 a.m. ET - 4:15 p.m. ET) and Curb sessions. The GTH Trading Status field will be used to represent the status of series that trade during the GTH session. The GTH session runs from 8:15 p.m. to 9:25 a.m. ET for GTH-eligible Products (C1 only).'
    0x2d:
