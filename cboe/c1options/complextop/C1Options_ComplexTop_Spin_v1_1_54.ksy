# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C1Options ComplexTop Spin v1.1.54
#
# Protocol:
...
meta:
  id: cboe_c1options_complextop_spin_v1_1_54
  title: Cboe C1Options ComplexTop Spin v1.1.54
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe C1 Options Complex Top Spin v1.1.54'
...
types:
  ...
  complex_leg:
    seq:
      - id: leg_symbol_printable_ascii_8
        type: str
        size: 8
        encoding: ASCII
        pad-right: 0x20
  ...
  edcid_leg:
    seq:
      - id: leg_symbol_printable_ascii_6
        type: str
        size: 6
        encoding: ASCII
        pad-right: 0x20
