# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C1Options OpeningAuction Csm v1.0
#
# Protocol:
#   Organization: Chicago Board Options Exchange
#   Protocol: Opening Auction Feed
#   Encoding: Csm
#   Version: 1.0
#   Date: 7/18/2018
...
meta:
  id: cboe_c1options_openingauction_csm_v1_0
  title: Cboe C1Options OpeningAuction Csm v1.0
  license: GPL-3.0
  endian: be

doc: 'Chicago Board Options Exchange Cboe C1 Options Opening Auction Feed Csm v1.0'
