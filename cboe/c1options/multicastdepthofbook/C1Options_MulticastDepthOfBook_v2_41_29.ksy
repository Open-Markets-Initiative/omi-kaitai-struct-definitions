# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C1Options MulticastDepthOfBook Pitch v2.41.29
#
# Protocol:
...
meta:
  id: cboe_c1options_multicastdepthofbook_pitch_v2_41_29
  title: Cboe C1Options MulticastDepthOfBook Pitch v2.41.29
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe C1 Options Multicast Depth Of Book Pitch v2.41.29'
...
types:
  ...
  time_reference_message:
    seq:
      - id: midnight_reference
        ...
        doc: 'Midnight Eastern Time reference time for subsequent Time messages, expressed as number of whole seconds since the Epoch. Seconds since Unix epoch'
      - id: time_reference
        type: u4
  ...
  time_message:
    seq:
      ...
      - id: epoch_time
        type: u4
        doc: 'Number of whole seconds since the Epoch'
  unit_clear_message:
    seq:
      - id: time_offset
        type: nanosecond_offset
  ...
  auction_notification_message:
    seq:
      ...
      - id: auction_notification_type
        type: u1
        enum: auction_notification_type
        doc: 'Auction Type'
      - id: side
        type: str
        size: 1
...
enums:
  message_type:
    ...
    0x9d:
      ...
      doc: 'This message disseminates the minimum and maximum strike prices of the strike price range used to calculate the Special Opening Quote (“SOQ”) on a Volatility Settlement date'
    0x9e:
  ...
  auction_type:
    0x47:
      ...
      doc: 'Gth Opening'
    0x4f:
      id: 'rth_opening_auction'
      doc: 'Rth Opening Auction'
    0x48:
      id: 'halt_re_opening'
      doc: 'Halt Re Opening'
    0x56:
