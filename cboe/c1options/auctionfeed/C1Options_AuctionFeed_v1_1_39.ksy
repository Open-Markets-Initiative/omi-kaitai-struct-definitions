# ---------------------------------------------------------------------
# Kaitai struct definition for: Cboe C1Options AuctionFeed Pitch v1.1.39
#
# Protocol:
...
meta:
  id: cboe_c1options_auctionfeed_pitch_v1_1_39
  title: Cboe C1Options AuctionFeed Pitch v1.1.39
  license: GPL-3.0
  endian: le

doc: 'Chicago Board Options Exchange Cboe C1 Options Auction Feed Pitch v1.1.39'
...
types:
  ...
  time_message:
    seq:
      ...
      - id: epoch_time
        type: u4
        doc: 'C1 Only. Number of whole seconds since the Epoch (midnight January 1, 1970 UTC)'
  unit_clear_message:
    seq:
      - id: time_offset
        type: nanosecond_offset
