# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax MiaxOptions ComplexTopOfMarket Mach v1.3.a
#
# Protocol:
...
meta:
  id: miax_miaxoptions_complextopofmarket_mach_v1_3_a_udp
  title: Miax MiaxOptions ComplexTopOfMarket Mach v1.3.a
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Options Complex Top of Market Mach v1.3.a'
...
types:
  ...
  complex_top_of_market_best_bid_or_offer_compact_format_bid_message:
    seq:
      ...
      - id: price_short
        type: decimal_s2_2
        doc: 'MIAX Best price at the time stated in Timestamp and side specified in Message Type. The net limit price for the strategy. Implied decimal with scale 1e-2'
      - id: size_short
        type: u2
  ...
  complex_top_of_market_best_bid_or_offer_wide_format_bid_message:
    seq:
      ...
      - id: price_long
        type: decimal_s8_4
        doc: 'MIAX Best price at the time stated in Timestamp and side specified in Message Type. The net limit price for the strategy. Implied decimal with scale 1e-4'
      - id: size_long
        type: u4
        doc: 'Aggregate size at MIAX Best Price at the time stated in Timestamp and side specified in Message Type'
...
enums:
  ...
  message_type:
    ...
    0x62:
      ...
      doc: 'This is the message format that will be used to disseminate each side of the MIAX Complex Top of Market for strategies with low Net Price and small aggregate MIAX Best Bid or Offer (MBBO) size. MIAX Complex Top of Market on Bid side.'
    0x6f:
      id: 'complex_top_of_market_best_bid_or_offer_compact_format_offer_message'
      doc: 'This is the message format that will be used to disseminate each side of the MIAX Complex Top of Market for strategies with low Net Price and small aggregate MIAX Best Bid or Offer (MBBO) size. MIAX Complex Top of Market on Offer side.'
    0x65:
      id: 'complex_top_of_market_best_bid_or_offer_wide_format_bid_message'
      doc: 'This is the message format that will be used to disseminate MIAX Complex Top of Market for strategies with high net price or large aggregate MIAX Best Bid or Offer (MBBO) size. MIAX Complex Top of Market on Bid side.'
    0x66:
      id: 'complex_top_of_market_best_bid_or_offer_wide_format_offer_message'
      doc: 'This is the message format that will be used to disseminate MIAX Complex Top of Market for strategies with high net price or large aggregate MIAX Best Bid or Offer (MBBO) size. MIAX Complex Top of Market on Offer side.'
    0x6d:
