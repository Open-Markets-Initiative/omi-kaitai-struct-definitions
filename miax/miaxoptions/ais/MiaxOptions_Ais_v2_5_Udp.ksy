# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax MiaxOptions Ais Mach v2.5
#
# Protocol:
...
meta:
  id: miax_miaxoptions_ais_mach_v2_5_udp
  title: Miax MiaxOptions Ais Mach v2.5
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Options Administrative Information Subscriber Mach v2.5'
...
types:
  ...
  simple_liquidity_seeking_event_notification_message:
    seq:
      ...
      - id: event_id
        type: u4
        doc: 'Unique Event ID for the current event'
      - id: price_short
        type: decimal_u4_4
        doc: 'Current price of the Event. Implied decimal with scale 1e-4'
      - id: imbalance_side
        type: u1
        enum: imbalance_side
        doc: 'This is the side of the excess liquidity that is waiting to get matched'
      - id: quantity_1
        type: u4
        doc: 'MatchQty - Number of contracts ready to be matched (both buyers and sellers already present)'
      - id: quantity_2
        type: u4
        doc: 'Routable Quantity. Number of contracts that may be routed'
      - id: quantity_3
        type: u4
        doc: 'Imbalance Quantity. Number of contracts on the Imbalance Side that cannot be matched'
      - id: quantity_4
        type: u4
        doc: 'Must Fill Quantity. Number of contracts, on the provided Side, that must be matched at the provided Price'
      - id: attributable_id
        type: str
        size: 4
        encoding: ASCII
  ...
  complex_liquidity_seeking_event_notification_message:
    seq:
      ...
      - id: side
        type: u1
        enum: side
        doc: 'Side of the auction'
      - id: price_long
        type: decimal_s8_4
        doc: 'The net limit price for the strategy. Implied decimal with scale 1e-4'
      - id: matched_quantity
        type: u4
        doc: 'Number of strategies ready to be matched (both buyers and sellers already present)'
      - id: imbalance_quantity_signed
        type: s4
        doc: 'Number of strategies on the Imbalance Side that cannot be matched'
      - id: attributable_id
        type: str
        size: 4
        encoding: ASCII
...
enums:
  ...
  message_type:
    ...
    0x53:
      ...
      doc: 'This message format is used to notify the firms of the state changes of the system. This is a notification that applies to each Underlying group.'
    0x4c:
      id: 'simple_liquidity_seeking_event_notification_message'
      doc: 'This is the message format that will be used to disseminate information each time a Liquidity seeking event starts at MIAX.'
    0x6c:
  ...
  miax_bbo_posting_increment_indicator:
    0x50:
      id: 'penny'
      doc: 'Penny 0.01 At All Price Levels'
    0x4e:
      id: 'penny_or_nickel'
