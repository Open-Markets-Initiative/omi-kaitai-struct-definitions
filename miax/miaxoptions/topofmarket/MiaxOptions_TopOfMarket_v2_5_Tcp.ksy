# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax MiaxOptions TopOfMarket Mach v2.5
#
# Protocol:
...
meta:
  id: miax_miaxoptions_topofmarket_mach_v2_5_tcp
  title: Miax MiaxOptions TopOfMarket Mach v2.5
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Options Top of Market Mach v2.5'
...
types:
  ...
  simple_series_update_message:
    seq:
      ...
      - id: long_term_option
        ...
        doc: '"Y" = Far month expiration (as defined by MIAX rules), "N" = Near month expiration (as defined by MIAX rules)'
      - id: active_on_miax
        type: u1
        enum: active_on_miax
  ...
  simple_top_of_market_best_bid_or_offer_compact_bid_message:
    seq:
      ...
      - id: mbbo_priority_customer_size_short
        type: u2
  ...
  simple_top_of_market_best_bid_or_offer_wide_bid_message:
    seq:
      ...
      - id: mbbo_size_long
        type: u4
        doc: 'Aggregate size at MIAX Best Price at the time stated in Timestamp and side specified in Message Type'
      - id: mbbo_priority_customer_size_long
        type: u4
        doc: 'Aggregate size of Priority Customer contracts at the MIAX Best Price'
      - id: mbbo_condition
        type: u1
...
enums:
  ...
  message_type:
    ...
    0x42:
      ...
      doc: 'This is the message format that will be used to disseminate each side of the MIAX Simple Top of Market for options with low premiums and small aggregate MIAX Best Bid or Offer (MBBO) size. "B" = Simple Top of Market on Bid side.'
    0x4f:
      id: 'simple_top_of_market_best_bid_or_offer_compact_offer_message'
      doc: 'This is the message format that will be used to disseminate each side of the MIAX Simple Top of Market for options with low premiums and small aggregate MIAX Best Bid or Offer (MBBO) size. "O" = Simple Top of Market on Offer side.'
    0x62:
      id: 'simple_top_of_market_best_bid_or_offer_wide_bid_message'
      doc: 'This is the message format that will be used to disseminate MIAX Simple Top of Market for options with high premiums or large aggregate MIAX Best Bid or Offer (MBBO) size. "b" = Simple Top of Market on Bid side (wide).'
    0x6f:
      id: 'simple_top_of_market_best_bid_or_offer_wide_offer_message'
      doc: 'This is the message format that will be used to disseminate MIAX Simple Top of Market for options with high premiums or large aggregate MIAX Best Bid or Offer (MBBO) size. "o" = Simple Top of Market on Offer side (wide).'
    0x64:
      id: 'simple_double_sided_top_of_market_best_bid_or_offer_compact_message'
      doc: 'This is the message format that will be used in the real-time feed and refresh service to disseminate both sides of the MIAX Simple Top of Market for options with low premiums and small aggregate MIAX Best Bid or Offer (MBBO) size.'
    0x44:
      id: 'simple_double_sided_top_of_market_best_bid_or_offer_wide_message'
      doc: 'This is the message format that will be used in the real-time feed and refresh service to disseminate both sides of the MIAX Simple Top of Market for options with high premiums or large aggregate MIAX Best Bid or Offer (MBBO) sizes.'
    0x54:
