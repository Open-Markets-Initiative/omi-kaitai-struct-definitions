...
meta:
  id: miax_pearlequities_depthofmarket_mach_v1_3_d_udp
...
types:
  ...
  symbol_update_message:
    seq:
      ...
      - id: opening_time
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'Expressed in HH:MM:SS format. Eg: 04:00:00'
      - id: closing_time
        type: str
        size: 8
        encoding: ASCII
        pad-right: 0x20
        doc: 'Expressed in HH:MM:SS format. Eg: 20:00:00'
  ...
  add_order_message:
    seq:
      ...
      - id: order_side
        type: u1
        enum: order_side
        doc: 'Side of order. B - Buy, S - Sell'
      - id: price
        type: decimal_u8_6
      ...
      - id: attributable_id
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'MPID of the firm if attributed; "RTAL" if attributed as such; space-filled if no attribution specified'
  modify_order_message:
    seq:
      ...
      - id: modify_order_flags
        ...
        doc: 'Modify Order flags. Bit 0 indicates Order Position; bits 1-7 are undefined'
  modify_order_flags:
    meta:
      bit-endian: le
    seq:
      - id: order_position
        type: b1
        doc: '0 - Order kept its position in the book; 1 - Order lost its position in the book'
      - id: reserved_7
        type: b7
        doc: 'Undefined'
  ...
  order_execution_message:
    seq:
      ...
      - id: order_execution_flags
        ...
        doc: 'Order Execution flags. Bit 0 indicates SIP reportability; bit 1 indicates Traded Against Retail; bits 2-7 are reserved'
  order_execution_flags:
    ...
    seq:
      ...
      - id: traded_against_retail
        type: b1
        doc: '0 - Did not trade against Retail; 1 - Traded against Retail'
      - id: reserved_6
        type: b6
        doc: 'Reserved for future use'
  trade_message:
    seq:
      ...
      - id: trade_flags
        type: trade_flags
        doc: 'Trade flags. Bit 0 indicates SIP reportability; bit 1 indicates Retail Trade participation; bits 2-7 are reserved'
  trade_flags:
    meta:
      bit-endian: le
    seq:
      - id: sip_reporting
        type: b1
        doc: '0 - Not reportable to the SIP; 1 - Reportable to the SIP'
      - id: retail_trade_indicator
        type: b1
        doc: '0 - Neither side is Retail; 1 - At least one side is Retail'
      - id: reserved_6
        type: b6
        doc: 'Reserved for future use'
