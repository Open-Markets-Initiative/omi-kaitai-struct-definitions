# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax PearlOptions TopOfMarket Mach v2.2
#
# Protocol:
...
meta:
  id: miax_pearloptions_topofmarket_mach_v2_2
  title: Miax PearlOptions TopOfMarket Mach v2.2
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Pearl Options Top Of Market Mach v2.2'
