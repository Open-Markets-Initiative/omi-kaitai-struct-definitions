# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax PearlOptions TopOfMarket Mach v1.2
#
# Protocol:
...
meta:
  id: miax_pearloptions_topofmarket_mach_v1_2_udp
  title: Miax PearlOptions TopOfMarket Mach v1.2
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Pearl Options Top of Market Mach v1.2'
...
types:
      ...
      - id: data
        ...
        type:
          ...
          cases:
            ...
            'message_type::top_of_market_best_bid_or_offer_compact_format_bid_message': top_of_market_best_bid_or_offer_compact_format_bid_message
            'message_type::top_of_market_best_bid_or_offer_compact_format_bid_priority_customer_message': top_of_market_best_bid_or_offer_compact_format_bid_priority_customer_message
            'message_type::top_of_market_best_bid_or_offer_compact_format_offer_message': top_of_market_best_bid_or_offer_compact_format_offer_message
            'message_type::top_of_market_best_bid_or_offer_compact_format_offer_priority_customer_message': top_of_market_best_bid_or_offer_compact_format_offer_priority_customer_message
            'message_type::top_of_market_best_bid_or_offer_wide_format_bid_message': top_of_market_best_bid_or_offer_wide_format_bid_message
            'message_type::top_of_market_best_bid_or_offer_wide_format_bid_priority_customer_message': top_of_market_best_bid_or_offer_wide_format_bid_priority_customer_message
            'message_type::top_of_market_best_bid_or_offer_wide_format_offer_message': top_of_market_best_bid_or_offer_wide_format_offer_message
            'message_type::top_of_market_best_bid_or_offer_wide_format_offer_priority_customer_message': top_of_market_best_bid_or_offer_wide_format_offer_priority_customer_message
            'message_type::double_sided_top_of_market_best_bid_or_offer_compact_format_message': double_sided_top_of_market_best_bid_or_offer_compact_format_message
            'message_type::double_sided_top_of_market_best_bid_or_offer_wide_format_message': double_sided_top_of_market_best_bid_or_offer_wide_format_message
  ...
  series_update_message:
    seq:
      ...
      - id: restricted_option
        ...
        doc: 'Restricted Option indicator'
      - id: long_term_option
        type: u1
        enum: long_term_option
        doc: '"Y" = Far month expiration (as defined by Pearl rules); "N" = Near month expiration (as defined by Pearl rules)'
      - id: active_on_pearl
        type: u1
  ...
  top_of_market_best_bid_or_offer_compact_format_bid_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_priority_customer_size_short
        type: u2
        doc: 'Aggregate size of Priority Customer contracts at the Pearl Best Price'
      - id: pbbo_condition
        type: u1
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  top_of_market_best_bid_or_offer_compact_format_bid_priority_customer_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_condition
        ...
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  top_of_market_best_bid_or_offer_compact_format_offer_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_condition
        ...
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  top_of_market_best_bid_or_offer_compact_format_offer_priority_customer_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_condition
        ...
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  top_of_market_best_bid_or_offer_wide_format_bid_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_size_long
        type: u4
        doc: 'Aggregate size at Pearl Best Price at the time stated in Timestamp and side specified in Message Type'
      - id: pbbo_priority_customer_size_long
        type: u4
        doc: 'Aggregate size of Priority Customer contracts at the Pearl Best Price'
      - id: pbbo_condition
        type: u1
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  top_of_market_best_bid_or_offer_wide_format_bid_priority_customer_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_condition
        ...
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  top_of_market_best_bid_or_offer_wide_format_offer_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_condition
        ...
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  top_of_market_best_bid_or_offer_wide_format_offer_priority_customer_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
      ...
      - id: pbbo_condition
        ...
        enum: pbbo_condition
        doc: 'PBBO Condition Value'
  double_sided_top_of_market_best_bid_or_offer_compact_format_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
  ...
  double_sided_top_of_market_best_bid_or_offer_wide_format_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Pearl system today. Nanoseconds since Second epoch'
...
enums:
  ...
  message_type:
    ...
    0x42:
      id: 'top_of_market_best_bid_or_offer_compact_format_bid_message'
      doc: 'This is the message format that will be used to disseminate each side of the Pearl Top of Market for options with low premiums and small aggregate Pearl Best Bid or Offer (PBBO) size. Top of Market on Bid side.'
    0x68:
      id: 'top_of_market_best_bid_or_offer_compact_format_bid_priority_customer_message'
      doc: 'Simple Top of Market on Bid side with Priority Customer establishing new aggressive price.'
    0x4f:
      id: 'top_of_market_best_bid_or_offer_compact_format_offer_message'
      doc: 'This is the message format that will be used to disseminate each side of the Pearl Top of Market for options with low premiums and small aggregate Pearl Best Bid or Offer (PBBO) size. Top of Market on Offer side.'
    0x69:
      id: 'top_of_market_best_bid_or_offer_compact_format_offer_priority_customer_message'
      doc: 'Simple Top of Market on Offer side with Priority Customer establishing new aggressive price.'
    0x57:
      id: 'top_of_market_best_bid_or_offer_wide_format_bid_message'
      doc: 'This is the message format that will be used to disseminate Pearl Top of Market for options with high premiums or large aggregate Pearl Best Bid or Offer (PBBO) size. Top of Market on Bid side.'
    0x6a:
      id: 'top_of_market_best_bid_or_offer_wide_format_bid_priority_customer_message'
      doc: 'Simple Top of Market on Bid side with Priority Customer establishing new aggressive price.'
    0x41:
      id: 'top_of_market_best_bid_or_offer_wide_format_offer_message'
      doc: 'This is the message format that will be used to disseminate Pearl Top of Market for options with high premiums or large aggregate Pearl Best Bid or Offer (PBBO) size. Top of Market on Offer side.'
    0x6b:
      id: 'top_of_market_best_bid_or_offer_wide_format_offer_priority_customer_message'
      doc: 'Simple Top of Market on Offer side with Priority Customer establishing new aggressive price.'
    0x64:
      id: 'double_sided_top_of_market_best_bid_or_offer_compact_format_message'
    ...
    0x44:
      id: 'double_sided_top_of_market_best_bid_or_offer_wide_format_message'
  ...
  pearl_bbo_posting_increment_indicator:
    0x50:
      id: 'penny'
      doc: 'Penny If Price 3 Penny If Price 3'
    0x4e:
      id: 'penny_or_nickel'
  ...
  event_reason:
    0x41:
      id: 'automatic'
      doc: 'This Event Resulted From Automatic Market Driven Event'
    0x4d:
      id: 'manual'
  ...
  unsequenced_message_type:
    ...
    0x72:
      ...
      doc: 'Sent by MIAX Pearl Options over the ToM Retransmission Interface (SesM Unsequenced Data Packet) carrying one Application Message that satisfies a previous Refresh Request. Note: Pearl Options PDF assigns Response Type "R" (uppercase) to this message, colliding with the Request Type "R" byte; lowercase "r" is used here to match the PearlEquities case-distinction convention.'
    0x45:
      id: 'end_of_refresh_notification_message'
      doc: 'Sent by MIAX Pearl Options over the ToM Retransmission Interface (SesM Unsequenced Data Packet) when the refresh response is complete.'
