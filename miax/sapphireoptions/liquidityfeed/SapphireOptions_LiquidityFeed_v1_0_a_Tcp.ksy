# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax SapphireOptions LiquidityFeed Mach v1.0.a
#
# Protocol:
...
meta:
  id: miax_sapphireoptions_liquidityfeed_mach_v1_0_a_tcp
  title: Miax SapphireOptions LiquidityFeed Mach v1.0.a
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Sapphire Options Liquidity Feed Mach v1.0.a'
...
types:
  ...
  sequenced_data_packet:
    seq:
      - id: sequence_number
        type: u8
        doc: 'Original sequence number from the live feed (for P/U/S/C refreshes); for Order Book Refresh, the last sequence number on the live feed at the time of the refresh request'
  ...
  simple_order_message:
    seq:
      ...
      - id: order_id
        type: u8
        doc: 'Sapphire assigned Order ID'
      - id: order_side
        type: u1
        enum: order_side
        doc: 'Side of order'
      ...
      - id: remaining_volume_open
        type: u4
        doc: 'Number of contracts that are still open for trading at Sapphire'
...
enums:
  ...
  message_type:
    ...
    0x46:
      ...
      doc: 'This is the message format that will be used to disseminate Sapphire Options Simple Orders.'
    0x43:
      id: 'complex_strategy_definition_update_message'
      doc: 'This is the message format that will be used to disseminate stock option strategies traded on Sapphire for the current session. The Strategy ID sent in this message is used for the dissemination of Complex Orders.'
    0x52:
      id: 'complex_order_message'
      doc: 'This is the message format that will be used to disseminate Sapphire Options Complex Orders.'
    0x78:
      id: 'order_close_message'
      doc: 'This is the message format that will be used to disseminate Order Close for Sapphire Options Simple and Complex Orders.'
  call_or_put:
    0x43:
      id: 'call'
      doc: 'Call'
  ...
  unsequenced_message_type:
    0x52:
      ...
      doc: 'Sent by the firm over the SLF Retransmission Interface (SesM Unsequenced Data Packet) to request a Last Value Refresh of a particular data set identified by Refresh Message Type.'
    0x72:
      id: 'refresh_response_message'
      doc: 'Sent by MIAX Sapphire over the SLF Retransmission Interface (SesM Unsequenced Data Packet) carrying one Application Message that satisfies a previous Refresh Request. When the Refresh Message Type is ''O'' (Order Book Refresh), the response is a series of messages (System Time, latest System State, Series Update, Underlying Trading Status Notifications, Complex Strategy Definitions, open Simple orders, and open Complex orders) sharing the last sequence number from the live feed at the time of the request. Note: MIAX Sapphire PDF assigns Response Type "R" (uppercase) to this message, colliding with the Request Type "R" byte; lowercase "r" is used here to match the Pearl convention for case-distinct discrimination.'
    0x45:
      id: 'end_of_refresh_notification_message'
      doc: 'Sent by MIAX Sapphire over the SLF Retransmission Interface (SesM Unsequenced Data Packet) when the refresh response is complete.'
