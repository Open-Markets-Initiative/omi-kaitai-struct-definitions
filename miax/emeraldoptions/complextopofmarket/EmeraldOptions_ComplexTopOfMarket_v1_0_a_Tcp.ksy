# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax EmeraldOptions ComplexTopOfMarket Mach v1.0.a
#
# Protocol:
...
meta:
  id: miax_emeraldoptions_complextopofmarket_mach_v1_0_a_tcp
  title: Miax EmeraldOptions ComplexTopOfMarket Mach v1.0.a
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Emerald Options Complex Top of Market Mach v1.0.a'
...
types:
  ...
  sequenced_data_packet:
    seq:
      ...
      - id: sequenced_message_type
        ...
        size: 1
        encoding: ASCII
        doc: 'Market-data application message type carried over the SesM sequenced channel (matches the MACH UDP Message Type byte; Miax Emerald Options uses Ascii message codes)'
  ...
  system_time_message:
    seq:
      - id: seconds
        ...
        doc: 'Seconds part of the time that applies to all messages that get disseminated until this message gets sent again. Seconds since Unix epoch'
  ...
  complex_top_of_market_best_bid_or_offer_compact_format_bid_message:
    seq:
      ...
      - id: price_short
        type: decimal_s2_2
        doc: 'Emerald Best price at the time stated in Timestamp and side specified in Message Type. The net limit price for the strategy. Implied decimal with scale 1e-2'
      - id: size_short
        type: u2
      ...
      - id: priority_customer_size_short
        type: u2
        doc: 'Aggregate size of Priority Customer contracts at Emerald Best Price for the Complex Strategy'
      - id: condition
        type: u1
        enum: condition
  ...
  complex_top_of_market_best_bid_or_offer_wide_format_bid_message:
    seq:
      ...
      - id: price_long
        type: decimal_s8_4
        doc: 'Emerald Best price at the time stated in Timestamp and side specified in Message Type. The net limit price for the strategy. Implied decimal with scale 1e-4'
      - id: size_long
        type: u4
        doc: 'Aggregate size at Emerald Best Price at the time stated in Timestamp and side specified in Message Type'
  ...
  complex_double_sided_top_of_market_best_bid_and_offer_compact_format_message:
    seq:
      ...
      - id: bid_price_short
        type: decimal_s2_2
        doc: 'Emerald Best Bid net price. Implied decimal with scale 1e-2'
      - id: bid_size_short
        type: u2
        doc: 'Aggregate size at Emerald Best Bid Net Price'
      - id: bid_priority_customer_size_short
        type: u2
        doc: 'The aggregate size of Priority Customer contracts at Emerald Best Bid Price for the Complex Strategy'
      - id: bid_condition
        type: u1
        enum: bid_condition
        doc: 'Top of Strategy Market Quote Conditions'
      - id: offer_price_short
        type: decimal_s2_2
        doc: 'Emerald Best Offer net price. Implied decimal with scale 1e-2'
      - id: offer_size_short
        type: u2
        doc: 'Aggregate size at Emerald Best Bid Net Price'
      - id: offer_priority_customer_size_short
        type: u2
        doc: 'The aggregate size of Priority Customer contracts at Emerald Best Offer Price for the Complex Strategy'
      - id: offer_condition
        type: u1
  ...
  complex_double_sided_top_of_market_best_bid_and_offer_wide_format_message:
    seq:
      ...
      - id: bid_price_long
        type: decimal_s8_4
        doc: 'Emerald Best Bid net price. Implied decimal with scale 1e-4'
      - id: bid_size_long
        type: u4
        doc: 'Aggregate size at Emerald Best Bid Net Price'
      - id: bid_priority_customer_size_long
        type: u4
        doc: 'Aggregate size of Priority Customer contracts at Emerald Best Bid Price for the Complex Strategy'
      - id: bid_condition
        type: u1
        enum: bid_condition
        doc: 'Top of Strategy Market Quote Conditions'
      - id: offer_price_long
        type: decimal_s8_4
        doc: 'Emerald Best Offer net price. Implied decimal with scale 1e-4'
      - id: offer_size_long
        type: u4
        doc: 'Aggregate size at MIAX Best Bid Net Price'
      - id: offer_priority_customer_size_long
        type: u4
        doc: 'Aggregate size of Priority Customer contracts at Emerald Best Offer Price for the Complex Strategy'
      - id: offer_condition
        type: u1
        enum: offer_condition
        doc: 'Top of Strategy Market Quote Conditions'
  ...
  login_request:
    seq:
      ...
      - id: computer_id
        ...
        encoding: ASCII
        pad-right: 0x20
        doc: 'issued by MIAX Emerald Options Exchange during initial setup'
...
enums:
  ...
  message_type:
    ...
    0x62:
      ...
      doc: 'This is the message format that will be used to disseminate each side of the Emerald Complex Top of Market for strategies with low Net Price and small aggregate Emerald Best Bid or Offer (MBBO) size. Emerald Complex Top of Market on Bid side.'
    0x6f:
      id: 'complex_top_of_market_best_bid_or_offer_compact_format_offer_message'
      doc: 'This is the message format that will be used to disseminate each side of the Emerald Complex Top of Market for strategies with low Net Price and small aggregate Emerald Best Bid or Offer (MBBO) size. Emerald Complex Top of Market on Offer side.'
    0x65:
      id: 'complex_top_of_market_best_bid_or_offer_wide_format_bid_message'
      doc: 'This is the message format that will be used to disseminate Emerald Complex Top of Market for strategies with high net price or large aggregate Emerald Best Bid or Offer (EBBO) size. Emerald Complex Top of Market on Bid side.'
    0x66:
      id: 'complex_top_of_market_best_bid_or_offer_wide_format_offer_message'
      doc: 'This is the message format that will be used to disseminate Emerald Complex Top of Market for strategies with high net price or large aggregate Emerald Best Bid or Offer (EBBO) size. Emerald Complex Top of Market on Offer side.'
    0x6d:
      id: 'complex_double_sided_top_of_market_best_bid_and_offer_compact_format_message'
      doc: 'This is the message format that will be used to disseminate both sides of the Emerald top of market for strategies (cEBBO) with low net price and small aggregate size.'
    0x77:
      id: 'complex_double_sided_top_of_market_best_bid_and_offer_wide_format_message'
      doc: 'This is the message format that will be used to disseminate both sides of the Emerald top of market for strategies (cEBBO) with net prices or aggregate sizes which cannot be specified in the compact format.'
    0x74:
  ...
  condition:
    ...
    0x43:
      id: 'complex_auction'
      doc: 'Complex Auction Or C Prime Auction In Progress'
    0x4d:
