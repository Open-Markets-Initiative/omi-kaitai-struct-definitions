# ---------------------------------------------------------------------
# Kaitai struct definition for: Miax EmeraldOptions OrderFeed Mach v1.1.a
#
# Protocol:
...
meta:
  id: miax_emeraldoptions_orderfeed_mach_v1_1_a_tcp
  title: Miax EmeraldOptions OrderFeed Mach v1.1.a
  license: GPL-3.0
  endian: le

doc: 'Miami International Holdings MIAX Emerald Options Order Feed Mach v1.1.a'
...
types:
  ...
  simple_order_message:
    seq:
      ...
      - id: order_price_short
        type: decimal_u4_4
        doc: 'Original limit price of the order. Zero for market orders. Implied decimal with scale 1e-4'
      - id: order_original_volume
        type: u4
        doc: 'Number of contracts specified on the order'
      - id: remaining_volume_open
        type: u4
        doc: 'Number of contracts that are still open for trading at Emerald'
      ...
      - id: route_instruction
        type: u1
        enum: route_instruction
        doc: 'Route instruction that came with the order'
      - id: attributed_id
        type: str
        size: 4
        encoding: ASCII
      ...
      - id: priority_customer_volume
        type: u4
        doc: 'Number of Priority Customer contracts when Origin = “ “ (Derived Order)'
      - id: reserved_28
        size: 28
        doc: 'Reserved for future use'
  ...
  complex_order_message:
    seq:
      ...
      - id: order_price_long
        type: decimal_s8_4
        doc: 'Effective limit price of the order (see notes). Not applicable for Market Orders. Implied decimal with scale 1e-4'
      - id: order_original_volume
        type: u4
        doc: 'Number of contracts specified on the order'
      - id: remaining_volume_open
  ...
  order_close_message:
    seq:
      - id: nanoseconds
        type: nanosecond_offset
        doc: 'Time at which this product is added/updated on Emerald system today. Nanoseconds since Second epoch'
      - id: simple_or_complex_order
        type: u1
        enum: simple_or_complex_order
        doc: 'Simple or Complex Order indicator'
      - id: order_id
        type: u8
        doc: 'Emerald assigned Order ID'
...
enums:
  ...
  message_type:
    ...
    0x46:
      ...
      doc: 'This is the message format that will be used to disseminate Emerald Options Simple Orders.'
    0x43:
      id: 'complex_strategy_definition_update_message'
      doc: 'This is the message format that will be used to disseminate stock option strategies traded on Emerald for the current session. The Strategy ID sent in this message is utilized by the Administrative Information Subscriber (AIS) Feed for Complex Liquidity Seeking Events, the Emerald - MIAX Order Feed (MOR) for Complex Order dissemination, the Complex Top of Market Feed (cToM) for Complex Trade and Top of Market dissemination and the Emerald -MIAX Express Interface (MEI) for Complex eQuotes.'
    0x52:
      id: 'complex_order_message'
      doc: 'This is the message format that will be used to disseminate Emerald Options Complex Orders.'
    0x78:
      id: 'order_close_message'
      doc: 'This is the message format that will be used to disseminate Order Close for Emerald Options Simple and Complex Orders.'
  call_or_put:
    0x43:
      id: 'call'
      doc: 'Call'
  ...
  time_in_force_tif:
    0x41:
      id: 'aoc'
      doc: 'Auction Or Cancel'
    0x47:
      id: 'gtc'
      doc: 'Good Till Canceled'
    0x4f:
      id: 'opg'
      doc: 'Opening Transaction Only Or Cancel'
    0x44:
      id: 'day'
      doc: 'Day'
    0x53:
      id: 'sao'
      doc: 'Settlement Auction Only Future Use'
  origin:
    0x30:
    ...
    0x20:
      id: 'not_applicable'
      doc: 'Not Applicable Used For Derived Order'
  openclose_indicator:
    0x4f:
      id: 'open'
      doc: 'Open'
  ...
  unsequenced_message_type:
    0x52:
      ...
      doc: 'Sent by the firm over the MOR Retransmission Interface (SesM Unsequenced Data Packet) to request a Last Value Refresh of a particular data set identified by Refresh Message Type.'
    0x72:
      id: 'refresh_response_message'
      doc: 'Sent by MIAX Emerald over the MOR Retransmission Interface (SesM Unsequenced Data Packet) carrying one Application Message that satisfies a previous Refresh Request. Note: MIAX Emerald PDF assigns Response Type "R" (uppercase) to this message, colliding with the Request Type "R" byte; lowercase "r" is used here to match the Pearl convention for case-distinct discrimination.'
    0x45:
      id: 'end_of_refresh_notification_message'
      doc: 'Sent by MIAX Emerald over the MOR Retransmission Interface (SesM Unsequenced Data Packet) when the refresh response is complete.'
