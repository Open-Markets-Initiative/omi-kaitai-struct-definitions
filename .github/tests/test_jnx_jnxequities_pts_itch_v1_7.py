...
from jnx_jnxequities_pts_itch_v1_7_udp import JnxJnxequitiesPtsItchV17Udp


class JnxJnxequitiesPtsItchV17UdpTests(unittest.TestCase):
    ...
    def test_orderaddedwithoutattributesmessage(self):
        for payload in payloads.of("omi-data-packets/Jnx/JnxEquities.Pts.Itch.v1.7/OrderAddedWithoutAttributesMessage.pcap"):
            parsed = JnxJnxequitiesPtsItchV17Udp.from_bytes(payload)
