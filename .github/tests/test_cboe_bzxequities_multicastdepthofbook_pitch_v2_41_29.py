...
from cboe_bzxequities_multicastdepthofbook_pitch_v2_41_29 import CboeBzxequitiesMulticastdepthofbookPitchV24129


class CboeBzxequitiesMulticastdepthofbookPitchV24129Tests(unittest.TestCase):
    ...
    def test_addorderexpandedmessage(self):
        for payload in payloads.of("omi-data-packets/Cboe/BzxEquities.MulticastDepthOfBook.Pitch.v2.41.29/AddOrderExpandedMessage.pcap"):
            parsed = CboeBzxequitiesMulticastdepthofbookPitchV24129.from_bytes(payload)
