# ---------------------------------------------------------------------
# Kaitai struct definition for: Ice IceFutures Mdf iMpact v1.1.43
#
# Protocol:
...
meta:
  id: ice_icefutures_mdf_impact_v1_1_43
  title: Ice IceFutures Mdf iMpact v1.1.43
  license: GPL-3.0
  endian: be

doc: 'Intercontinental Exchange Intercontinental Exchange Futures Multicast Data Feed iMpact v1.1.43'
  ...
  add_or_modify_order_message:
    seq:
      ...
      - id: modification_timestamp
        type: millisecond_timestamp
        doc: 'This field can be used to get the order modification time. Milliseconds since Unix epoch'
      - id: request_trading_engine_received_timestamp
        type: nanosecond_timestamp
        doc: 'time the trading engine received the request that triggers this message. Nanoseconds since Unix epoch'
  ...
  message_bundle_marker:
    seq:
      - id: start_or_end
        type: u1
        enum: start_or_end
        doc: 'Marker: ‘S’ – Start of a message bundle, ‘E’ – End of a message bundle'
