# ---------------------------------------------------------------------
# Kaitai struct definition for: Ice IceFutures Mdf iMpact v1.1.24
#
# Protocol:
...
meta:
  id: ice_icefutures_mdf_impact_v1_1_24
  title: Ice IceFutures Mdf iMpact v1.1.24
  license: GPL-3.0
  endian: be

doc: 'Intercontinental Exchange Intercontinental Exchange Futures Multicast Data Feed iMpact v1.1.24'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::marker_index_prices': marker_index_prices
  ...
  trade_message:
    seq:
      ...
      - id: system_priced_leg_type
        ...
        doc: '‘C’ – System Priced Crack Spread Leg'
      ...
      - id: extra_flags
        type: s1
        doc: 'Bit 0 (Least Significant Bit): IsRFCCrossing – indicate this is a RFC Crossing Deal if set to 1'
  ...
  leg_definition:
    seq:
      ...
      - id: leg_market_id
        type: u4
        doc: 'Market Id of the futures leg market'
      - id: leg_ratio
        type: u2
  ...
  new_expiry_message:
    seq:
      ...
      - id: market_type_id
        type: s2
        enum: market_type_id
        doc: 'See Appendix C for the list of market types and IDs'
      - id: order_price_denominator
        type: str
        size: 1
        encoding: ASCII
      ...
      - id: unit_qty_denominator
        ...
        size: 1
        encoding: ASCII
        doc: 'Denominator for UnitQuantity. Clients should also apply UnitQtyDenominator when calculating LotSize. This field will be ‘0’ for most of the markets'
      ...
      - id: off_exchange_increment_price
        type: s4
        doc: 'Off exchange increment price. OrderPriceDenominator should be applied to this field'
  ...
  special_field:
    seq:
      - id: special_field_id
        type: u1
        doc: 'Special Field Identifier'
      - id: len_special_field_value
        type: u2
        doc: 'Length of this field'
      - id: special_field_value
        size: len_special_field_value
        doc: 'Special field value'
  ...
  fixing_lockdown_message:
    seq:
      ...
      - id: gbp_price
        type: s8
        doc: 'Auctioneers price for the round in GBP. Use 3 decimal places for GBP Price'
      - id: eur_price
        type: s8
        doc: 'Auctioneers price for the round in EUR. Use 3 decimal places for EUR Price'
