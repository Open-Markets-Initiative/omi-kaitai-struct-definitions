# ---------------------------------------------------------------------
# Kaitai struct definition for: Ice IceFutures Mdf iMpact v1.1.51
#
# Protocol:
...
meta:
  id: ice_icefutures_mdf_impact_v1_1_51
  title: Ice IceFutures Mdf iMpact v1.1.51
  license: GPL-3.0
  endian: be

doc: 'Intercontinental Exchange Intercontinental Exchange Futures Multicast Data Feed iMpact v1.1.51'
...
types:
  packet_header_struct:
    seq:
      ...
      - id: sent_date_time
        ...
        doc: 'Field is the timestamp of when the message block is sent, the number of nanoseconds since Jan 1st, 1970, 00:00:00 GMT. Nanoseconds since Unix epoch'
  message_struct:
    seq:
      - id: message_header
        type: message_header
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::fragment_wrapper_message': fragment_wrapper_message
            ...
            'message_type::fixing_indicative_price_message': fixing_indicative_price_message
  ...
  trade_message:
    seq:
      ...
      - id: request_trading_engine_received_timestamp
        type: nanosecond_timestamp
        doc: 'time the trading engine received the request that triggers this message. Nanoseconds since Unix epoch'
  trade_flags:
    meta:
      bit-endian: le
    seq:
  ...
  index_prices_message:
    seq:
      ...
      - id: endex_status
        type: u1
        enum: endex_status
        doc: 'Endex Only Values'
      - id: alt_market_id
        type: s4
        doc: 'The market id of the marker market, or 0 if none is set'
      - id: index_price_denominator
        type: str
        size: 1
        encoding: ASCII
        doc: 'This field should be applied to the Price field to get the number of decimals for the Marker/Index'
  ...
  interval_price_limit_notification_message:
    seq:
      ...
      - id: is_up
        type: u1
        enum: is_up
        doc: 'Upper/Lower bound violation'
      - id: ipl_tpl_hold_duration
        type: s4
        doc: 'Hold duration, in milliseconds'
      - id: ipl_tpl_up
        type: s8
        doc: 'IPL upper bound'
      - id: ipl_tpl_down
  ...
  new_futures_strategy_definition_message:
    seq:
      ...
      - id: old_num_of_cycles
        type: s2
        doc: 'Number of cycles for a contract'
      - id: market_type_id
        type: s2
        enum: market_type_id
        doc: 'Number of cycles for a contract'
      - id: override_block_min
        ...
        size: 1
        encoding: ASCII
        doc: 'Override Block Minimum'
      - id: num_extra_leg_definition
        type: s1
        doc: 'Number of strategy leg definitions. The leg info'
      - id: extra_leg_definition
        type: extra_leg_definition
        repeat: expr
        repeat-expr: num_extra_leg_definition
        doc: 'Extra Leg Definition'
      - id: num_of_cycles
        type: s4
        doc: 'Numeric Number of cycles for a contract'
      - id: unit_of_measure
        type: str
        size: 30
        encoding: ASCII
  ...
  new_expiry_message:
    seq:
      ...
      - id: hedge_market_id
        type: s4
        doc: 'Market ID for the corresponding hedge market'
      - id: settlement_type
        type: u1
      ...
      - id: mifid_regulated_market
        ...
        enum: mifid_regulated_market
        doc: 'Indicates MIFID-II market. ‘Y’ or ‘N’'
      - id: screen_last_trade_year
        type: s2
        doc: 'Screen last trade year, 4 digits'
      - id: screen_last_trade_month
        type: s2
        doc: 'Screen last trade month, range 1-12'
      - id: screen_last_trade_day
        type: s2
        doc: 'Screen last trade day of the month'
      - id: old_num_of_cycles
        type: s2
        doc: 'Number of cycles for a contract'
      - id: num_of_cycles
  ...
  fragment_wrapper_message:
    seq:
      - id: total_length
        type: s2
        doc: 'The total length of the fragmented message'
      - id: fragment_offset
        type: s2
        doc: 'The index of the byte where this fragment starts within the total length of the fragmented message'
      - id: fragment_length
        type: s2
        doc: 'The number of bytes in this fragment'
      - id: fragment_bytes
        size-eos: true
        doc: 'The serialized bytes of the fragmented message'
  new_options_strategy_definition_message:
    seq:
      ...
      - id: override_block_min
        ...
        encoding: ASCII
        doc: 'Override Block Minimum'
      - id: num_extra_strategy_leg_definition
        type: s1
        doc: 'Number of strategy leg definitions. The leg info are in repeating group followed'
      - id: extra_strategy_leg_definition
        type: extra_strategy_leg_definition
        repeat: expr
        repeat-expr: num_extra_strategy_leg_definition
        doc: 'Extra Strategy Leg Definition'
      - id: num_of_cycles
        type: s4
        doc: 'Numeric Number of cycles for a contract'
      - id: min_price
  ...
  hedge_definition:
    seq:
      ...
      - id: hedge_delta_obsolete
        type: s2
        doc: 'Hedge Delta Obsolete'
  ...
  message_bundle_marker:
    seq:
      - id: start_or_end
        type: u1
        enum: start_or_end
        doc: 'Start Or End Marker'
      - id: trade_transaction_id
        type: s8
        doc: 'The value used to associate bundles of the same transaction. This value will be 0 when the transaction has no trade. The value will be -1 if the channel does not support sub-bundling'
      - id: is_transaction_end
        type: u1
        enum: is_transaction_end
        doc: 'This field will always be set to ‘ ‘ for Start of a message bundle'
  fixing_transition_message:
    seq:
      ...
      - id: fixing_status
        type: u1
        enum: fixing_status
        doc: 'C - Closed, P - Preopen, L - Lockdown'
      - id: auction_end_time
        type: millisecond_timestamp
  ...
  fixing_lockdown_message:
    seq:
      ...
      - id: num_decimals_quantity
        type: s1
        doc: 'Num Decimals'
  fixing_indicative_price_message:
    seq:
      - id: market_id
        type: s4
      - id: iba_currency
...
enums:
  message_type:
    ...
    0x5a:
      id: 'fragment_wrapper_message'
      doc: 'When multicast messages become too large to fit within a single packet, their serialized content will be split into byte fragments and sent within this Fragment Wrapper Message'
    0x55:
    ...
    0x34:
      ...
      doc: 'This message supports ICE Benchmark Administration’s (IBA) electronic Gold Auction and it is disseminated when there is a transition of the fixing market.'
    0x30:
      id: 'fixing_indicative_price_message'
  ...
  has_previous_day_settlement_price:
    ...
    0x4e:
      id: 'no_field'
      doc: 'Does Not Have Previous Day Settlement Price'
  ...
  event_type:
    0x41:
      id: 'implication_disabled_for_the_market'
      doc: 'Implication Disabled For The Market'
  is_up:
    0x59:
  ...
  mifid_regulated_market:
    0x59:
      id: 'yes_field'
      doc: 'Mifid Regulated Market'
    0x4e:
      id: 'no_field'
      doc: 'Not Mifid Regulated Market'
  allow_options:
    0x59:
      id: 'yes_field'
