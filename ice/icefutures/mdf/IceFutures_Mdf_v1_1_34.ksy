# ---------------------------------------------------------------------
# Kaitai struct definition for: Ice IceFutures Mdf iMpact v1.1.34
#
# Protocol:
...
meta:
  id: ice_icefutures_mdf_impact_v1_1_34
  title: Ice IceFutures Mdf iMpact v1.1.34
  license: GPL-3.0
  endian: be

doc: 'Intercontinental Exchange Intercontinental Exchange Futures Multicast Data Feed iMpact v1.1.34'
...
types:
      ...
      - id: payload
        ...
        type:
          ...
          cases:
            ...
            'message_type::transaction_end_marker_for_empty_last_bundle_message': transaction_end_marker_for_empty_last_bundle_message
  ...
  transaction_end_marker_for_empty_last_bundle_message:
    seq:
      - id: trade_transaction_id
        type: s8
        doc: 'The value used to associate bundles of the same transaction. This value will be 0 when the transaction has no trade. The value will be -1 if the channel does not support sub-bundling'
...
enums:
  message_type:
    ...
    0x65:
      id: 'transaction_end_marker_for_empty_last_bundle_message'
      doc: 'This message will be sent in rare cases when the last bundle of a transaction is filtered out and the IsTransactionEnd=Y marker cannot be sent.'
    0x6d:
