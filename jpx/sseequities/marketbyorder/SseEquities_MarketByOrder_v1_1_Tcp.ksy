# ---------------------------------------------------------------------
# Kaitai struct definition for: Jpx SseEquities MarketByOrder Flex v1.1
#
# Protocol:
...
meta:
  id: jpx_sseequities_marketbyorder_flex_v1_1_tcp
  title: Jpx SseEquities MarketByOrder Flex v1.1
  license: GPL-3.0
  endian: be

doc: 'Japan Exchange Group Sapporo Securities Exchange Equities Market By Order Flex v1.1'
