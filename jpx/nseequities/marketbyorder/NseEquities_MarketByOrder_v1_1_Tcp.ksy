# ---------------------------------------------------------------------
# Kaitai struct definition for: Jpx NseEquities MarketByOrder Flex v1.1
#
# Protocol:
...
meta:
  id: jpx_nseequities_marketbyorder_flex_v1_1_tcp
  title: Jpx NseEquities MarketByOrder Flex v1.1
  license: GPL-3.0
  endian: be

doc: 'Japan Exchange Group Nagoya Stock Exchange Equities Market By Order Flex v1.1'
